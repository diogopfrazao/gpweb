...
if(!file_exists(BASE_DIR.'/modulos/projetos/tarefa_cache.class_pro.php')){
	...
	$bd->Execute("ALTER TABLE pratica_indicador ADD COLUMN pratica_indicador_risco INTEGER(100) UNSIGNED DEFAULT NULL;");
	$bd->Execute("ALTER TABLE pratica_indicador ADD COLUMN pratica_indicador_risco_resposta INTEGER(100) UNSIGNED DEFAULT NULL;");
	}	
else {
	$sql = new BDConsulta;

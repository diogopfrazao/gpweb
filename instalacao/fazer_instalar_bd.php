...
if( ( $fazer_cfg || $fazer_bd_cfg ) && $erroCArquivo ) {
  echo '<tr><td  align="left" colspan="2">O seguinte conteúdo deverá ir para gpweb'
       . ( file_exists( '../modulos/projetos/tarefa_cache.class_pro.php' ) ? '/server' : '' )
       . '/<b>config.php</b>.<br/>Crie este arquivo manualmente e cole as linhas de baixo à mão. Exclua todas as linhas em branco após \'?>\' e salve. Este arquivo deverá poder ser lido pelo Servidor Web.</td></tr>';
  echo '<tr><td align="center" colspan="2"><textarea class="botao" name="hospedadoBd" cols="100" rows="20" title="Conteúdo de config.php para criação manual." />'

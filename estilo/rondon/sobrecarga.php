...
class CTabBox extends CCaixaTab_nucleo {
	...
	public function mostrar( $extra = '', $js_tabs = false, $alinhamento = 'left', $opt_flat = true, $somente_tab=false, $tableId = false) {
		...
		foreach ($this->tabs as $k => $v) {
			...
			$s .= '<td id="tab_s_'.$k.'" valign="middle" style="white-space: nowrap" class="'.$classe.'">&nbsp;<a '.($estilo ? 'class="aba" ' : '').'href="';

...
echo '<script type="text/javascript" src="../js/gpweb.js?dc=3"></script>';
...
echo '<tr><td style="white-space: nowrap"><b>Atualize as informações de cadastro:</b></td><td><input type="hidden" class="texto" size="25" name="contato_posto" value="'.$linha->contato_posto.'" maxlength="50" /></td></tr>';
...
echo '<tr><td align="right" width="100">Função:</td><td style="white-space: nowrap"><input type="text" class="texto" name="contato_funcao" value="'.$linha->contato_funcao.'" maxlength="100" size="25" /></td></tr>';
...
echo '<tr><td align="right" style="white-space: nowrap">Tipo:</td><td><input type="text" class="texto" name="contato_tipo" value="'.$linha->contato_tipo.'" maxlength="50" size="25" /></td></tr>';
echo '<tr><td align="right" width="100" style="white-space: nowrap">Endereço:</td><td><input type="text" class="texto" name="contato_endereco1" value="'.$linha->contato_endereco1.'" maxlength="60" size="25" /></td></tr>';
echo '<tr><td align="right" style="white-space: nowrap">Complemento:</td><td><input type="text" class="texto" name="contato_endereco2" value="'.$linha->contato_endereco2.'" maxlength="60" size="25" /></td></tr>';
echo '<tr><td align="right" style="white-space: nowrap">Município:</td><td><input type="text" class="texto" name="contato_cidade" value="'.$linha->contato_cidade.'" maxlength="30" size="25" /></td></tr>';
echo '<tr><td align="right" style="white-space: nowrap">Estado:</td><td>'.selecionaVetor($estado, 'contato_estado','class="texto" size=1', $linha->contato_estado).'</td></tr>';
echo '<tr><td align="right" style="white-space: nowrap">CEP:</td><td><input type="text" class="texto" name="contato_cep" value="'.$linha->contato_cep.'" maxlength="11" size="25" /></td></tr>';
echo '<tr><td align="right" style="white-space: nowrap">País:</td><td>'.selecionaVetor($paises, 'contato_pais', 'size="1" class="texto"', ($linha->contato_pais ? $linha->contato_pais : 'BR')).'</td></tr>';
echo '<tr><td align="right" width="100" style="white-space: nowrap">Telefone Comercial:</td><td><input type="text" class="texto" name="contato_tel" value="'.$linha->contato_tel.'" maxlength="30" size="25" /></td></tr>';
echo '<tr><td align="right" style="white-space: nowrap">Telefone Residencial:</td><td><input type="text" class="texto" name="contato_tel2" value="'.$linha->contato_tel2.'" maxlength="30" size="25" /></td></tr>';
echo '<tr><td align="right" style="white-space: nowrap">Celular:</td><td><input type="text" class="texto" name="contato_cel" value="'.$linha->contato_cel.'" maxlength="30" size="25" /></td></tr>';
echo '<tr><td align="right" width="100" style="white-space: nowrap">E-mail:</td><td style="white-space: nowrap"><input type="text" class="texto" name="contato_email" value="'.$linha->contato_email.'" maxlength="255" size="25" /></td></tr>';
echo '<tr><td align="right" style="white-space: nowrap">2º E-Mail:</td><td><input type="text" class="texto" name="contato_email2" value="'.$linha->contato_email2.'" maxlength="255" size="25" /></td></tr>';
echo '<tr><td align="right" style="white-space: nowrap">Página Web:</td><td><input type="text" class="texto" name="contato_url" value="'.$linha->contato_url.'" maxlength="255" size="25" /></td></tr>';
$data = new CData($linha->contato_nascimento);
echo '<tr><td align="right" style="white-space: nowrap">Aniversário:</td><td style="white-space: nowrap"><input type="text" class="texto" name="contato_nascimento" value="'.( $linha->contato_nascimento && $linha->contato_nascimento!='0000-00-00' ? $data->format('%d/%m/%Y') : '').'" maxlength="10" size="25" onkeyup="barra(this)" />(dd/mm/aaaa)</td></tr>';
...
echo '</td></tr>';
echo '</table></td>';
echo '<td valign="top" width="50%"><b>Observação do Contato</b><br /><textarea class="textarea" name="contato_notas" rows="20" cols="40">'.$linha->contato_notas.'</textarea></td></tr>';

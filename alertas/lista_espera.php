...
echo '<tr><td align=center><h1>Envio de mensagem na lista de espera</h1></td></tr>';
echo '<tr><td align=center>&nbsp;</td></tr>';
echo '<tr><td align=center>Verificando a lista ...</td></tr>';
echo '<tr><td align=center>&nbsp;</td></tr>';
$espera = new EventoFila;
$espera->verificar();
echo '<tr><td align=center>Feito, '.($espera->evento_contagem ? ($espera->evento_contagem==1 ? 'uma mensagem enviada' : $espera->evento_contagem.' mensagens enviadas.') : ' nenhuma mensagem enviada!')."\n".'</td></tr>';
echo '<tr><td align=center>&nbsp;</td></tr>';
echo '</table>';

...
if (!class_exists("CoolTreeView",FALSE)) { 
	...
	class treenode { 
		...
		public $_bls; public $_bOs;
		
		public function __construct( $_blt, $_bO3="", $_bOt=FALSE, $_blu="", $_bOu="") {
			$this->id =$_blt; 
			$this->text =$_bO3; 
			$this->image =$_blu; 
			$this->expand =$_bOt; 
		...
		public function addchild( $_blv) {
			$_blv->_bOs =$this; 
			array_push($this->_blr ,$_blv); 
			} 
		
		public function adddata( $_bOv, $_blw) {
			$this->_bls[$_bOv]=$_blw; 
			} 
		} 
	
	class cooltreeview { 
		public $_bl0="2.0.\067.1";
		public $id;
		public $_bOw;
		public $_blx;
		public $_bOx;
		...
		public $imageFolder;
		public $selectedIds;
		public $selectEnable=TRUE;
		public $selectDisableIds;
		public $multipleSelectEnable=FALSE;
		public $DragAndDropEnable=FALSE;
		public $dragDisableIds;
		public $dropDisableIds;
		public $EditNodeEnable=FALSE;
		public $editDisableIds;
		public $isSubTree=FALSE;
		public $singleExpand=FALSE;
		public $keepState="none";
		public $keepStateHours=030;
		public $showLines=FALSE;
		public $scriptFolder="";
		
		public function __construct( $_blt) {
			$this->id =$_blt; 
		...
		public function _bO10( $_bl11, $_bO11) {
		...
		public function add( $_bl15, $_blt, $_bO3="", $_bOt=FALSE, $_blu="", $_bOu="") {
		...
		public function getrootnode() { return $this->_bOw; }
		
		public function getnode( $_bl16) { return $this->_bOx[$_bl16]; }
		
		public function _bO13() {

 ...
 *  allows you to easily include all the calendar arquivos and setup the
...
class DHTML_Calendar {
    ...
    public function __construct( $calendar_lib_path = '/calendar/',
                                 $lingua              = 'en',
        ...
        $this->calendar_lang_file = 'lang/calendar-' . $lingua . '.js';
    ...
    public function set_option( $name, $valor) {
        $this->calendar_options[$name] = $valor;
    }
    ...
    public function make_input_field( $cal_options = array(), $field_attributes = array()) {
        ...
        $options = array_merge($cal_options,
                               array('inputField' => $this->_campo_id($id),
    ...
    public function _campo_id( $id) { return 'f-calendar-field-' . $id; }
    public function _trigger_id( $id) { return 'f-calendar-trigger-' . $id; }
    public function _gen_id() { static $id = 0; return ++$id; }

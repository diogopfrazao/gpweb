...
class Stylesheet {
   ...
   */
  public static $ACCEPTED_MEDIA_TYPES = array("all", "static", "visual",
                                       "bitmap", "paged", "print");
  ...
  public function __construct() {
    ...
    list($this->_protocol, $this->_base_host, $this->_base_path) = explode_url(previnirXSS($_SERVER["SCRIPT_FILENAME"]));
   ...
   *
   * @param Style $superior The style of this style's parent in the DOM tree
   * @return Style
   */
  public function create_style( $superior = null) {
    return new Style($this, $superior);
  }
   ...
   * @param string $css
   */
  public function load_css( &$css) { $this->_parse_css( $css); }
...
//      echo "</pre>";
  ...
  private function _parse_sections($str) {
    ...
    $padraos = array("/[\\s\n]+/", "/\\s+([>.:+#])\\s+/");
    $substitutos = array(" ", "\\1");
    $str = preg_replace($padraos, $substitutos, $str);

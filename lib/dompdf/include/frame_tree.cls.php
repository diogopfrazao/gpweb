...
class Frame_Tree {
   ...
   * @return DomDocument
   */
  public function get_dom() { return $this->_dom; }
   ...
   * @return Frame
   */
  public function get_frame( $id) { return isset($this->_registry[$id]) ? $this->_registry[$id] : null; }
   ...
   */
  public function get_frames() { return new FrameTreeList( $this->_root); }

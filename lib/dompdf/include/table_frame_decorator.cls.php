...
class Table_Frame_Decorator extends Frame_Decorator {  
  ...
  /**
   * Table header rows.  Each table header is duplicard when a table
   * spans pages.
   *
   * @var array
   */
  ...
  /**
   * Table footer rows.  Each table footer is duplicard when a table
   * spans pages.
   *
   * @var array
   */
  ...
  public function split( $child = null) {
    ...
    // not duplicar headers, simply move the table to the next page.    
   ...
   * @return Cellmap
   */
  public function get_cellmap() { return $this->_cellmap; }
   ...
   * @return float
   */
  public function get_min_width() { return $this->_min_width; }
   ...
   * @return float
   */
  public function get_max_width() { return $this->_max_width; }
   ...
   */  
  public function set_min_width( $width) { $this->_min_width = $width; }
   ...
   */
  public function set_max_width( $width) { $this->_max_width = $width; }

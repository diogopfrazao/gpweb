...
class Cellmap {
  ...
  public function get_num_rows() { return $this->_num_rows; }
  public function get_num_cols() { return $this->_num_cols; }
  ...
  public function add_frame( Frame $frame) {
    ...
    for ( $cs = 0; $cs < $colspan; $cs++ ) {
      ...
      // requested percentagem or absolute values with the existing widths

...
class CPDF_Adapter implements Canvas {
   ...
   * @var array;
   */
  public static $PAPER_SIZES = array( "4a0" => array(0,0,4767.87,6740.79),
   ...
   * @return Cpdf
   */
  public function get_cpdf() { return $this->_pdf; }
   ...
   * @return int
   */
  public function get_page_number() { return $this->_page_number; }

  /**
   * Returns the total number of pages in the document
   * @return int
   */
  public function get_page_count() { return $this->_page_count; }
   ...
   * @param int $num
   */
  public function set_page_number( $num) { $this->_page_number = $num; }
   ...
   * @param int $count
   */
  public function set_page_count( $count) {  $this->_page_count = $count; }
  ...
  public function filled_rectangle( $x1, $y1, $w, $h, $color, $blend = "Normal", $opacity = 1.0) {
  ...
  public function polygon( $points, $color, $width = null, $style = array(),
  ...
  public function circle( $x, $y, $r1, $color, $width = null, $style = null,
                          $fill = false, $blend = "Normal", $opacity = 1.0) {
  ...
  public function text( $x, $y, $text, $font, $size, $color = array(0,0,0),
   ...
   * @return string
   */
  public function get_messages() { return $this->_pdf->messages; }

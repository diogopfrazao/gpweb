...
class Cached_PDF_Decorator extends CPDF_Adapter implements Canvas {
  ...
  public function get_cpdf() { return $this->_pdf->get_cpdf(); }

  public function open_object() { $this->_pdf->open_object(); }
  public function reopen_object() { return $this->_pdf->reopen_object(); }
  
  public function close_object() { $this->_pdf->close_object(); }

  public function add_object( $object, $where = 'all') { $this->_pdf->add_object( $object, $where); }

  public function serialize_object( $id) { $this->_pdf->serialize_object( $id); }

  public function reopen_serialized_object( $obj) { $this->_pdf->reopen_serialized_object( $obj); }
    
  //........................................................................

  public function get_width() { return $this->_pdf->get_width(); }
  public function get_height() {  return $this->_pdf->get_height(); }
  public function get_page_number() { return $this->_pdf->get_page_number(); }
  public function get_page_count() { return $this->_pdf->get_page_count(); }

  public function set_page_number( $num) { $this->_pdf->set_page_number( $num); }
  public function set_page_count( $count) { $this->_pdf->set_page_count( $count); }
  ...
  public function get_messages() { return $this->_pdf->get_messages(); }

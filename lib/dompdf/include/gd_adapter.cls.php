 ...
 * Not super-useful dia-to-dia but handy nonetheless
 *
 * @package dompdf
 */
class GD_Adapter implements Canvas {
   ...
   * @return resource
   */
  public function get_image() { return $this->_img; }
   ...
   * @return float
   */
  public function get_width() { return $this->_width / $this->_aa_factor; }
   ...
   * @return float
   */
  public function get_height() { return $this->_height / $this->_aa_factor; }

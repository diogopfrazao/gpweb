...
abstract class Frame_Decorator extends Frame {
  ...
  public function get_node() { return $this->_frame->get_node(); }
  public function get_id() { return $this->_frame->get_id(); }
  public function get_style() { return $this->_frame->get_style(); }
  public function get_original_style() { return $this->_frame->get_original_style(); }
  public function get_containing_block( $i = null) { return $this->_frame->get_containing_block( $i); }
  public function get_position( $i = null) { return $this->_frame->get_position( $i); }
...
//   }
  ...
  public function get_margin_height() { return $this->_frame->get_margin_height(); }
  public function get_margin_width() { return $this->_frame->get_margin_width(); }
  public function get_padding_box() { return $this->_frame->get_padding_box(); }
  public function get_border_box() { return $this->_frame->get_border_box(); }

  public function set_id( $id) { $this->_frame->set_id( $id); }
  public function set_style( Style $style) { $this->_frame->set_style( $style); }
  ...
  public function __toString() { return $this->_frame->__toString(); }
  ...
  public function get_reflower() { return $this->_reflower; }
   ...
   * @param Frame $child
   */
  public function split( $child = null) {
  ...
  public final function position() { $this->_positioner->position();  }
  
  public final function reflow() {
  ...
  public final function get_min_max_width() { return $this->get_reflower()->get_min_max_width(); }

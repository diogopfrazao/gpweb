...
class DOMPDF {
  ...
  public function set_protocol( $proto) { $this->_protocol = $proto; }
   ...
   * @param string $host
   */
  public function set_host( $host) { $this->_base_host = $host; }
   ...
   * @param string $path
   */
  public function set_base_path( $path) { $this->_base_path = $path; }
   ...
   * @return string
   */
  public function get_protocol() { return $this->_protocol; }
   ...
   * @return string
   */
  public function get_host() { return $this->_base_host; }
   ...
   * @return string
   */
  public function get_base_path() { return $this->_base_path; }
   ...
   * @return Canvas
   */
  public function get_canvas() { return $this->_pdf; }

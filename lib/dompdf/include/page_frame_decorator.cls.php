...
//        echo "after: avoid\n";
      ...
      $superior = $frame->get_parent();
      if ( $prev && $superior && $superior->get_style()->page_break_inside == "avoid" ) {
//          echo "parent inside: avoid\n";
      ...
      if ( $superior->get_node()->nodeName == "body" && !$prev ) {
...
//          echo "Body's first child.\n";
      ...
      if ( !$prev && $superior ) 
        return $this->_page_break_allowed( $superior );
...
//     echo "no valid break found, just splitting.\n";
  ...
  public function split( $frame = null) {
    // Do nothing
  }

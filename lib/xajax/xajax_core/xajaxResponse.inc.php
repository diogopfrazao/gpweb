...
class xajaxResponse
{
	...
	*/
	public function assign( $sTarget, $sAttribute, $inicioData)
	{
		return $this->addCommand(
			array(
					'cmd'=>'as',
	...
	/*
		...
		object : The <xajaxResponse> object.
	*/
	public function append( $sTarget, $sAttribute, $inicioData)
	{	
		return $this->addCommand(
			array(
					'cmd'=>'ap',
	...
	/*
		...
		object : The <xajaxResponse> object.
	*/
	public function prepend( $sTarget, $sAttribute, $inicioData)
	{
		return $this->addCommand(
			array(
					'cmd'=>'pp',
	...
	*/
	public function replace( $sTarget, $sAttribute, $sSearch, $inicioData)
	{
		return $this->addCommand(
			array(
					'cmd'=>'rp',
	...
	*/
	...
	/*
		...
		object : The <xajaxResponse> object.
	*/
	public function contextAssign( $sAttribute, $inicioData)
	{
		return $this->addCommand(
			array(
					'cmd'=>'c:as', 
	...
	/*
		...
		object : The <xajaxResponse> object.
	*/
	public function contextAppend( $sAttribute, $inicioData)
	{
		return $this->addCommand(
			array(
					'cmd'=>'c:ap', 
	...
	/*
		...
		object : The <xajaxResponse> object.
	*/
	public function contextPrepend( $sAttribute, $inicioData)
	{
		return $this->addCommand(
			array(
					'cmd'=>'c:pp', 
	...
	*/
	public function _printEscapedString_XML( &$inicioData)
	{

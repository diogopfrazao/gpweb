...
class Data_Intervalo {
     ...
     * @access public
     */
    public function setFromSeconds( $segundos)
    {
        if ($segundos < 0) {
            return false;
        }
     ...
     * @access public
     */
    public function setFromMinutes( $minutos)
    {
     ...
     * @access public
     */
    public function setFromHours( $horas)
    {
     ...
     * @access public
     */
    public function setFromDays( $dias)
    {
     ...
     * @access public
     */
    public function setFromDateDiff( $data1, $data2)
    {

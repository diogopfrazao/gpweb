...
class Data_Calc
{
    ...
    public static function isValidDate( $dia, $mes, $ano)
    {
        if($ano < 0 || $ano > 9999)
            return false;
    ...
    public static function isLeapYear( $ano="")
    {
    ...
    public static function isFuturfimData( $dia, $mes, $ano)
    {
    ...
    public static function isPastDate( $dia, $mes, $ano)
    {
        $this_ano = Data_Calc::dateNow("%Y");
        $this_mes = Data_Calc::dateNow("%m");
        $this_dia = Data_Calc::dateNow("%d");
    ...
    public static function diaDaSemana( $dia="", $mes="", $ano="")
    {
    ...
    public static function semanaDoAno( $dia, $mes, $ano)
    {
        if(empty($ano))
            $ano = Data_Calc::dateNow("%Y");
        if(empty($mes))
    ...
    public static function dataJuliana( $dia="", $mes="", $ano="")
    {
        if(empty($ano))
            $ano = Data_Calc::dateNow("%Y");
        if(empty($mes))
    ...
    public static function quarterOfYear( $dia="", $mes="", $ano="")
    {
        if(empty($ano))
            $ano = Data_Calc::dateNow("%Y");
        if(empty($mes))
    ...
    public static function beginOfNextMonth( $dia="", $mes="", $ano="", $format="%Y%m%d")
    {
        if(empty($ano))
            $ano = Data_Calc::dateNow("%Y");
        if(empty($mes))
    ...
    public static function endOfNextMonth( $dia="", $mes="", $ano="", $format="%Y%m%d")
    {
        if(empty($ano))
            $ano = Data_Calc::dateNow("%Y");
        if(empty($mes))
    ...
    public static function beginOfPrevMonth( $dia="", $mes="", $ano="", $format="%Y%m%d")
    {
        if(empty($ano))
            $ano = Data_Calc::dateNow("%Y");
        if(empty($mes))
    ...
    public static function endOfPrevMonth( $dia="", $mes="", $ano="", $format="%Y%m%d")
    {
        if(empty($ano))
            $ano = Data_Calc::dateNow("%Y");
        if(empty($mes))
    ...
    public static function nextWeekdia( $dia="", $mes="", $ano="", $format="%Y%m%d")
    {
        if(empty($ano))
            $ano = Data_Calc::dateNow("%Y");
        if(empty($mes))
    ...
    public static function prevWeekdia( $dia="", $mes="", $ano="", $format="%Y%m%d")
    {
        if(empty($ano))
            $ano = Data_Calc::dateNow("%Y");
        if(empty($mes))
    ...
    public static function proxDiaOfWeek( $dow, $dia="", $mes="", $ano="", $format="%Y%m%d", $onOrAfter=false)
    {
        if(empty($ano))
            $ano = Data_Calc::dateNow("%Y");
        if(empty($mes))
    ...
    public static function diaAnteriorOfWeek( $dow, $dia="", $mes="", $ano="", $format="%Y%m%d", $onOrBefore=false)
    {
        if(empty($ano))
            $ano = Data_Calc::dateNow("%Y");
        if(empty($mes))
    ...
    public static function proxDiaOfWeekOnOrAfter( $dow, $dia="", $mes="", $ano="", $format="%Y%m%d")
    {
    ...
    public static function diaAnteriorOfWeekOnOrBefore( $dow, $dia="", $mes="", $ano="", $format="%Y%m%d")
    {
    ...
    public static function proxDia( $dia="", $mes="", $ano="", $format="%Y%m%d")
    {
        if(empty($ano))
            $ano = Data_Calc::dateNow("%Y");
        if(empty($mes))
    ...
    public static function diaAnterior( $dia="", $mes="", $ano="", $format="%Y%m%d")
    {
        if(empty($ano))
            $ano = Data_Calc::dateNow("%Y");
        if(empty($mes))
    ...
    public static function defaultCentury( $ano)
    {
        if(strlen($ano) == 1)
            $ano = "0$ano";
        if($ano > 50)
    ...
    public static function dateDiff( $dia1, $mes1, $ano1, $dia2, $mes2, $ano2)
    {
    ...
    */
    public static function comparfimDatas( $dia1, $mes1, $ano1, $dia2, $mes2, $ano2)
    {
    ...
    public static function diasInMonth( $mes="", $ano="")
    {
        if(empty($ano))
            $ano = Data_Calc::dateNow("%Y");
        if(empty($mes))
    ...
    public static function weeksInMonth( $mes="", $ano="", $fdow=null)
    {
        if(empty($ano))
            $ano = Data_Calc::dateNow("%Y");
        if(empty($mes))
    ...
    public static function firstOfMonthWeekdia( $mes="", $ano="")
    {
        if(empty($ano))
            $ano = Data_Calc::dateNow("%Y");
        if(empty($mes))
    ...
    public static function beginOfMonth( $mes="", $ano="", $format="%Y%m%d")
    {
        if(empty($ano))
            $ano = Data_Calc::dateNow("%Y");
        if(empty($mes))
    ...
    public static function beginOfWeek( $dia="", $mes="", $ano="", $format="%Y%m%d", $fdow=null)
    {
        if(empty($ano))
            $ano = Data_Calc::dateNow("%Y");
        if(empty($mes))
    ...
    public static function endOfWeek( $dia="", $mes="", $ano="", $format="%Y%m%d", $fdow=null)
    {
        if(empty($ano))
            $ano = Data_Calc::dateNow("%Y");
        if(empty($mes))
    ...
    public static function beginOfNextWeek( $dia="", $mes="", $ano="", $format="%Y%m%d", $fdow=null)
    {
        if(empty($ano))
            $ano = Data_Calc::dateNow("%Y");
        if(empty($mes))
    ...
    public static function beginOfPrevWeek( $dia="", $mes="", $ano="", $format="%Y%m%d", $fdow=null)
    {
        if(empty($ano))
            $ano = Data_Calc::dateNow("%Y");
        if(empty($mes))
    ...
    public static function getCalendarioSemana( $dia="", $mes="", $ano="", $format="%Y%m%d", $fdow=null)
    {
        if(empty($ano))
            $ano = Data_Calc::dateNow("%Y");
        if(empty($mes))
    ...
    public static function getCalendarioMes( $mes="", $ano="", $format="%Y%m%d", $fdow=null){
    ...
    public static function getCalendarioAno( $ano="", $format="%Y%m%d")
    {
        if(empty($ano))
            $ano = Data_Calc::dateNow("%Y");
    ...
    public static function dataParaDias( $dia, $mes, $ano)
    {
    ...
    public static function diasParaData( $dias, $format="%Y%m%d")
    {
    ...
    public function NWeekdiaOfMonth( $occurance, $diaDaSemana, $mes, $ano, $format="%Y%m%d")
    {
        $ano = sprintf("%04d",$ano);
        $mes = sprintf("%02d",$mes);
    ...
    public static function dateFormat( $dia, $mes, $ano, $format)
    {
    ...
    public static function getMesNomeCompl( $mes)
    {
        $mes = (int)$mes;
    ...
    public static function getMesNomeAbrev( $mes, $length=3)
    {
        $mes = (int)$mes;
    ...
    public static function getSemanaNomeCompl( $dia="", $mes="", $ano="")
    {
        if(empty($ano))
            $ano = Data_Calc::dateNow("%Y");
        if(empty($mes))
    ...
    public static function getSemanaNomeAbrev( $dia="", $mes="", $ano="", $length=3)
    {
        if(empty($ano))
            $ano = Data_Calc::dateNow("%Y");
        if(empty($mes))
    ...
    */
    public function getMonthFromFullName( $mes)
    {
        $mes = strtolower($mes);

...
function mudar_percentagem_instrumento($instrumento_id=null, $instrumento_porcentagem=null){
	$sql = new BDConsulta;
...
$xajax->registerFunction("mudar_percentagem_instrumento");

$cor = getSisValor('SituacaoInstrumentoCor');

function mudar_status_instrumento($instrumento_id=null, $instrumento_situacao=null){
	global $cor;
	$sql = new BDConsulta;
	$sql->adTabela('instrumento');
...
$xajax->registerFunction("mudar_status_instrumento");

...
global $m, $a, $u, $tab, $perms, $cia_id, $usuario_id, $dialogo, $ano, $estilo_interface;
...
echo '<th style="white-space: nowrap">'.dica('Tendência', 'Tendência apresentada pelos últimos 3 valores registrados no indicador.').'<b>Tendência</b>'.dicaF().'</th>';
echo '</tr>';
$fp = -1;
$id = 0;
$qnt=0;

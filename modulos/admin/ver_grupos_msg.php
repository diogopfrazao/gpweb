...
$sql->adCampo('grupo_permissao_grupo');
$sql->adOnde('grupo_permissao_usuario='.(int)$usuario_id);
$permissao = $sql->ListaChave('grupo_permissao_grupo');
$sql->limpar();
$sql->adTabela('grupo_usuario');
$sql->adCampo('grupo_usuario_grupo');
$sql->adOnde('grupo_usuario_usuario='.(int)$usuario_id);

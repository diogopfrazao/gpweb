...
if (!$dialogo){
	...
	$km->Add('ver','ver_mes',dica('Visão Mensal','Visualizar o mês inteiro.').'Visão Mensal'.dicaF(), "javascript: void(0);' onclick='url_passar(0, \"m=calendario&a=index&data=".$data_inicio->format('%Y%m%d')."\");");
	$km->Add('ver','ver_dia',dica('Visão Diária','Visualizar o dia.').'Visão Diária'.dicaF(), "javascript: void(0);' onclick='url_passar(0, \"m=calendario&a=ver_dia&data=".$data_inicio->format('%Y%m%d')."&tab=0\");");
	...
	if ($podeEditar && $editar) {	
		$km->Add("inserir","inserir_registro",dica('Registro de Ocorrência','Inserir um novo registro de ocorrência.').'Registro de ocorrência'.dicaF(), "javascript: void(0);' onclick='url_passar(0, \"m=praticas&a=log_editar&evento_id=".$evento_id."\");");
		...
		if ($Aplic->modulo_ativo('foruns') && $Aplic->checarModulo('foruns', 'adicionar')) $km->Add("diverso","inserir_forum",dica('Novo Fórum', 'Inserir um novo fórum relacionado.').'Fórum'.dicaF(), "javascript: void(0);' onclick='url_passar(0, \"m=foruns&a=editar&forum_evento=".$evento_id."\");");
		...
		if ($Aplic->checarModulo('praticas', 'adicionar', null, 'avaliacao_indicador')) $km->Add("diverso","inserir_avaliacao",dica('Nova Avaliação', 'Inserir uma nova avaliação relacionada.').'Avaliação'.dicaF(), "javascript: void(0);' onclick='url_passar(0, \"m=praticas&a=avaliacao_editar&avaliacao_evento=".$evento_id."\");");
...
if ($obj->evento_cia) echo '<tr><td align="right" style="white-space: nowrap">'.dica(ucfirst($config['organizacao']).' Responsável', ucfirst($config['genero_organizacao']).' '.$config['organizacao'].' responsável por este evento.').ucfirst($config['organizacao']).' responsável:'.dicaF().'</td><td class="realce" width="100%">'.link_cia($obj->evento_cia).'</td></tr>';
...
if ($obj->evento_dept) echo '<tr><td align="right" style="white-space: nowrap">'.dica(ucfirst($config['departamento']).' Responsável', ucfirst($config['genero_dept']).' '.$config['departamento'].' responsável por este evento.').ucfirst($config['departamento']).' responsável:'.dicaF().'</td><td class="realce" width="100%">'.link_dept($obj->evento_dept).'</td></tr>';
...
if ($saida_depts) echo '<tr><td align="right" valign="top" style="white-space: nowrap">'.dica(ucfirst($config['departamentos']).' Envolvid'.$config['genero_dept'].'s', 'Qual '.strtolower($config['departamento']).' está envolvid'.$config['genero_dept'].' com este evento'.'.').ucfirst($config['departamentos']).' envolvid'.$config['genero_dept'].'s:'.dicaF().'</td><td width="100%" colspan="2" class="realce">'.$saida_depts.'</td></tr>';
...
echo '<tr><td align="right" style="white-space: nowrap">'.dica('Responsável', 'O responsável pelo evento.').'Responsável:'.dicaF().'</td><td class="realce" style="text-align: justify;">'.link_usuario($obj->evento_dono,'','','esquerda').'</td></tr>';
...
if ($saida_quem) echo '<tr><td align="right" style="white-space: nowrap">'.dica('Sem Confirmação', 'Quais '.$config['genero_usuario'].'s '.$config['usuarios'].' que tem ainda não confirmaram presença neste compromisso.').'Sem confirmação:'.dicaF().'</td><td class="realce" style="text-align: justify;">'.$saida_quem.'</td></tr>';
...
if ($saida_quem) echo '<tr><td align="right" style="white-space: nowrap">'.dica('Confirmação', 'Quais '.$config['genero_usuario'].'s '.$config['usuarios'].' que tem confirmaram presença neste compromisso.').'Confirmou:'.dicaF().'</td><td class="realce" style="text-align: justify;">'.$saida_quem.'</td></tr>';
...
if ($obj->evento_tarefa) echo '<tr><td align="right" style="white-space: nowrap">'.dica(ucfirst($config['tarefa']), 'Este evento é específico de  um'.($config['genero_tarefa']=='a' ?  'a' : '').' '.$config['tarefa'].'.').ucfirst($config['tarefa']).':'.dicaF().'</td><td align="left" class="realce">'.link_tarefa($obj->evento_tarefa).'</td></tr>';
elseif ($obj->evento_projeto) echo '<tr><td align="right" style="white-space: nowrap">'.dica(ucfirst($config['projeto']).' Relacionad'.$config['genero_projeto'], 'Este evento é específico de um'.($config['genero_projeto']=='o' ? '' : 'a').' '.$config['projeto'].'.').ucfirst($config['projeto']).':'.dicaF().'</td><td align="left" class="realce">'.link_projeto($obj->evento_projeto).'</td></tr>';
elseif ($obj->evento_pratica) echo '<tr><td align="right" style="white-space: nowrap">'.dica(ucfirst($config['pratica']), 'Este evento é específico de '.($config['genero_pratica']=='a' ? 'uma ': 'um ').$config['pratica'].'.').ucfirst($config['pratica']).':'.dicaF().'</td><td align="left" class="realce">'.link_pratica($obj->evento_pratica).'</td></tr>';
elseif ($obj->evento_acao) echo '<tr><td align="right" style="white-space: nowrap">'.dica(ucfirst($config['acao']), 'Este evento é específico de um'.($config['genero_acao']=='a' ?  'a' : '').' '.$config['acao'].'.').ucfirst($config['acao']).':'.dicaF().'</td><td align="left" class="realce">'.link_acao($obj->evento_acao).'</td></tr>';
elseif ($obj->evento_indicador) echo '<tr><td align="right" style="white-space: nowrap">'.dica('Indicador', 'Este evento é específico de um indicador.').'Indicador:'.dicaF().'</td><td align="left" class="realce">'.link_indicador($obj->evento_indicador).'</td></tr>';
elseif ($obj->evento_tema) echo '<tr><td align="right" style="white-space: nowrap">'.dica(ucfirst($config['tema']), 'Este evento é específico de '.($config['genero_tema']=='o' ? 'um' : 'uma').' '.$config['tema'].'.').ucfirst($config['tema']).':'.dicaF().'</td><td align="left" class="realce">'.link_tema($obj->evento_tema).'</td></tr>';
elseif ($obj->evento_objetivo) echo '<tr><td align="right" style="white-space: nowrap">'.dica(ucfirst($config['objetivo']), 'Este evento é específico de '.($config['genero_objetivo']=='o' ? 'um' : 'uma').' '.$config['objetivo'].'.').''.ucfirst($config['objetivo']).':'.dicaF().'</td><td align="left" class="realce">'.link_objetivo($obj->evento_objetivo).'</td></tr>';
elseif ($obj->evento_fator) echo '<tr><td align="right" style="white-space: nowrap">'.dica(ucfirst($config['fator']), 'Este evento é específico de '.($config['genero_fator']=='o' ? 'um' : 'uma').' '.$config['fator'].'.').ucfirst($config['fator']).':'.dicaF().'</td><td align="left" class="realce">'.link_fator($obj->evento_fator).'</td></tr>';
elseif ($obj->evento_estrategia) echo '<tr><td align="right" style="white-space: nowrap">'.dica(ucfirst($config['iniciativa']), 'Este evento é específico de '.($config['genero_iniciativa']=='o' ? 'um' : 'uma').' '.$config['iniciativa'].'.').'Iniciativas estratégicas:'.dicaF().'</td><td align="left" class="realce">'.link_estrategia($obj->evento_estrategia).'</td></tr>';
elseif ($obj->evento_meta) echo '<tr><td align="right" style="white-space: nowrap">'.dica(ucfirst($config['meta']), 'Este evento é específico de '.($config['genero_meta']=='o' ? 'um' : 'uma').' '.$config['meta'].'.').ucfirst($config['meta']).':'.dicaF().'</td><td align="left" class="realce">'.link_meta($obj->evento_meta).'</td></tr>';
elseif ($obj->evento_calendario) echo '<tr><td align="right" style="white-space: nowrap">'.dica('Agenda', 'Este evento é específico de uma agenda.').'Agenda:'.dicaF().'</td><td align="left" class="realce">'.link_calendario($obj->evento_calendario).'</td></tr>';
if ($obj->evento_descricao) echo '<tr><td align="right" style="white-space: nowrap">'.dica('Descrição', 'Um resumo sobre o evento.').'Descrição'.dicaF().'</td><td class="realce" style="text-align: justify;">'.$obj->evento_descricao.'</td></tr>';


if ($obj->evento_inicio) echo '<tr><td align="right" style="white-space: nowrap">'.dica('Data de Início', 'A data prevista de início do evento.').'Data de início:'.dicaF().'</td><td class="realce" width="100%" style="margin-bottom:0cm; margin-top:0cm;">'.retorna_data($obj->evento_inicio, true).'</td></tr>';
if ($obj->evento_fim) echo '<tr><td align="right" style="white-space: nowrap">'.dica('Data de Término', 'A data prevista de término do evento.').'Data de término:'.dicaF().'</td><td class="realce" width="100%" style="margin-bottom:0cm; margin-top:0cm;">'.retorna_data($obj->evento_fim, true).'</td></tr>';
if ($obj->evento_duracao) echo '<tr><td align="right" style="white-space: nowrap">'.dica('Duração', 'A duração do evento em dias.').'Duração:'.dicaF().'</td><td width="100%" class="realce">'.number_format(((float)$obj->evento_duracao/($config['horas_trab_diario'] ? $config['horas_trab_diario'] : 8)), 2, ',', '.').'</td></tr>';



if ($obj->evento_recorrencias) echo '<tr><td align="right" style="white-space: nowrap">'.dica('Recorrência', 'De quanto em quanto tempo este evento se repete.').'Recorrência:'.dicaF().'</td><td class="realce" style="text-align: justify;">'.$recorrencia[$obj->evento_recorrencias].($obj->evento_recorrencias ? ' ('.$obj->evento_nr_recorrencias.' vez'.((int)$obj->evento_nr_recorrencias > 1 ? 'es':''). ')' : '').'</td></tr>';
if ($obj->evento_diautil) echo '<tr><td align="right">'.dica('De 2ª a 6ª feira', 'A faixa de tempo do evento não inclue os fins de semana.').'De 2ª a 6ª feira:'.dicaF().'</td><td class="realce" width="100%">'.($obj->evento_diautil  ? 'Sim' : 'Não').'</td></tr>';	




if ($obj->evento_oque) echo '<tr><td align="right" valign="top" style="white-space: nowrap">'.dica('O Que Fazer', 'Sumário sobre o que se trata este evento.').'O Que:'.dicaF().'</td><td class="realce" width="100%">'.$obj->evento_oque.'</td></tr>';
if ($obj->evento_quem) echo '<tr><td align="right" valign="top" style="white-space: nowrap">'.dica('Quem', 'Quem está relacinado com este evento.').'Quem:'.dicaF().'</td><td class="realce" width="100%">'.$obj->evento_quem.'</td></tr>';
if ($obj->evento_quando) echo '<tr><td align="right" valign="top" style="white-space: nowrap">'.dica('Quando Fazer', 'Quando o evento é executado.').'Quando:'.dicaF().'</td><td class="realce" width="100%">'.$obj->evento_quando.'</td></tr>';
if ($obj->evento_onde) echo '<tr><td align="right" valign="top" style="white-space: nowrap">'.dica('Onde Fazer', 'Onde o evento é executado.').'Onde:'.dicaF().'</td><td class="realce" width="100%">'.$obj->evento_onde.'</td></tr>';
if ($obj->evento_porque) echo '<tr><td align="right" valign="top" style="white-space: nowrap">'.dica('Por Que Fazer', 'Por que o evento será executado.').'Por que:'.dicaF().'</td><td class="realce" width="100%">'.$obj->evento_porque.'</td></tr>';
if ($obj->evento_como) echo '<tr><td align="right" valign="top" style="white-space: nowrap">'.dica('Como Fazer', 'Como o evento é executado.').'Como:'.dicaF().'</td><td class="realce" width="100%">'.$obj->evento_como.'</td></tr>';
...
if (count($lista)) {
	echo '<tr><td align="right" style="white-space: nowrap" valign="middle">'.dica('Relacionado', 'A que área o evento está relacionado.').'Relacionado:'.dicaF().'</td></td><td class="realce">';	
...
if ($obj->evento_recorrencia_pai) echo '<tr><td align="right" style="white-space: nowrap">'.dica('Rencorrência de Evento', 'De qual evento original este é recorrência.').'Recorrência de:'.dicaF().'</td><td class="realce" style="text-align: justify;">'.link_evento($obj->evento_recorrencia_pai).'</td></tr>';

if ($obj->evento_principal_indicador) echo '<tr><td align="right" style="white-space: nowrap">'.dica('Indicador Principal', 'Dentre os indicadores relacionados, o mais representativo da situação geral.').'Indicador principal:'.dicaF().'</td><td width="100%" class="realce">'.link_indicador($obj->evento_principal_indicador).'</td></tr>';
...
echo '<tr><td align="right">'.dica('Ativo', 'Indica se o evento ainda está ativo.').'Ativo:'.dicaF().'</td><td class="realce" width="100%">'.($obj->evento_ativo  ? 'Sim' : 'Não').'</td></tr>';	

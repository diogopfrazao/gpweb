...
function popJornada() {
	...
	else window.open('./index.php?m=publico&a=selecionar&dialogo=1&chamar_volta=setJornada&tabela=jornada&jornada_id='+document.getElementById('jornada_id').value, 'Calendário','left=0,top=0,height=700,width=700,scrollbars=yes, resizable=yes');
	}

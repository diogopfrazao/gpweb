...
if (!$dialogo){
  ...
  $saida.='<table cellspacing=0 cellpadding=0>';
	...
	$imprimir='<tr><td style="white-space: nowrap">'.dica('Imprimir o Ano', 'Clique neste ícone '.imagem('imprimir_p.png').' para abrir uma nova janela onde poderá imprimir o ano a partir do navegador Web.').'<a href="javascript: void(0);" onclick ="url_passar(1,\'m=calendario&a=ver_ano&dialogo=1&data='.$data.'\');">'.imagem('imprimir_p.png').'</a>'.dicaF().'</td></tr>';
...
echo '<tr>';
echo '<td style="border-style:solid;border-width:1px" class="evento">&nbsp;&nbsp;</td><td style="white-space: nowrap">evento</td><td>&nbsp;</td>';
echo '<td style="border-style:solid;border-width:1px" class="acao">&nbsp;&nbsp;</td><td style="white-space: nowrap">ação de '.$config['acao'].'</td><td>&nbsp;</td>';
echo '<td style="border-style:solid;border-width:1px" class="tarefa">&nbsp;&nbsp;</td><td style="white-space: nowrap">'.$config['tarefa'].'</td><td>&nbsp;</td>';
if ($Aplic->modulo_ativo('atas')) echo '<td style="border-style:solid;border-width:1px" class="ata">&nbsp;&nbsp;</td><td style="white-space: nowrap">ata de reunião</td><td>&nbsp;</td>';
if ($Aplic->modulo_ativo('atas')) echo '<td style="border-style:solid;border-width:1px;" class="ata_acao">&nbsp;&nbsp;</td><td style="white-space: nowrap">ação de ata de reunião</td><td>&nbsp;</td>';
if ($Aplic->modulo_ativo('problema')) echo '<td style="border-style:solid;border-width:1px" class="problema">&nbsp;&nbsp;</td><td style="white-space: nowrap">'.$config['problema'].'</td><td>&nbsp;</td>';
echo '<td style="border-style:solid;border-width:1px" class="multiplo">&nbsp;&nbsp;</td><td style="white-space: nowrap">múltiplos</td><td>&nbsp;</td>';
echo '</tr>';
echo '<tr>';
...
echo '<td style="border-style:solid;border-width:1px;" class="expediente_alternativo">&nbsp;&nbsp;</td><td style="white-space: nowrap">alterntivo</td><td>&nbsp;</td>';

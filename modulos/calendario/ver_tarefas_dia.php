...
global $envolvimento, $este_dia, $periodo_todo, $primeiraData, $ultimaData, $cia_id, $dept_id, $usuario_id,
	$projeto_id,
	$tarefa_id,
	$pg_perspectiva_id,
	$tema_id,
...
$tarefas = CTarefa::getTarefasParaPeriodo($primeiraData, $ultimaData, $usuario_id, $envolvimento, $cia_id, $dept_id,
	$projeto_id,
	$tarefa_id,
	$pg_perspectiva_id,
	$tema_id,

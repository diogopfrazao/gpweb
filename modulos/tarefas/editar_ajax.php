...
function calcular_duracao($inicio, $fim, $cia_id, $projeto_id=null, $tarefa_id=null){
	...
	$objResposta = new xajaxResponse();
	$objResposta->assign("tarefa_duracao","value", float_brasileiro((float)$horas/($config['horas_trab_diario'] ? $config['horas_trab_diario'] : 8)));
	return $objResposta;
	}
...
function mudar_usuario_ajax($cia_id=0, $usuario_id=0, $campo=null, $posicao=null, $script=null, $segunda_tabela=null, $condicao=null, $pesquisar=null, $estado_sigla=null, $municipio_id=null, $grupo_id=null){
	global $Aplic;
	$pesquisar=previnirXSS(utf8_decode($pesquisar));
	if (!$cia_id) $cia_id=$Aplic->usuario_cia;
	$saida=mudar_usuario_em_dept(true, $cia_id, 0, $campo, $posicao, $script, null, null, null, null, $pesquisar, $estado_sigla, $municipio_id, $grupo_id);
	$objResposta = New xajaxResponse();
	$objResposta->assign($posicao,"innerHTML", $saida);
	return $objResposta;
	}	

...
$eventos = CEvento::getEventoParaPeriodo(null, null, 'todos', '','','', $projeto_id, $tarefa_id);
...
foreach ($eventos as $linha) {
	...
	$html .= '<td width="10%" style="white-space: nowrap">'.imagem('icones/evento'.$linha['evento_tipo'].'.png','Tipo de Evento', 'Cada evento tem um gráfico diferente para facilitar a identificação visual.').'&nbsp;<b>'.$tipos[$linha['evento_tipo']].'</b></td>';

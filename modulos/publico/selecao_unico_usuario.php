...
if (!$cia_id && !$contato) $cia_id=$Aplic->usuario_cia;
...
echo '<tr id="filtro_basico"><td colspan=20><table cellspacing=0 cellpadding=0>';
...
echo '<tr><td style="white-space: nowrap" align="right" width="50">Pesquisar:</td><td align="left" style="white-space: nowrap"><table cellpadding=0 cellspacing=0><tr><td><input type="text" class="texto" style="width:300px;" name="pesquisar" id="pesquisar" value="'.$pesquisar.'" /></td><td><a href="javascript:void(0);" onclick="document.env.pesquisar.value=\'\'; mudar_lista();">'.imagem('icones/limpar_p.gif').'</a></td></tr></table></td></tr>';
...
if (count($usuarios)){
	...
	foreach ($usuarios as $usuario) {
		...
		if($contato && $usuario['usuario_ativo']!='0') {
			if ($usuario['usuario_grupo_dept']) echo '<tr><td>&nbsp;&nbsp;&nbsp;<input type="checkbox" name="usuario[]" id="usuario_'.$usuario['contato_id'].'" value="'.$usuario['contato_id'].'" ' .($usuario['contato_id']==$contato_id ? 'checked="checked"' :''). ' onClick="setUsuario('.$usuario['contato_id'].', \'\',\''.acerta_caracteres($usuario['contato_nomeguerra']).'\', \'\', \''.$campo.'\', \''.acerta_caracteres($contato_cia).'\' ,'.$usuario['cia_id'].','.$usuario['dept_id'].');" /><label for="usuario_'.$usuario['contato_id'].'">'.$usuario['contato_nomeguerra'].'</label></td></tr>';
			else echo '<tr><td>&nbsp;&nbsp;&nbsp;<input type="checkbox" name="usuario[]" id="usuario_'.$usuario['contato_id'].'" value="'.$usuario['contato_id'].'" ' .($usuario['contato_id']==$contato_id ? 'checked="checked"' :''). ' onClick="setUsuario('.$usuario['contato_id'].', \''.$usuario['contato_posto'].'\',\''.($nome_completo && $usuario['contato_nomecompleto'] ? acerta_caracteres($usuario['contato_nomecompleto']) : acerta_caracteres($usuario['contato_nomeguerra'])).'\', \''.$usuario['contato_funcao'].'\', \''.$campo.'\', \''.acerta_caracteres($contato_cia).'\' ,'.$usuario['cia_id'].','.$usuario['dept_id'].');" /><label for="usuario_'.$usuario['contato_id'].'">'.nome_funcao(($config['militar'] < 10 ? $usuario['contato_posto'].' '.$usuario['contato_nomeguerra'] : $usuario['contato_nomeguerra']),'',$usuario['contato_funcao']).'</label></td></tr>';
			}
		elseif($usuario['usuario_ativo']!='0') {
			if ($usuario['usuario_grupo_dept']) echo '<tr><td>&nbsp;&nbsp;&nbsp;<input type="checkbox" name="usuario[]" id="usuario_'.$usuario['usuario_id'].'" value="'.$usuario['usuario_id'].'" ' .($usuario['usuario_id']==$usuario_id ? 'checked="checked"' :''). ' onClick="setUsuario('.$usuario['usuario_id'].', \'\',\''.acerta_caracteres($usuario['contato_nomeguerra']).'\', \'\', \''.$campo.'\', \''.acerta_caracteres($contato_cia).'\' ,'.$usuario['cia_id'].','.$usuario['dept_id'].');" /><label for="usuario_'.$usuario['usuario_id'].'">'.$usuario['contato_nomeguerra'].'</label></td></tr>';
			else echo '<tr><td>&nbsp;&nbsp;&nbsp;<input type="checkbox" name="usuario[]" id="usuario_'.$usuario['usuario_id'].'" value="'.$usuario['usuario_id'].'" ' .($usuario['usuario_id']==$usuario_id ? 'checked="checked"' :''). ' onClick="setUsuario('.$usuario['usuario_id'].', \''.$usuario['contato_posto'].'\',\''.($nome_completo && $usuario['contato_nomecompleto'] ? acerta_caracteres($usuario['contato_nomecompleto']) : acerta_caracteres($usuario['contato_nomeguerra'])).'\', \''.$usuario['contato_funcao'].'\', \''.$campo.'\', \''.acerta_caracteres($contato_cia).'\' ,'.$usuario['cia_id'].','.$usuario['dept_id'].');" /><label for="usuario_'.$usuario['usuario_id'].'">'.nome_funcao(($config['militar'] < 10 ? $usuario['contato_posto'].' '.$usuario['contato_nomeguerra'] : $usuario['contato_nomeguerra']),'',$usuario['contato_funcao']).'</label></td></tr>';
			}
		}
	}
...
function subniveis($dept_id, $subnivel){
	...
	foreach($subordinados as $linha){
		...
		foreach ($usuarios as $usuario) {
			...
			elseif($usuario['usuario_ativo']!='0') {
				if ($usuario['usuario_grupo_dept']) echo '<tr><td>&nbsp;&nbsp;&nbsp;'.$subnivel.'<input type="checkbox" name="usuario[]" id="usuario_'.$usuario['usuario_id'].'" value="'.$usuario['usuario_id'].'" ' .($usuario['usuario_id']==$usuario_id ? 'checked="checked"' :''). ' onClick="setUsuario('.$usuario['usuario_id'].', \'\',\''.acerta_caracteres($usuario['contato_nomeguerra']).'\', \'\', \''.$campo.'\', \''.acerta_caracteres($contato_cia).'\' ,'.$usuario['cia_id'].','.$usuario['dept_id'].');" /><label for="usuario_'.$usuario['usuario_id'].'">'.$usuario['contato_nomeguerra'].'</label></td></tr>';
...
function acerta_caracteres($texto){
...
function setUsuario(usuario_id, posto, nome, funcao, campo, cia_nome, cia_id, dept_id) {
	if(parent && parent.gpwebApp){
		parent.gpwebApp._popupCallback(usuario_id, posto, nome, funcao, campo, cia_nome, cia_id, dept_id);
		return;
		}
	window.opener.<?php echo $chamarVolta?>(usuario_id, posto, nome, funcao, campo, cia_nome, cia_id, dept_id);
	self.close();
	}

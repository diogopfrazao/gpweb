...
echo '<tr id="filtro_basico" style="display:"><td colspan=20><table cellspacing=0 cellpadding=0><tr><td><table cellspacing=0 cellpadding=0>';
...
echo '<tr><td style="white-space: nowrap" align="right" width="50">Pesquisar:</td><td align="left" style="white-space: nowrap"><table cellpadding=0 cellspacing=0><tr><td><input type="text" class="texto" style="width:280px;" name="pesquisar" id="pesquisar" value="'.$pesquisar.'" onchange="mudar_lista();" /><a href="javascript:void(0);" onclick="document.env.pesquisar.value=\'\'; mudar_lista();">'.imagem('icones/limpar_p.gif').'</a></td></tr></table></td></tr>';
...
echo '<tr><td><input type="checkbox" name="usuario[]" id="usuario_0" value="0" onClick="setUsuario();" /><label for="usuario_0">Nenhum'.($config['genero_usuario']=='o' ? ' ' : 'a ').$config['usuario'].'</label>';

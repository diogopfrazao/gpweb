...
echo '<tr><td style="white-space: nowrap" align="right" width="50">Pesquisar:</td><td align="left" style="white-space: nowrap"><table cellpadding=0 cellspacing=0><tr><td><input type="text" class="texto" style="width:230px;" name="pesquisar" id="pesquisar" value="'.$pesquisar.'" onChange="document.env.contatos_enviados.value=0; setContatoIDs();document.env.submit();"  /><a href="javascript:void(0);" onclick="document.env.pesquisar.value=\'\'; document.env.contatos_enviados.value=0; setContatoIDs();document.env.submit();">'.imagem('icones/limpar_p.gif').'</a></td></tr></table></td></tr>';

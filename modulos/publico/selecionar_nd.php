...
echo '<tr><td align="right" style="white-space: nowrap">'.dica('Categoria Econômica', 'Escolha a categoria econômica deste item.').'Categoria econômica:'.dicaF().'</td><td>'.selecionaVetor($vetor_nd_grupo, 'nd_grupo', 'class=texto size=1 style="width:395px;" onchange="env.nd_item_subitem.value=\'\'; mudar_nd();"', $nd_grupo).'</td></tr>';
...
echo '<tr><td align="right" style="white-space: nowrap">'.dica('Modalidade de Aplicação', 'Escolha a modalidade de aplicação deste item.').'Modalidade de aplicação:'.dicaF().'</td><td>'.selecionaVetor($ModalidadeAplicacao, 'nd_elemento_subelemento', 'class=texto size=1 style="width:395px;"  onchange="env.nd_item_subitem.value=\'\'; mudar_nd();"', $nd_elemento_subelemento).'</td></tr>';

...
echo '<tr><td colspan=2 align="center" style="white-space: nowrap"><h1>Segunda conta de '.$config['usuario'].'</h1></td></tr>';
echo '<tr><td align="right" style="white-space: nowrap">Login</td><td><input type="text" name="usuario_login2" class="texto" value="'.$login2.'"/></td></tr>';
echo '<tr><td align="right" style="white-space: nowrap">Senha</td><td><input type="password" name="usuario_senha2" class="texto" /></td></tr>';
...
function enviarDados() {
	...
	else if (f.usuario_login2.value.length < 3) {	

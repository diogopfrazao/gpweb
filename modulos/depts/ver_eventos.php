...
foreach ($eventos as $linha) {
	echo '<tr><td width="25%" style="white-space: nowrap">'.retorna_data($linha['evento_inicio']).'&nbsp;-&nbsp;'.retorna_data($linha['evento_fim']).'</td>';
	echo '<td width="10%" style="white-space: nowrap">'.imagem('icones/evento'.$linha['evento_tipo'].'.png').'&nbsp;<b>'.$tipos[$linha['evento_tipo']].'</b></td>';

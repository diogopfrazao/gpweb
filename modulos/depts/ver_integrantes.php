...
$q->adCampo('usuario_id, contato_email, contato_tel, contato_tel2, contato_cel');
...
foreach ($usuarios as $usuario) {
	...
	if ($usuario['contato_tel']) $telefone=$usuario['contato_tel'];
	elseif ($usuario['contato_tel2']) $telefone=$usuario['contato_tel2'];
	elseif ($usuario['contato_cel']) $telefone=$usuario['contato_cel'];
	else  $telefone='&nbsp;';

...
echo '<tr><td><a href="javascript:void(0);" onclick="url_passar(0, \'m='.$m.'&a='.$a.'&u='.$u.'&recurso_id='.$recurso_id.'&data='.$anoAnterior.'\');">'.dica('Ano Anterior', 'Clique para exibir o ano anterior.').'<img src="'.acharImagem('anterior.gif').'" width="16" height="16" border=0></a></td>';
echo '<th width="100%" align="center">'.htmlentities($data->format('%Y')).'</th><td><a href="javascript:void(0);" onclick="url_passar(0, \'m='.$m.'&a='.$a.'&u='.$u.'&recurso_id='.$recurso_id.'&data='.$anoProximo.'\');">'.dica('Próximo Ano', 'Clique para exibir o próximo ano.').'<img src="'.acharImagem('proximo.gif').'" width="16" height="16" border=0>'.dicaF().'</a></td></tr></table></td></tr>';
...
echo '<td valign="top" align="center" width="200">'.$recurso->calendarioMesAtual(true, ($tab==2 && $a=='ver' && $m=='recursos' ? true : false), ($tab==3 && $a=='ver' && $m=='recursos' ? true : false)).'</td>';
...
echo '</tr></table>';
echo '</td></tr>';
echo '<tr><td align="center"><table align="center" class="minical"><tr><td style="border-style:solid;border-width:1px" class="sobrecarga_25">&nbsp;&nbsp;</td><td style="white-space: nowrap">0-25%</td><td>&nbsp;</td><td style="border-style:solid;border-width:1px" class="sobrecarga_50">&nbsp;&nbsp;</td><td style="white-space: nowrap">25-50%</td><td>&nbsp;</td><td style="border-style:solid;border-width:1px" class="sobrecarga_75">&nbsp;&nbsp;</td><td style="white-space: nowrap">50-75%</td><td>&nbsp;</td><td style="border-style:solid;border-width:1px" class="sobrecarga_95">&nbsp;&nbsp;</td><td style="white-space: nowrap">75-95%</td><td>&nbsp;</td><td class="sobrecarga_100">&nbsp;&nbsp;</td><td style="white-space: nowrap">95-100%</td><td>&nbsp;</td><td class="sobrecarga_acima100">&nbsp;&nbsp;</td><td style="white-space: nowrap">Acima de 100%</td><td>&nbsp;</td><td class="hoje">&nbsp;&nbsp;</td><td style="white-space: nowrap">Hoje</td></tr></table></td></tr>';

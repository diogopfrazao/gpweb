...
if ($del && !$Aplic->checarModulo('arquivos', 'excluir')) $Aplic->redirecionar('m=publico&a=acesso_negado');
elseif ($nao_eh_novo && !$Aplic->checarModulo('arquivos', 'editar'))  $Aplic->redirecionar('m=publico&a=acesso_negado');
elseif (!$nao_eh_novo && !$Aplic->checarModulo('arquivos', 'adicionar')) $Aplic->redirecionar('m=publico&a=acesso_negado');

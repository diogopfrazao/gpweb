...
if ($arquivo_pasta_id > 0) {
	...
	echo '<table border=0 cellpadding=0 cellspacing=1 width="100%"><tr><td><a href="javascript:void(0);" onclick="url_passar(0, \'m='.$m.'&a='.$a.'&u='.$u.'&tab='.$tab.'&arquivo_pasta_id=0\');">'.imagem('icones/inicio.png', 'Voltar para a Raíz', 'Clique neste ícone '.imagem('icones/inicio.png').' para voltar à raíz do diretório.').'</a>';
	echo '<a href="javascript:void(0);" onclick="url_passar(0, \'m='.$m.'&a='.$a.'&u='.$u.'&tab='.$tab.'&arquivo_pasta_id='.$objPasta->arquivo_pasta_superior.'\');">'.imagem('icones/voltar.png','Pasta Superior', 'Clique neste ícone '.imagem('icones/voltar.png').' para volta à pasta superior.').'</a>';
...
function mostrarArquivos($arquivo_pasta_id) {
	...
	$s .= '<th><a class="hdr" href="javascript:void(0);" onclick="url_passar(0, \'m='.$m.'&a='.$a.'&u='.$u.($tab ? '&tab='.$tab : '').($arquivo_pasta_id ? '&arquivo_pasta_id='.$arquivo_pasta_id : '').$extra.'&ordenar=tamanho&ordem='.($ordem ? '0' : '1').'\');">'.dica('Tamanho', 'Clique para ordenar pelo tamanho dos arquivos.<br><br>O tamanho do arquivo é em bytes').'Tamanho'.dicaF().'</a></th>';

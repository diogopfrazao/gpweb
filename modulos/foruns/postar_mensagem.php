...
if (!$dialogo) echo '<tr><td align="left" style="white-space: nowrap">'.mostrarBlocos($blocos, $titulo_blocos, $texto_blocos).'</td></tr>';
...
if ($mensagem_superior) {
	...
	echo '<tr><td align="left">'.dica('Autor', 'Cada tópico ter um autor, que é o criador do mesmo.').'Autor:'.dicaF().'</td><td align="left">'.getUsuarioNome($mensagem_info['usuario_login']).' ('.$data->format('%d/%m/%Y %H:%M').')</td></tr>';

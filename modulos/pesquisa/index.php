...
echo '<tr><td style="white-space: nowrap" colspan="2"><a href="javascript: void(0);" onclick="selecionarTodosModulos(this)">Selecionar tudo</a> | <a href="javascript: void(0);" onclick="deselecionarTodosModulos(this)">Desmarcar todos</a></td></tr>';
$objarray = array();
$saida=array();
foreach ($arquivos as $tmp) {

...
$botoesTitulo = new CBlocoTitulo('Pesquisar '.ucfirst($config['mensagens']), 'email1.png', $m, $m.'.'.$a);
...
echo '<table class="std" width="100%" align="center" border=0 cellpadding=0 cellspacing=0 >';

echo '<tr><td align="right" style="white-space: nowrap" width=50>'.dica('Texto','Escreva a palavra chave a ser pesquisa n'.$config['genero_mensagem'].'s '.$config['mensagens'].' do sistema.').'Texto:'.dicaF().'</td><td><input type="text" class="texto" name="assunto" id="assunto" size="60"></td></tr>';
echo '<tr><td align="center" colspan="2" style="white-space: nowrap"> </td></tr>';
echo '<tr><td align="right" style="white-space: nowrap"style="white-space: nowrap">'.dica('Data de Início', 'Digite ou escolha no calendário a data de início da pesquisa.').'De:'.dicaF().'</td><td style="white-space: nowrap"><input type="hidden" name="pesquisa_inicio" id="pesquisa_inicio" value="" /><input type="text" name="data_inicio" style="width:70px;" id="data_inicio" onchange="setData(\'env\', \'data_inicio\', \'pesquisa_inicio\');" value="" class="texto" />'.dica('Data Inicial', 'Clique neste ícone '.imagem('icones/calendario.gif').' para abrir um calendário onde poderá selecionar a data de início deste evento.').'<a href="javascript: void(0);" ><img id="f_btn1" src="'.acharImagem('calendario.gif').'" style="vertical-align:middle" alt="Agenda"" border=0 /></a>'.dicaF().dica('Data de Término', 'Digite ou escolha no calendário a data de término da pesquisa.').'&nbsp;&nbsp;a&nbsp;&nbsp;'.dicaF().'<input type="hidden" name="pesquisa_fim" id="pesquisa_fim" value="" /><input type="text" name="data_fim" id="data_fim" style="width:70px;" onchange="setData(\'env\', \'data_fim\', \'pesquisa_fim\');" value="" class="texto" />'.dica('Data de Término', 'Clique neste ícone '.imagem('icones/calendario.gif').'  para abrir um calendário onde poderá selecionar a data de término deste evento.').'<a href="javascript: void(0);" ><img id="f_btn2" src="'.acharImagem('calendario.gif').'" style="vertical-align:middle" alt="Agenda"" border=0 /></a>'.dicaF().'</td></tr>';
echo '<tr><td align="right"style="white-space: nowrap">'.dica('Enviadas Por','Selecione '.$config['genero_mensagem'].'s '.$config['mensagens'].' que tenham sido enviad'.$config['genero_mensagem'].'s pel'.$config['genero_usuario'].' '.$config['usuario'].' selecionado à direita.').'Enviadas por:'.dicaF().'</td><td colspan="2"><input type="hidden" id="cia_usuario_enviou" name="cia_usuario_enviou" value="" /><input type="text" id="nome_enviou" name="nome_enviou" value="" style="width:284px;" class="texto" READONLY /><a href="javascript: void(0);" onclick="popEnviada();">'.imagem('icones/usuarios.gif','Selecionar '.ucfirst($config['usuario']),'Clique neste ícone '.imagem('icones/usuarios.gif').' para selecionar '.($config['genero_usuario']=='o' ? 'um' : 'uma').' '.$config['usuario'].'.').'</a></td></tr>';
echo '<tr><td align="right"style="white-space: nowrap">'.dica('Recebidas Por','Selecione '.$config['genero_mensagem'].'s '.$config['mensagens'].' que tenham sido recebid'.$config['genero_mensagem'].'s pel'.$config['genero_usuario'].' '.$config['usuario'].' selecionado à direita.').'Recebidas por:'.dicaF().'</td><td colspan="2"><input type="hidden" id="cia_usuario_recebeu" name="cia_usuario_recebeu" value="" /><input type="text" id="nome_recebeu" name="nome_recebeu" value="" style="width:284px;" class="texto" READONLY /><a href="javascript: void(0);" onclick="popRecebida();">'.imagem('icones/usuarios.gif','Selecionar '.ucfirst($config['usuario']),'Clique neste ícone '.imagem('icones/usuarios.gif').' para selecionar '.($config['genero_usuario']=='o' ? 'um' : 'uma').' '.$config['usuario'].'.').'</a></td></tr>';
echo '<tr><td align="right"style="white-space: nowrap">'.dica('Criador','Selecione qual '.$config['usuario'].' criou '.$config['genero_mensagem'].' '.$config['mensagem'].'.').'Criador:'.dicaF().'</td><td colspan="2"><input type="hidden" id="cia_usuario_criou" name="cia_usuario_criou" value="" /><input type="text" id="nome_criador" name="nome_criador" value="" style="width:284px;" class="texto" READONLY /><a href="javascript: void(0);" onclick="popCriador();">'.imagem('icones/usuarios.gif','Selecionar '.ucfirst($config['usuario']),'Clique neste ícone '.imagem('icones/usuarios.gif').' para selecionar '.($config['genero_usuario']=='o' ? 'um' : 'uma').' '.$config['usuario'].'.').'</a></td></tr>';

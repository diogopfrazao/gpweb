...
if (!$dialogo){
	$botoesTitulo = new CBlocoTitulo('Compromissos Anual', 'compromisso.png', $m, "$m.$a");
...
echo '<td style="white-space: nowrap">Chave:</td><td>&nbsp;</td>';
echo '<td style="border-style:solid;border-width:1px" class="dia">&nbsp;&nbsp;</td><td style="white-space: nowrap">Dia</td><td>&nbsp;</td>';
echo '<td style="border-style:solid;border-width:1px" class="compromisso">&nbsp;&nbsp;</td><td style="white-space: nowrap">Compromisso</td><td>&nbsp;</td>';
...
echo '<td class="hoje">&nbsp;&nbsp;</td><td style="white-space: nowrap">Hoje</td><td>&nbsp;</td>';

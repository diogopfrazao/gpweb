...
$sql->limpar();
$qnt=0;
foreach($dados as $dado) echo '<tr align=center><td>'.nome_funcao('','','','',$dado['modelos_dados_criador']).'</td><td>'.(!$qnt++ ? 'Criou' : 'Editou').'</td><td>'.retorna_data($dado['modelo_dados_data']).'</td></tr>';

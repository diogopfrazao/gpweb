...
if (!$dialogo){
	...
	$popFiltro='<tr><td align="right" style="white-space: nowrap">'.dica('Relacionado','A qual parte do sistema os documentos estão relacionados.').'Relacionado:'.dicaF().'</td><td align="left">'.selecionaVetor($tipos, 'tipo_relacao', 'style="width:250px;" class="texto" onchange="popRelacao(this.value)"').'</td></tr>';
	...
	$icone_pasta='<tr><td align="right" style="white-space: nowrap"><a href="javascript: void(0);" onclick ="url_passar(0, \'m=email&a=editar_pastas\');">'.imagem('pasta_p.png', 'Pastas','Clique neste ícone '.imagem('pasta_p.png').' para editar as pastas particulares.').'</a></td></tr>';
...
echo '<tr><td align="right" width="130">'.dica('Texto à Pesquisar','Escreva a palavra chave a ser pesquisa nos documentos.').'Texto:'.dicaF().'</td><td><input type="text" class="texto" name="assunto" id="assunto" size="60" value="'.$assunto.'"></td></tr>';
...
echo'<tr><td align="right" style="white-space: nowrap">'.dica('Ações Sofridas', 'Escolha qual ação sofrida pelo documento.').'Ação sofrida:'.dicaF().'</td><td style="white-space: nowrap">'.selecionaVetor($acoes_documentos, 'acao_documento', 'size="1" class="texto"', $acao_documento).'</td></tr>';
		...
		if (isset($rs_linha['modelo_id']) && $rs_linha['modelo_id']){
		  ...
		  foreach((array)$sql_resultadosc as $rs_anexo){
			...
			foreach($lista as $linha) {	
				...
				elseif ($linha['modelo_gestao_ata']) $icone.='<a href="javascript:void(0);" onclick="url_passar(0,\'m=atas&a=ata_ver&ata_id='.$linha['modelo_gestao_ata'].'\');">'.imagem('icones/ata_p.png','Ata de Reunião','Clique neste ícone '.imagem('icones/ata_p.png').' para ver a ata de reunião que este documento está vinculado.').'</a>';
				elseif ($linha['modelo_gestao_mswot']) $icone.='<a href="javascript:void(0);" onclick="url_passar(0,\'m=swot&a=mswot_ver&mswot_id='.$linha['modelo_gestao_mswot'].'\');">'.imagem('icones/mswot_p.png','Matriz SWOT','Clique neste ícone '.imagem('icones/mswot_p.png').' para ver a matriz SWOT que este documento está vinculado.').'</a>';
				elseif ($linha['modelo_gestao_swot']) $icone.='<a href="javascript:void(0);" onclick="url_passar(0,\'m=swot&a=swot_ver&swot_id='.$linha['modelo_gestao_swot'].'\');">'.imagem('icones/swot_p.png','Campo SWOT','Clique neste ícone '.imagem('icones/swot_p.png').' para ver o campo de matriz SWOT que este documento está vinculado.').'</a>';
				...
				elseif ($linha['modelo_gestao_gut']) $icone.='<a href="javascript:void(0);" onclick="url_passar(0,\'m=praticas&a=gut_ver&gut_id='.$linha['modelo_gestao_gut'].'\');">'.imagem('icones/gut_p.gif','Matriz GUT','Clique neste ícone '.imagem('icones/gut_p.gif').' para ver a matriz GUT que este documento está vinculado.').'</a>';
				elseif ($linha['modelo_gestao_causa_efeito']) $icone.='<a href="javascript:void(0);" onclick="url_passar(0,\'m=praticas&a=causa_efeito_ver&causa_efeito_id='.$linha['modelo_gestao_causa_efeito'].'\');">'.imagem('icones/causa_efeito_p.gif','Diagrama de Causa-Efeito','Clique neste ícone '.imagem('icones/causa_efeito_p.gif').' para ver o diagrama de causa-efeito que este documento está vinculado.').'</a>';
				...
				elseif ($linha['modelo_gestao_patrocinador']) $icone.='<a href="javascript:void(0);" onclick="url_passar(0,\'m=patrocinadores&a=patrocinador_ver&patrocinador_id='.$linha['modelo_gestao_patrocinador'].'\');">'.imagem('icones/patrocinador_p.gif','Patrocinador','Clique neste ícone '.imagem('icones/patrocinador_p.gif').' para ver o patrocinador que este documento está vinculado.').'</a>';
				...
				elseif ($linha['modelo_gestao_beneficio']) $icone.='<a href="javascript:void(0);" onclick="url_passar(0,\'m=projetos&a=beneficio_pro_ver&beneficio_id='.$linha['modelo_gestao_beneficio'].'\');">'.imagem('icones/beneficio_p.png',ucfirst($config['beneficio']).' d'.$config['genero_programa'].' '.ucfirst($config['programa']),'Clique neste ícone '.imagem('icones/beneficio_p.png').' para ver '.$config['genero_beneficio'].' '.$config['beneficio'].' d'.$config['genero_programa'].' '.$config['programa'].' que este documento está vinculado.').'</a>';
				...
				elseif ($linha['modelo_gestao_projeto_viabilidade']) $icone.='<a href="javascript:void(0);" onclick="url_passar(0,\'m=projetos&a=viabilidade_ver&projeto_viabilidade_id='.$linha['modelo_gestao_projeto_viabilidade'].'\');">'.imagem('icones/viabilidade_p.gif','Estudo de Viabilidade','Clique neste ícone '.imagem('icones/viabilidade_p.gif').' para ver o estudo de viabilidade que este documento está vinculado.').'</a>';
				elseif ($linha['modelo_gestao_projeto_abertura']) $icone.='<a href="javascript:void(0);" onclick="url_passar(0,\'m=projetos&a=termo_abertura_ver&projeto_abertura_id='.$linha['modelo_gestao_projeto_abertura'].'\');">'.imagem('icones/anexo_projeto_p.png','Termo de Abertura','Clique neste ícone '.imagem('icones/anexo_projeto_p.png').' para ver o termo de abertura que este documento está vinculado.').'</a>';
				elseif ($linha['modelo_gestao_plano_gestao']) $icone.='<a href="javascript:void(0);" onclick="url_passar(0,\'m=praticas&u=gestao&a=menu&pg_id='.$linha['modelo_gestao_plano_gestao'].'\');">'.imagem('icones/planogestao_p.png','Planejamento Estratégico','Clique neste ícone '.imagem('icones/planogestao_p.png').' para ver o planejamento estratégico que este documento está vinculado.').'</a>';		
				elseif ($linha['modelo_gestao_ssti']) $icone.='<a href="javascript:void(0);" onclick="url_passar(0,\'m=ssti&a=ssti_ver&ssti_id='.$linha['modelo_gestao_ssti'].'\');">'.imagem('icones/ssti_p.png',ucfirst($config['ssti']),'Clique neste ícone '.imagem('icones/ssti_p.png').' para ver '.$config['genero_ssti'].' '.$config['ssti'].' que este documento está vinculado.').'</a>';
				elseif ($linha['modelo_gestao_laudo']) $icone.='<a href="javascript:void(0);" onclick="url_passar(0,\'m=ssti&a=laudo_ver&laudo_id='.$linha['modelo_gestao_laudo'].'\');">'.imagem('icones/laudo_p.png',ucfirst($config['laudo']),'Clique neste ícone '.imagem('icones/laudo_p.png').' para ver '.$config['genero_laudo'].' '.$config['laudo'].' que este documento está vinculado.').'</a>';
				...
				elseif ($linha['modelo_gestao_trelo_cartao']) $icone.='<a href="javascript:void(0);" onclick="url_passar(0,\'m=trelo&a=trelo_cartao_ver&trelo_cartao_id='.$linha['modelo_gestao_trelo_cartao'].'\');">'.imagem('icones/trelo_cartao_p.png',ucfirst($config['trelo_cartao']),'Clique neste ícone '.imagem('icones/trelo_cartao_p.png').' para ver '.$config['genero_trelo_cartao'].' '.$config['trelo_cartao'].' que este documento está vinculado.').'</a>';
				elseif ($linha['modelo_gestao_pdcl']) $icone.='<a href="javascript:void(0);" onclick="url_passar(0,\'m=pdcl&a=pdcl_ver&pdcl_id='.$linha['modelo_gestao_pdcl'].'\');">'.imagem('icones/pdcl_p.png',ucfirst($config['pdcl']),'Clique neste ícone '.imagem('icones/pdcl_p.png').' para ver '.$config['genero_pdcl'].' '.$config['pdcl'].' que este documento está vinculado.').'</a>';
				...
				elseif ($linha['modelo_gestao_os']) $icone.='<a href="javascript:void(0);" onclick="url_passar(0,\'m=os&a=os_ver&os_id='.$linha['modelo_gestao_os'].'\');">'.imagem('icones/os_p.png',ucfirst($config['os']),'Clique neste ícone '.imagem('icones/os_p.png').' para ver '.$config['genero_os'].' '.$config['os'].' que este documento está vinculado.').'</a>';

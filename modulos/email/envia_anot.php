...
$botoesTitulo = new CBlocoTitulo('Inserir '.$titulo, 'email1.png', 'admin', '');
$botoesTitulo->mostrar();


echo estiloTopoCaixa();
echo '<table align="center" border=0 class="std2" cellspacing=0 cellpadding=0 width="100%"  BORDERCOLOR="#000000" ><tr><td>&nbsp;</td></tr>';

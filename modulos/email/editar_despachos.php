...
echo '<tr><td align="right" style="white-space: nowrap">'.dica('Anotação', 'Caso seja específico para anotações deverá ser marcado este campo').'Anotação:'.dicaF().'</td><td><input type="checkbox" value="1" name="despacho_anotacao" id="despacho_anotacao" /></td></tr>';
echo '<tr><td align="right" style="white-space: nowrap">'.dica('Despacho', 'Caso seja específico para despachos deverá ser marcado este campo').'Despacho:'.dicaF().'</td><td><input type="checkbox" value="1" name="despacho_despacho" id="despacho_despacho" /></td></tr>';
echo '<tr><td align="right" style="white-space: nowrap">'.dica('Resposta', 'Caso seja específico para respostas deverá ser marcado este campo').'Resposta:'.dicaF().'</td><td><input type="checkbox" value="1" name="despacho_resposta" id="despacho_resposta" /></td></tr>';
...
if (count($despachos)) {
	...
	foreach ($despachos as $despacho_id => $linha) {
		...
		echo '<td width=32><a href="javascript: void(0);" onclick="editar_despacho('.$linha['despacho_id'].');">'.imagem('icones/editar.gif', 'Editar', 'Clique neste ícone '.imagem('icones/editar.gif').' para editar a despacho.').'</a>';
		echo '<a href="javascript: void(0);" onclick="if (confirm(\'Tem certeza que deseja excluir esta despacho?\')) {excluir_despacho('.$linha['despacho_id'].');}">'.imagem('icones/remover.png', 'Excluir', 'Clique neste ícone '.imagem('icones/remover.png').' para excluir esta despacho.').'</a></td>';
		echo '</tr>';
		}
	echo '</table>';
	}

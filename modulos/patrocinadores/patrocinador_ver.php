...
if (isset($_REQUEST['patrocinador_id'])) $Aplic->setEstado('patrocinador_id', getParam($_REQUEST, 'patrocinador_id', null), $m, $a, $u);
$patrocinador_id = $Aplic->getEstado('patrocinador_id', null, $m, $a, $u);
...
$editar=permiteEditarPatrocinador($obj->patrocinador_acesso,$patrocinador_id);

$podeEditarTudo=($obj->patrocinador_acesso>=5 ? $editar && (in_array($obj->patrocinador_responsavel, $Aplic->usuario_lista_grupo_vetor) || $Aplic->usuario_super_admin || $Aplic->usuario_admin) : $editar);
...
if (!$dialogo){	
	$botoesTitulo = new CBlocoTitulo('Detalhes d'.$config['genero_patrocinador'].' '.ucfirst($config['patrocinador']), '../../../modulos/patrocinadores/imagens/patrocinador.gif', $m, $m.'.'.$a);
	...
	if ($podeAdicionar)	$km->Add("inserir","inserir_objeto",dica('Nov'.$config['genero_patrocinador'].' '.ucfirst($config['patrocinador']), 'Criar um nov'.$config['genero_patrocinador'].' '.$config['patrocinador'].'.').'Nov'.$config['genero_patrocinador'].' '.ucfirst($config['patrocinador']).dicaF(), "javascript: void(0);' onclick='url_passar(0, \"m=patrocinadores&a=patrocinador_editar\");");
	if ($podeEditar && $editar) {		
		$km->Add("inserir","inserir_registro",dica('Registro de Ocorrência','Inserir um novo registro de ocorrência.').'Registro de ocorrência'.dicaF(), "javascript: void(0);' onclick='url_passar(0, \"m=praticas&a=log_editar&patrocinador_id=".$patrocinador_id."\");");
		if ($Aplic->modulo_ativo('calendario') && $Aplic->checarModulo('eventos', 'adicionar')) $km->Add("inserir","inserir_evento",dica('Novo Evento', 'Criar um novo evento relacionado.').'Evento'.dicaF(), "javascript: void(0);' onclick='url_passar(0, \"m=calendario&a=editar&evento_patrocinador=".$patrocinador_id."\");");
		...
		if ($Aplic->modulo_ativo('links') && $Aplic->checarModulo('links', 'adicionar')) $km->Add("diverso","inserir_link",dica('Novo Link', 'Inserir um novo link relacionado.').'Link'.dicaF(), "javascript: void(0);' onclick='url_passar(0, \"m=links&a=editar&link_patrocinador=".$patrocinador_id."\");");
		if ($Aplic->modulo_ativo('foruns') && $Aplic->checarModulo('foruns', 'adicionar')) $km->Add("diverso","inserir_forum",dica('Novo Fórum', 'Inserir um novo fórum relacionado.').'Fórum'.dicaF(), "javascript: void(0);' onclick='url_passar(0, \"m=foruns&a=editar&forum_patrocinador=".$patrocinador_id."\");");
	...
	if ($podeEditarTudo && $podeEditar && !$bloquear) $km->Add("acao","acao_editar",dica('Editar Patrocinador','Editar os detalhes deste patrocinador.').'Editar Patrocinador'.dicaF(), "javascript: void(0);' onclick='url_passar(0, \"m=patrocinadores&a=patrocinador_editar&patrocinador_id=".$patrocinador_id."\");");
	if ($podeEditarTudo && $podeExcluir && !$bloquear) $km->Add("acao","acao_excluir",dica('Excluir','Excluir este patrocinador.').'Excluir Patrocinador'.dicaF(), "javascript: void(0);' onclick='excluir()");
	...
	if ($podeEditarTudo && $podeEditar) $km->Add("acao","acao_exportar",dica('Exportar Link', 'Clique neste ícone '.imagem('icones/exporta_p.png').' para criar um endereço web para visualização em ambiente externo.').imagem('icones/exporta_p.png').' Exportar Link'.dicaF(), "javascript: void(0);' onclick='exportar_link();");	
...
if ($obj->patrocinador_cia) echo '<tr><td align="right" style="white-space: nowrap">'.dica(ucfirst($config['organizacao']).' Responsável', ucfirst($config['genero_organizacao']).' '.$config['organizacao'].' responsável.').ucfirst($config['organizacao']).' responsável:'.dicaF().'</td><td class="realce" width="100%">'.link_cia($obj->patrocinador_cia).'</td></tr>';
if ($Aplic->profissional){
...
if ($obj->patrocinador_dept) echo '<tr><td align="right" style="white-space: nowrap">'.dica(ucfirst($config['departamento']).' Responsável', ucfirst($config['genero_dept']).' '.$config['departamento'].' responsável por este patrocinador.').ucfirst($config['departamento']).' responsável:'.dicaF().'</td><td class="realce" width="100%">'.link_dept($obj->patrocinador_dept).'</td></tr>';
...
if ($saida_depts) echo '<tr><td align="right" valign="top" style="white-space: nowrap">'.dica(ucfirst($config['departamentos']), 'Qual '.strtolower($config['departamento']).' está envolvid'.$config['genero_dept'].' com '.($config['genero_objetivo']=='o' ? 'este' : 'esta').' '.$config['objetivo'].'.').ucfirst($config['departamentos']).' envolvid'.$config['genero_dept'].'s:'.dicaF().'</td><td width="100%" colspan="2" class="realce">'.$saida_depts.'</td></tr>';




if ($obj->patrocinador_responsavel) echo '<tr><td align="right" valign="top" style="white-space: nowrap">'.dica('Responsável pel'.$config['genero_patrocinador'].' '.ucfirst($config['patrocinador']), ucfirst($config['usuario']).' responsável por gerenciar '.$config['genero_patrocinador'].' '.$config['patrocinador'].'.').'Responsável:'.dicaF().'</td><td class="realce" width="100%">'.link_usuario($obj->patrocinador_responsavel, '','','esquerda').'</td></tr>';		
...
if ($saida_quem) echo '<tr><td align="right" valign="top" style="white-space: nowrap">'.dica('Designados', 'Quais '.strtolower($config['usuarios']).' estão envolvid'.$config['genero_usuario'].'s.').'Designados:'.dicaF().'</td><td width="100%" colspan="2" class="realce"><table cellspacing=0 cellpadding=0><tr><td>'.$saida_quem.'</td></tr></table></td></tr>';

if ($obj->patrocinador_descricao) echo '<tr><td align="right" >'.dica('Descrição', 'Descrição d'.$config['genero_patrocinador'].' '.$config['patrocinador'].'.').'Descrição:'.dicaF().'</td><td class="realce">'.$obj->patrocinador_descricao.'</td></tr>';
if ($obj->patrocinador_cpf) echo '<tr><td align="right" style="white-space: nowrap">'.dica('CPF', 'O CPF d'.$config['genero_patrocinador'].' '.$config['patrocinador'].'.<br><br>Não tem relevância para o '.$config['gpweb'].' mas pode facilitar na catalogação dos patrocinadors.').'CPF:'.dicaF().'</td><td style="white-space: nowrap" class="realce">'.$obj->patrocinador_cpf.'</td></tr>';
if ($obj->patrocinador_cnpj) echo '<tr><td align="right" style="white-space: nowrap">'.dica('CNPJ', 'O CNPJ d'.$config['genero_patrocinador'].' '.$config['patrocinador'].'.<br><br>Não tem relevância para o '.$config['gpweb'].' mas pode facilitar na catalogação dos patrocinadors.').'CNPJ:'.dicaF().'</td><td style="white-space: nowrap" class="realce">'.$obj->patrocinador_cnpj.'</td></tr>';
if ($obj->patrocinador_endereco1 || $obj->patrocinador_endereco2 || $obj->patrocinador_cidade || $obj->patrocinador_estado) echo '<tr><td align="right" style="white-space: nowrap">'.dica('Endereço', 'O endereço d'.$config['genero_patrocinador'].' '.$config['patrocinador'].'.').'Endereço:'.dicaF().'</td><td class="realce" style="text-align: justify;">'.$obj->patrocinador_endereco1.($obj->patrocinador_endereco1 ? '<br />' :'').$obj->patrocinador_endereco2.($obj->patrocinador_endereco2 ? '<br />' :'').$obj->patrocinador_cidade.' '.$obj->patrocinador_estado.' '.$obj->patrocinador_cep.($obj->patrocinador_cidade || $obj->patrocinador_estado || $obj->patrocinador_cep ? '<br />' :'').($paises[$obj->patrocinador_pais] ? $paises[$obj->patrocinador_pais] : $obj->patrocinador_pais).'</td></tr>';
if ($obj->patrocinador_endereco1 || $obj->patrocinador_endereco2 || $obj->patrocinador_cidade || $obj->patrocinador_estado) echo '<tr><td align="right" style="white-space: nowrap">'.dica('Visualizar Endereço', 'Clique no símbolo do Google Maps à direita para visualizar o endereço d'.$config['genero_patrocinador'].' '.$config['patrocinador'].'.').'Visualizar Endereço:'.dicaF().'</td><td class="realce" style="text-align: justify;">'.dica('Google Maps', 'Clique nesta imagem para visualizar no Google Maps, aberto em uma nova janela, o endereço d'.$config['genero_patrocinador'].' '.$config['patrocinador'].'.').'<a target="_blank" href="'.get_protocol().'maps.google.com/maps?key=AIzaSyAsFbkGMNJdcsHBSQySo8jpA7zqBhlg1Pg&q='.utf8_encode($obj->patrocinador_endereco1).'+'.utf8_encode($obj->patrocinador_endereco2).'+'.utf8_encode($obj->patrocinador_cidade).'+'.utf8_encode($obj->patrocinador_estado).'+'.utf8_encode($obj->patrocinador_cep).'+'.utf8_encode($obj->patrocinador_pais).'"><img align="left" src="'.acharImagem('google_map.png').'" alt="Achar no Google Maps" /></a>'.dicaF().'</td></tr>';
if ($obj->patrocinador_tel) echo '<tr><td align="right" style="white-space: nowrap">'.dica('Telefone Comercial', 'O telefone comercial d'.$config['genero_patrocinador'].' '.$config['patrocinador'].', para se comunicar com o mesmo.').'Telefone Comercial:'.dicaF().'</td><td class="realce" style="text-align: justify;">'.$obj->patrocinador_tel.'</td></tr>';
if ($obj->patrocinador_tel2) echo '<tr><td align="right" style="white-space: nowrap">'.dica('Telefone Residencial', 'O telefone residencial d'.$config['genero_patrocinador'].' '.$config['patrocinador'].', para se comunicar com o mesmo.').'Telefone Residencial:'.dicaF().'</td><td class="realce" style="text-align: justify;">'.$obj->patrocinador_tel2.'</td></tr>';
if ($obj->patrocinador_cel) echo '<tr><td align="right" style="white-space: nowrap">'.dica('Celular', 'O celular d'.$config['genero_patrocinador'].' '.$config['patrocinador'].', para se comunicar com o mesmo.').'Celular:'.dicaF().'</td><td class="realce" style="text-align: justify;">'.$obj->patrocinador_cel.'</td></tr>';
if ($obj->patrocinador_email) echo '<tr><td align="right" style="white-space: nowrap">'. dica('E-mail', 'O e-mail d'.$config['genero_patrocinador'].' '.$config['patrocinador'].' para se comunicar com o mesmo.').'E-mail:'.dicaF().'</td><td class="realce" style="white-space: nowrap">'.link_email($obj->patrocinador_email, $patrocinador_id).'</td></tr>';
if ($obj->patrocinador_url) echo '<tr><td align="right" style="white-space: nowrap">'.dica('Página Web', 'A página na Internet d'.$config['genero_patrocinador'].' '.$config['patrocinador'].'.').'Página Web:'.dicaF().'</td><td style="white-space: nowrap" class="realce"><a href="'.get_protocol().$obj->patrocinador_url.'">'.$obj->patrocinador_url.'</a></td></tr>';
...
if (count($instrumentos_selecionados)) {
	$qnt=0;
	echo '<tr><td align="right" style="white-space: nowrap">'.dica(ucfirst($config['instrumentos']), 'Quais '.strtolower($config['instrumentos']).' estão envolvid'.$config['genero_instrumento'].'s.').ucfirst($config['instrumentos']).':'.dicaF().'</td><td class="realce" width="100%">';
	foreach($instrumentos_selecionados AS $valor) echo ($qnt++ ? '<br>' : '').link_instrumento($valor);
	echo '</td></tr>';
...
if (count($lista)) {
	echo '<tr><td align="right" style="white-space: nowrap" valign="middle">'.dica('Relacionado','A qual parte do sistema '.$config['genero_patrocinador'].' '.$config['patrocinador'].' está relacionado.').'Relacionado:'.dicaF().'</td></td><td class="realce">';	
	foreach($lista as $gestao_data){
		if ($gestao_data['patrocinador_gestao_tarefa']) echo ($qnt_gestao++ ? '<br>' : '').imagem('icones/tarefa_p.gif').link_tarefa($gestao_data['patrocinador_gestao_tarefa']);
		elseif ($gestao_data['patrocinador_gestao_projeto']) echo ($qnt_gestao++ ? '<br>' : '').imagem('icones/projeto_p.gif').link_projeto($gestao_data['patrocinador_gestao_projeto']);
		elseif ($gestao_data['patrocinador_gestao_pratica']) echo ($qnt_gestao++ ? '<br>' : '').imagem('icones/pratica_p.gif').link_pratica($gestao_data['patrocinador_gestao_pratica']);
		elseif ($gestao_data['patrocinador_gestao_acao']) echo ($qnt_gestao++ ? '<br>' : '').imagem('icones/plano_acao_p.gif').link_acao($gestao_data['patrocinador_gestao_acao']);
		elseif ($gestao_data['patrocinador_gestao_perspectiva']) echo ($qnt_gestao++ ? '<br>' : '').imagem('icones/perspectiva_p.png').link_perspectiva($gestao_data['patrocinador_gestao_perspectiva']);
		elseif ($gestao_data['patrocinador_gestao_tema']) echo ($qnt_gestao++ ? '<br>' : '').imagem('icones/tema_p.png').link_tema($gestao_data['patrocinador_gestao_tema']);
		elseif ($gestao_data['patrocinador_gestao_objetivo']) echo ($qnt_gestao++ ? '<br>' : '').imagem('icones/obj_estrategicos_p.gif').link_objetivo($gestao_data['patrocinador_gestao_objetivo']);
		elseif ($gestao_data['patrocinador_gestao_fator']) echo ($qnt_gestao++ ? '<br>' : '').imagem('icones/fator_p.gif').link_fator($gestao_data['patrocinador_gestao_fator']);
		elseif ($gestao_data['patrocinador_gestao_estrategia']) echo ($qnt_gestao++ ? '<br>' : '').imagem('icones/estrategia_p.gif').link_estrategia($gestao_data['patrocinador_gestao_estrategia']);
		elseif ($gestao_data['patrocinador_gestao_meta']) echo ($qnt_gestao++ ? '<br>' : '').imagem('icones/meta_p.gif').link_meta($gestao_data['patrocinador_gestao_meta']);
		elseif ($gestao_data['patrocinador_gestao_canvas']) echo ($qnt_gestao++ ? '<br>' : '').imagem('icones/canvas_p.png').link_canvas($gestao_data['patrocinador_gestao_canvas']);
		elseif ($gestao_data['patrocinador_gestao_risco']) echo ($qnt_gestao++ ? '<br>' : '').imagem('icones/risco_p.png').link_risco($gestao_data['patrocinador_gestao_risco']);
		elseif ($gestao_data['patrocinador_gestao_risco_resposta']) echo ($qnt_gestao++ ? '<br>' : '').imagem('icones/risco_resposta_p.png').link_risco_resposta($gestao_data['patrocinador_gestao_risco_resposta']);
		elseif ($gestao_data['patrocinador_gestao_indicador']) echo ($qnt_gestao++ ? '<br>' : '').imagem('icones/indicador_p.gif').link_indicador($gestao_data['patrocinador_gestao_indicador']);
		elseif ($gestao_data['patrocinador_gestao_calendario']) echo ($qnt_gestao++ ? '<br>' : '').imagem('icones/agenda_p.png').link_calendario($gestao_data['patrocinador_gestao_calendario']);
		elseif ($gestao_data['patrocinador_gestao_monitoramento']) echo ($qnt_gestao++ ? '<br>' : '').imagem('icones/monitoramento_p.gif').link_monitoramento($gestao_data['patrocinador_gestao_monitoramento']);
		elseif ($gestao_data['patrocinador_gestao_ata']) echo ($qnt_gestao++ ? '<br>' : '').imagem('icones/ata_p.png').link_ata_pro($gestao_data['patrocinador_gestao_ata']);
		elseif ($gestao_data['patrocinador_gestao_mswot']) echo ($qnt_gestao++ ? '<br>' : '').imagem('icones/mswot_p.png').link_mswot($gestao_data['patrocinador_gestao_mswot']);
		elseif ($gestao_data['patrocinador_gestao_swot']) echo ($qnt_gestao++ ? '<br>' : '').imagem('icones/swot_p.png').link_swot($gestao_data['patrocinador_gestao_swot']);
		elseif ($gestao_data['patrocinador_gestao_operativo']) echo ($qnt_gestao++ ? '<br>' : '').imagem('icones/operativo_p.png').link_operativo($gestao_data['patrocinador_gestao_operativo']);
		elseif ($gestao_data['patrocinador_gestao_instrumento']) echo ($qnt_gestao++ ? '<br>' : '').imagem('icones/instrumento_p.png').link_instrumento($gestao_data['patrocinador_gestao_instrumento']);
		elseif ($gestao_data['patrocinador_gestao_recurso']) echo ($qnt_gestao++ ? '<br>' : '').imagem('icones/recursos_p.gif').link_recurso($gestao_data['patrocinador_gestao_recurso']);
		elseif ($gestao_data['patrocinador_gestao_problema']) echo ($qnt_gestao++ ? '<br>' : '').imagem('icones/problema_p.png').link_problema($gestao_data['patrocinador_gestao_problema']);
		elseif ($gestao_data['patrocinador_gestao_demanda']) echo ($qnt_gestao++ ? '<br>' : '').imagem('icones/demanda_p.gif').link_demanda($gestao_data['patrocinador_gestao_demanda']);	
		elseif ($gestao_data['patrocinador_gestao_programa']) echo ($qnt_gestao++ ? '<br>' : '').imagem('icones/programa_p.png').link_programa($gestao_data['patrocinador_gestao_programa']);
		elseif ($gestao_data['patrocinador_gestao_licao']) echo ($qnt_gestao++ ? '<br>' : '').imagem('icones/licoes_p.gif').link_licao($gestao_data['patrocinador_gestao_licao']);
		elseif ($gestao_data['patrocinador_gestao_evento']) echo ($qnt_gestao++ ? '<br>' : '').imagem('icones/calendario_p.png').link_evento($gestao_data['patrocinador_gestao_evento']);
		elseif ($gestao_data['patrocinador_gestao_link']) echo ($qnt_gestao++ ? '<br>' : '').imagem('icones/links_p.gif').link_link($gestao_data['patrocinador_gestao_link']);
		elseif ($gestao_data['patrocinador_gestao_avaliacao']) echo ($qnt_gestao++ ? '<br>' : '').imagem('icones/avaliacao_p.gif').link_avaliacao($gestao_data['patrocinador_gestao_avaliacao']);
		elseif ($gestao_data['patrocinador_gestao_tgn']) echo ($qnt_gestao++ ? '<br>' : '').imagem('icones/tgn_p.png').link_tgn($gestao_data['patrocinador_gestao_tgn']);
		elseif ($gestao_data['patrocinador_gestao_brainstorm']) echo ($qnt_gestao++ ? '<br>' : '').imagem('icones/brainstorm_p.gif').link_brainstorm($gestao_data['patrocinador_gestao_brainstorm']);
		elseif ($gestao_data['patrocinador_gestao_gut']) echo ($qnt_gestao++ ? '<br>' : '').imagem('icones/gut_p.gif').link_gut($gestao_data['patrocinador_gestao_gut']);
		elseif ($gestao_data['patrocinador_gestao_causa_efeito']) echo ($qnt_gestao++ ? '<br>' : '').imagem('icones/causaefeito_p.png').link_causa_efeito($gestao_data['patrocinador_gestao_causa_efeito']);
		elseif ($gestao_data['patrocinador_gestao_arquivo']) echo ($qnt_gestao++ ? '<br>' : '').imagem('icones/arquivo_p.png').link_arquivo($gestao_data['patrocinador_gestao_arquivo']);
		elseif ($gestao_data['patrocinador_gestao_forum']) echo ($qnt_gestao++ ? '<br>' : '').imagem('icones/forum_p.gif').link_forum($gestao_data['patrocinador_gestao_forum']);
		elseif ($gestao_data['patrocinador_gestao_checklist']) echo ($qnt_gestao++ ? '<br>' : '').imagem('icones/todo_list_p.png').link_checklist($gestao_data['patrocinador_gestao_checklist']);
		elseif ($gestao_data['patrocinador_gestao_agenda']) echo ($qnt_gestao++ ? '<br>' : '').imagem('icones/compromisso_p.png').link_agenda($gestao_data['patrocinador_gestao_agenda']);
		elseif ($gestao_data['patrocinador_gestao_agrupamento']) echo ($qnt_gestao++ ? '<br>' : '').imagem('icones/agrupamento_p.png').link_agrupamento($gestao_data['patrocinador_gestao_agrupamento']);
		
		elseif ($gestao_data['patrocinador_gestao_semelhante']) echo ($qnt_gestao++ ? '<br>' : '').imagem('icones/patrocinador_p.gif').link_patrocinador($gestao_data['patrocinador_gestao_semelhante']);
		
		elseif ($gestao_data['patrocinador_gestao_template']) echo ($qnt_gestao++ ? '<br>' : '').imagem('icones/template_p.gif').link_template($gestao_data['patrocinador_gestao_template']);
		elseif ($gestao_data['patrocinador_gestao_painel']) echo ($qnt_gestao++ ? '<br>' : '').imagem('icones/painel_p.png').link_painel($gestao_data['patrocinador_gestao_painel']);
		elseif ($gestao_data['patrocinador_gestao_painel_odometro']) echo ($qnt_gestao++ ? '<br>' : '').imagem('icones/odometro_p.png').link_painel_odometro($gestao_data['patrocinador_gestao_painel_odometro']);
		elseif ($gestao_data['patrocinador_gestao_painel_composicao']) echo ($qnt_gestao++ ? '<br>' : '').imagem('icones/composicao_p.gif').link_painel_composicao($gestao_data['patrocinador_gestao_painel_composicao']);		
		elseif ($gestao_data['patrocinador_gestao_tr']) echo ($qnt_gestao++ ? '<br>' : '').imagem('icones/tr_p.png').link_tr($gestao_data['patrocinador_gestao_tr']);	
		elseif ($gestao_data['patrocinador_gestao_me']) echo ($qnt_gestao++ ? '<br>' : '').imagem('icones/me_p.png').link_me($gestao_data['patrocinador_gestao_me']);	
		elseif ($gestao_data['patrocinador_gestao_acao_item']) echo ($qnt_gestao++ ? '<br>' : '').imagem('icones/acao_item_p.png').link_acao_item($gestao_data['patrocinador_gestao_acao_item']);	
		elseif ($gestao_data['patrocinador_gestao_beneficio']) echo ($qnt_gestao++ ? '<br>' : '').imagem('icones/beneficio_p.png').link_beneficio($gestao_data['patrocinador_gestao_beneficio']);	
		elseif ($gestao_data['patrocinador_gestao_painel_slideshow']) echo ($qnt_gestao++ ? '<br>' : '').imagem('icones/slideshow_p.gif').link_painel_slideshow($gestao_data['patrocinador_gestao_painel_slideshow']);	
		elseif ($gestao_data['patrocinador_gestao_projeto_viabilidade']) echo ($qnt_gestao++ ? '<br>' : '').imagem('icones/viabilidade_p.gif').link_viabilidade($gestao_data['patrocinador_gestao_projeto_viabilidade']);	
		elseif ($gestao_data['patrocinador_gestao_projeto_abertura']) echo ($qnt_gestao++ ? '<br>' : '').imagem('icones/anexo_projeto_p.png').link_termo_abertura($gestao_data['patrocinador_gestao_projeto_abertura']);	
		elseif ($gestao_data['patrocinador_gestao_plano_gestao']) echo ($qnt_gestao++ ? '<br>' : '').imagem('icones/planogestao_p.png').link_plano_gestao($gestao_data['patrocinador_gestao_plano_gestao']);	
		elseif ($gestao_data['patrocinador_gestao_ssti']) echo ($qnt_gestao++ ? '<br>' : '').imagem('icones/ssti_p.png').link_ssti($gestao_data['patrocinador_gestao_ssti']);
		elseif ($gestao_data['patrocinador_gestao_laudo']) echo ($qnt_gestao++ ? '<br>' : '').imagem('icones/laudo_p.png').link_laudo($gestao_data['patrocinador_gestao_laudo']);
		elseif ($gestao_data['patrocinador_gestao_trelo']) echo ($qnt_gestao++ ? '<br>' : '').imagem('icones/trelo_p.png').link_trelo($gestao_data['patrocinador_gestao_trelo']);
		elseif ($gestao_data['patrocinador_gestao_trelo_cartao']) echo ($qnt_gestao++ ? '<br>' : '').imagem('icones/trelo_cartao_p.png').link_trelo_cartao($gestao_data['patrocinador_gestao_trelo_cartao']);
		elseif ($gestao_data['patrocinador_gestao_pdcl']) echo ($qnt_gestao++ ? '<br>' : '').imagem('icones/pdcl_p.png').link_pdcl($gestao_data['patrocinador_gestao_pdcl']);
		elseif ($gestao_data['patrocinador_gestao_pdcl_item']) echo ($qnt_gestao++ ? '<br>' : '').imagem('icones/pdcl_item_p.png').link_pdcl_item($gestao_data['patrocinador_gestao_pdcl_item']);
		elseif ($gestao_data['patrocinador_gestao_os']) echo ($qnt_gestao++ ? '<br>' : '').imagem('icones/os_p.png').link_os($gestao_data['patrocinador_gestao_os']);
...
if ($Aplic->profissional) {
	...
	$sql->limpar();
	if (isset($moedas[$obj->patrocinador_moeda])) echo '<tr><td align="right" style="white-space: nowrap">'.dica('Moeda', 'A moeda padrão utilizada na meta.').'Moeda:'.dicaF().'</td><td class="realce" width="100%">'.$moedas[$obj->patrocinador_moeda].'</td></tr>';	
	}
if ($Aplic->profissional && $tem_aprovacao) echo '<tr><td align="right" style="white-space: nowrap">'.dica('Aprovado', 'Se '.$config['genero_patrocinador'].' '.$config['patrocinador'].' se encontra aprovado.').'Aprovado:'.dicaF().'</td><td  class="realce" width="100%">'.($obj->patrocinador_aprovado ? 'Sim' : '<span style="color:red; font-weight:bold">Não</span>').'</td></tr>';
...
echo '<tr><td align="right" width="100">'.dica('Ativo', 'Se '.$config['genero_patrocinador'].' '.$config['patrocinador'].' está ativo.').'Ativo:'.dicaF().'</td><td style="white-space: nowrap" class="realce">'.($obj->patrocinador_ativo ? 'Sim' : 'Não').'</td></tr>';
...
if (!$dialogo) {
	...
	if ($Aplic->checarModulo('praticas', 'acesso', null, 'plano_acao_item')) {
		...
		$sql->adOnde('plano_acao_item_gestao_patrocinador = '.(int)$patrocinador_id);
	...
	if ($Aplic->checarModulo('projetos', 'acesso', null, 'demanda')) {
		...
		$sql->adOnde('demanda_gestao_patrocinador = '.(int)$patrocinador_id);
	...
	if ($Aplic->profissional && $Aplic->modulo_ativo('praticas') && $Aplic->checarModulo('praticas', 'acesso', null, 'risco_resposta')) {		
		...
		$sql->adOnde('risco_resposta_gestao_patrocinador = '.(int)$patrocinador_id);
	...
	if ($Aplic->checarModulo('recursos', 'acesso', null, null)) {
		...
		$sql->adOnde('recurso_gestao_patrocinador = '.(int)$patrocinador_id);
	...
	if ($Aplic->modulo_ativo('patrocinadores') && $Aplic->checarModulo('patrocinadores', 'acesso', null, null)) {
		$sql->adTabela('patrocinador_gestao');
		$sql->adOnde('patrocinador_gestao_semelhante = '.(int)$patrocinador_id);
	...
	if ($Aplic->profissional && $Aplic->checarModulo('projetos', 'acesso', null, 'programa')) {
		...
		$sql->adOnde('programa_gestao_patrocinador = '.(int)$patrocinador_id);
	...
	if ($Aplic->profissional && $Aplic->checarModulo('projetos', 'acesso', null, 'beneficio')) {
		...
		$sql->adOnde('beneficio_gestao_patrocinador = '.(int)$patrocinador_id);
	...
	if ($Aplic->checarModulo('projeto', 'acesso', 'licao')) {
		...
		$sql->adOnde('licao_gestao_patrocinador = '.(int)$patrocinador_id);
	...
	if ($Aplic->checarModulo('praticas', 'acesso', null, 'pratica')) {
		...
		$sql->adOnde('pratica_gestao_patrocinador = '.(int)$patrocinador_id);
	...
	if ($Aplic->profissional && $Aplic->modulo_ativo('tr') && $Aplic->checarModulo('tr', 'acesso', null, null)) {
		...
		$sql->adOnde('tr_gestao_patrocinador = '.(int)$patrocinador_id);
	...
	if ($Aplic->checarModulo('praticas', 'acesso', null, 'brainstorm')) {
		...
		$sql->adOnde('brainstorm_gestao_patrocinador = '.(int)$patrocinador_id);
	...
	if ($Aplic->checarModulo('praticas', 'acesso', null, 'gut')) {
		...
		$sql->adOnde('gut_gestao_patrocinador = '.(int)$patrocinador_id);
	...
	if ($Aplic->checarModulo('praticas', 'acesso', null, 'causa_efeito')) {
		...
		$sql->adOnde('causa_efeito_gestao_patrocinador = '.(int)$patrocinador_id);
	...
	if ($Aplic->profissional && $Aplic->checarModulo('praticas', 'acesso', null, 'tgn')) {
		...
		$sql->adOnde('tgn_gestao_patrocinador = '.(int)$patrocinador_id);
	...
	if ($Aplic->profissional && $Aplic->checarModulo('praticas', 'acesso', null, 'canvas')) {
		...
		$sql->adOnde('canvas_gestao_patrocinador = '.(int)$patrocinador_id);
	...
	if ($Aplic->profissional && $Aplic->modulo_ativo('swot') && $Aplic->checarModulo('swot', 'acesso', null, null)) {
		...
		$sql->adOnde('mswot_gestao_patrocinador = '.(int)$patrocinador_id);
	...
	if ($Aplic->profissional && $Aplic->modulo_ativo('swot') && $Aplic->checarModulo('swot', 'acesso', null, null)) {
		...
		$sql->adOnde('swot_gestao_patrocinador = '.(int)$patrocinador_id);
	...
	if ($Aplic->profissional && $Aplic->modulo_ativo('operativo') && $Aplic->checarModulo('operativo', 'acesso', null, null)) {
		...
		$sql->adOnde('operativo_gestao_patrocinador = '.(int)$patrocinador_id);
	...
	if ($Aplic->profissional && $Aplic->checarModulo('praticas', 'acesso', null, 'monitoramento')) {
		...
		$sql->adOnde('monitoramento_gestao_patrocinador = '.(int)$patrocinador_id);
		...
		$sql->adOnde('avaliacao_gestao_patrocinador = '.(int)$patrocinador_id);
	...
	if ($Aplic->checarModulo('praticas', 'acesso', null, 'checklist')) {
		...
		$sql->adOnde('checklist_gestao_patrocinador = '.(int)$patrocinador_id);
	...
	if ($Aplic->profissional) {
		...
		$sql->adOnde('agenda_gestao_patrocinador = '.(int)$patrocinador_id);
	...
	if ($Aplic->profissional && $Aplic->modulo_ativo('agrupamento') && $Aplic->checarModulo('agrupamento', 'acesso', null, null)) {
		...
		$sql->adOnde('agrupamento_gestao_patrocinador = '.(int)$patrocinador_id);
	...
	if ($Aplic->profissional && $Aplic->checarModulo('projetos', 'acesso', null, 'modelo')) {
		...
		$sql->adOnde('template_gestao_patrocinador = '.(int)$patrocinador_id);
	...
	if ($Aplic->profissional && $Aplic->checarModulo('praticas', 'acesso', null, 'painel_indicador')) {
		...
		$sql->adOnde('painel_gestao_patrocinador = '.(int)$patrocinador_id);
	...
	if ($Aplic->profissional && $Aplic->checarModulo('praticas', 'acesso', null, 'odometro_indicador')) {
		...
		$sql->adOnde('painel_odometro_gestao_patrocinador = '.(int)$patrocinador_id);
	...
	if ($Aplic->profissional && $Aplic->checarModulo('praticas', 'acesso', null, 'composicao_painel')) {
		...
		$sql->adOnde('painel_composicao_gestao_patrocinador = '.(int)$patrocinador_id);
	...
	if ($Aplic->profissional && $Aplic->checarModulo('praticas', 'acesso', null, 'slideshow_painel')) {
		...
		$sql->adOnde('painel_slideshow_gestao_patrocinador = '.(int)$patrocinador_id);
	...
	if ($Aplic->profissional && $Aplic->checarModulo('agenda', 'acesso', null, null)) {
		...
		$sql->adOnde('calendario_gestao_patrocinador = '.(int)$patrocinador_id);
	...
	if ($Aplic->checarModulo('praticas', 'acesso', null, 'perspectiva')) {
		...
		$sql->adOnde('perspectiva_gestao_patrocinador = '.(int)$patrocinador_id);
	...
	if ($Aplic->checarModulo('praticas', 'acesso', null, 'tema')) {
		...
		$sql->adOnde('tema_gestao_patrocinador = '.(int)$patrocinador_id);
	...
	if ($Aplic->checarModulo('praticas', 'acesso', null, 'objetivo')) {
		...
		$sql->adOnde('objetivo_gestao_patrocinador = '.(int)$patrocinador_id);
	...
	if ($Aplic->checarModulo('praticas', 'acesso', null, 'me')) {
		...
		$sql->adOnde('me_gestao_patrocinador = '.(int)$patrocinador_id);
	...
	if ($config['exibe_fator'] && $Aplic->checarModulo('praticas', 'acesso', null, 'fator')) {
		...
		$sql->adOnde('fator_gestao_patrocinador = '.(int)$patrocinador_id);
	...
	if ($Aplic->checarModulo('praticas', 'acesso', null, 'iniciativa')) {
		...
		$sql->adOnde('estrategia_gestao_patrocinador = '.(int)$patrocinador_id);
	...
	if ($Aplic->checarModulo('praticas', 'acesso', null, 'meta')) {
		...
		$sql->adOnde('meta_gestao_patrocinador = '.(int)$patrocinador_id);
	...
	if ($Aplic->checarModulo('praticas', 'acesso', null, 'planejamento')) {
		...
		$sql->adOnde('plano_gestao_gestao_patrocinador = '.(int)$patrocinador_id);
	...
	if ($Aplic->checarModulo('projetos', 'acesso', null, 'abertura')) {
		...
		$sql->adOnde('projeto_abertura_gestao_patrocinador = '.(int)$patrocinador_id);
	...
	if ($Aplic->checarModulo('projetos', 'acesso', null, 'viabilidade')) {
		...
		$sql->adOnde('projeto_viabilidade_gestao_patrocinador = '.(int)$patrocinador_id);
	...
	if ($Aplic->profissional && $Aplic->modulo_ativo('ssti') && $Aplic->checarModulo('ssti', 'acesso')) {
		...
		$sql->adOnde('ssti_gestao_patrocinador = '.(int)$patrocinador_id);
	...
	if ($Aplic->profissional && $Aplic->modulo_ativo('ssti') && $Aplic->checarModulo('ssti', 'acesso',null, 'laudo')) {
		...
		$sql->adOnde('laudo_gestao_patrocinador = '.(int)$patrocinador_id);
	...
	if ($Aplic->profissional && $Aplic->modulo_ativo('trelo') && $Aplic->checarModulo('trelo', 'acesso')) {
		...
		$sql->adOnde('trelo_gestao_patrocinador = '.(int)$patrocinador_id);
	...
	if ($Aplic->profissional && $Aplic->modulo_ativo('trelo') && $Aplic->checarModulo('trelo', 'acesso')) {
		...
		$sql->adOnde('trelo_cartao_gestao_patrocinador = '.(int)$patrocinador_id);
	...
	if ($Aplic->profissional && $Aplic->modulo_ativo('pdcl') && $Aplic->checarModulo('pdcl', 'acesso')) {
		...
		$sql->adOnde('pdcl_gestao_patrocinador = '.(int)$patrocinador_id);
	...
	if ($Aplic->profissional && $Aplic->modulo_ativo('pdcl') && $Aplic->checarModulo('pdcl', 'acesso')) {
		...
		$sql->adOnde('pdcl_item_gestao_patrocinador = '.(int)$patrocinador_id);
	...
	if ($Aplic->profissional && $Aplic->modulo_ativo('os') && $Aplic->checarModulo('os', 'acesso')) {
		...
		$sql->adOnde('os_gestao_patrocinador = '.(int)$patrocinador_id);

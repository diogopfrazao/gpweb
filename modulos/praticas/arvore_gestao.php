...
if (!$dialogo){
  ...
  $saida.='<table cellspacing=0 cellpadding=0>';
	...
	$procura_tipo='<tr><td align="right" style="white-space: nowrap">'.dica('Exibição', 'Qual a forma de apresentar os objetos principais da árvore de gestão').'Exibição:'.dicaF().'</td><td>'.selecionaVetor($tipos, 'tipo_arvore', 'onchange="document.frm_filtro.submit()" class="texto" style="width:250px;"', $tipo_arvore).'</td></tr>';

	$popup='<tr><td style="white-space: nowrap">'.dica('PopUp', 'Abrir uma janela com a árvore de gestão para facilitar a navegação entre os dados.').'<a href="javascript: void(0)" onclick="popup();" ><img src="'.acharImagem('popup.png').'" border=0 width="16" heigth="16" /></a>'.dicaF().'</td></tr>';
	$imprimir='<tr><td align="right" style="white-space: nowrap">'.dica('Imprimir', 'Clique neste ícone '.imagem('imprimir_p.png').' para imprimir a árvore da gestão estratégica.').'<a href="javascript: void(0);" onclick ="url_passar(1, \'m=praticas&a=arvore_gestao&dialogo=1\');">'.imagem('imprimir_p.png').'</a>'.dicaF().'</td></tr>';
	
	$icone_exibir_painel='<tr><td width="1%" style="white-space: nowrap"><input type="checkbox" name="exibir_painel" id="exibir_painel" '.($exibir_painel ? 'checked="checked"' : '').' onchange="document.frm_filtro.submit()" value="1" /></td><td width="1%" style="white-space: nowrap"><label for="exibir_painel">'.dica('Painéis', 'Selecione esta opção caso deseja ver os painéis envolvidos.').' Painéis'.dicaF().'</label></td></tr>';
	$icone_exibir_painel_composicao='<tr><td width="1%" style="white-space: nowrap"><input type="checkbox" name="exibir_painel_composicao" id="exibir_painel_composicao" '.($exibir_painel_composicao ? 'checked="checked"' : '').' onchange="document.frm_filtro.submit()" value="1" /></td><td width="1%" style="white-space: nowrap"><label for="exibir_painel_composicao">'.dica('Composições de Painéis', 'Selecione esta opção caso deseja ver as composições de painéis envolvidas.').' Composições de Painéis'.dicaF().'</label></td></tr>';
	
	$icone_exibir_painel_slideshow='<tr><td width="1%" style="white-space: nowrap"><input type="checkbox" name="exibir_painel_slideshow" id="exibir_painel_slideshow" '.($exibir_painel_slideshow ? 'checked="checked"' : '').' onchange="document.frm_filtro.submit()" value="1" /></td><td width="1%" style="white-space: nowrap"><label for="exibir_painel_slideshow">'.dica('Slideshows', 'Selecione esta opção caso deseja ver os slideshows envolvidos.').' Slideshows'.dicaF().'</label></td></tr>';
	...
	$icone_exibir_acao='<tr><td width="1%" style="white-space: nowrap"><input type="checkbox" name="exibir_acao" id="exibir_acao" '.($exibir_acao ? 'checked="checked"' : '').' onchange="document.frm_filtro.submit()" value="1" /></td><td width="1%" style="white-space: nowrap"><label for="exibir_acao">'.dica(ucfirst($config['acoes']), 'Selecione esta opção caso deseja ver '.$config['genero_acao'].'s '.$config['acoes'].' envolvid'.$config['genero_acao'].'s.').' '.$config['acoes'].dicaF().'</label></td></tr>';
	$icone_exibir_meta='<tr><td width="1%" style="white-space: nowrap"><input type="checkbox" name="exibir_meta" id="exibir_meta" '.($exibir_meta ? 'checked="checked"' : '').' onchange="document.frm_filtro.submit()" value="1" /></td><td width="1%" style="white-space: nowrap"><label for="exibir_meta">'.dica(ucfirst($config['metas']), 'Selecione esta opção caso deseja ver '.$config['genero_meta'].'s '.$config['metas'].' envolvid'.$config['genero_meta'].'s.').' '.$config['metas'].dicaF().'</label></td></tr>';
	$icone_exibir_indicador='<tr><td width="1%" style="white-space: nowrap"><input type="checkbox" name="exibir_indicador" id="exibir_indicador" '.($exibir_indicador ? 'checked="checked"' : '').' onchange="document.frm_filtro.submit()" value="1" /></td><td width="1%" style="white-space: nowrap"><label for="exibir_indicador">'.dica('Indicadores', 'Selecione esta opção caso deseja ver os indicadores envolvidos.').' indicadores'.dicaF().'</label></td></tr>';
	$exibir='<tr><td align="right" style="white-space: nowrap">'.dica('Exibir', 'Quais objetos da lista à direita deseja exibir na árvore de gestão.').'Exibir:'.dicaF().'</td><td><table cellspacing=0 cellpadding=0>'.$icone_exibir_meta.$icone_exibir_indicador.$icone_exibir_projeto.$icone_exibir_acao.$icone_exibir_painel.$icone_exibir_painel_composicao.$icone_exibir_painel_slideshow.'</table></td></tr>';
	$botao_link=($Aplic->profissional && $podeEditar ? '<tr><td><a href="javascript: void(0)" onclick="javascript:exportar_link();">'.imagem('icones/arvore_exporta.png', 'Exportar Link', 'Clique neste ícone '.imagem('icones/arvore_exporta.png').' para criar um endereço web para visualização da árvore em ambiente externo.').'</a></td></tr>' : '');

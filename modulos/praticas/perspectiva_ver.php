...
if (isset($_REQUEST['pg_perspectiva_id'])) $Aplic->setEstado('pg_perspectiva_id', getParam($_REQUEST, 'pg_perspectiva_id', null), $m, $a, $u);
$pg_perspectiva_id = $Aplic->getEstado('pg_perspectiva_id', null, $m, $a, $u);
...
if ($Aplic->profissional){
	...
	$sql->adOnde('assinatura_perspectiva IN ('.$pg_perspectiva_id.')');
	$assinar = $sql->linha();
	$sql->limpar();
...
if(!(permiteAcessarPerspectiva($obj->pg_perspectiva_acesso,$pg_perspectiva_id) && $Aplic->checarModulo('praticas', 'acesso', $Aplic->usuario_id, 'perspectiva'))) $Aplic->redirecionar('m=publico&a=acesso_negado');

$editar=permiteEditarPerspectiva($obj->pg_perspectiva_acesso,$pg_perspectiva_id);
$podeEditar=$Aplic->checarModulo('praticas', 'editar', $Aplic->usuario_id, 'perspectiva');
$podeAdicionar=$Aplic->checarModulo('praticas', 'adicionar', $Aplic->usuario_id, 'perspectiva');
$podeExcluir=$Aplic->checarModulo('praticas', 'excluir', $Aplic->usuario_id, 'perspectiva');

$podeEditarTudo=($obj->pg_perspectiva_acesso>=5 ? $editar && (in_array($obj->pg_perspectiva_usuario, $Aplic->usuario_lista_grupo_vetor) || $Aplic->usuario_super_admin || $Aplic->usuario_admin) : $editar);
...
if (!$dialogo){	
	...
	if ($podeAdicionar)	$km->Add("inserir","inserir_objeto",dica('Nov'.$config['genero_perspectiva'].' '.ucfirst($config['perspectiva']), 'Criar um nov'.$config['genero_perspectiva'].' '.$config['perspectiva'].'.').'Nov'.$config['genero_perspectiva'].' '.ucfirst($config['perspectiva']).dicaF(), "javascript: void(0);' onclick='url_passar(0, \"m=praticas&a=perspectiva_editar\");");	
	if ($podeEditar && $editar) {
		$km->Add("inserir","inserir_registro",dica('Registro de Ocorrência','Inserir um novo registro de ocorrência.').'Registro de ocorrência'.dicaF(), "javascript: void(0);' onclick='url_passar(0, \"m=praticas&a=log_editar&pg_perspectiva_id=".$pg_perspectiva_id."\");");
		if ($Aplic->modulo_ativo('calendario') && $Aplic->checarModulo('eventos', 'adicionar')) $km->Add("inserir","inserir_evento",dica('Novo Evento', 'Criar um novo evento relacionado.').'Evento'.dicaF(), "javascript: void(0);' onclick='url_passar(0, \"m=calendario&a=editar&evento_perspectiva=".$pg_perspectiva_id."\");");
		...
		if ($Aplic->modulo_ativo('links') && $Aplic->checarModulo('links', 'adicionar')) $km->Add("diverso","inserir_link",dica('Novo Link', 'Inserir um novo link relacionado.').'Link'.dicaF(), "javascript: void(0);' onclick='url_passar(0, \"m=links&a=editar&link_perspectiva=".$pg_perspectiva_id."\");");
		if ($Aplic->modulo_ativo('foruns') && $Aplic->checarModulo('foruns', 'adicionar')) $km->Add("diverso","inserir_forum",dica('Novo Fórum', 'Inserir um novo fórum relacionado.').'Fórum'.dicaF(), "javascript: void(0);' onclick='url_passar(0, \"m=foruns&a=editar&forum_perspectiva=".$pg_perspectiva_id."\");");
	...
	if ($podeEditarTudo && $podeEditar && !$bloquear) $km->Add("acao","acao_editar",dica('Editar '.ucfirst($config['perspectiva']),'Editar os detalhes d'.($config['genero_perspectiva']=='a' ? 'esta' : 'este').' '.$config['perspectiva'].'.').'Editar '.ucfirst($config['perspectiva']).dicaF(), "javascript: void(0);' onclick='url_passar(0, \"m=praticas&a=perspectiva_editar&pg_perspectiva_id=".$pg_perspectiva_id."\");");
	if ($podeEditarTudo && $podeExcluir && !$bloquear) $km->Add("acao","acao_excluir",dica('Excluir','Excluir '.($config['genero_perspectiva']=='a' ? 'esta' : 'este').' '.$config['perspectiva'].'.').'Excluir '.ucfirst($config['perspectiva']).dicaF(), "javascript: void(0);' onclick='excluir()");
	...
	if ($Aplic->profissional) $km->Add("acao_imprimir","dashboard_geral",dica('Grau de Consecução','Dashboard do grau de consecução d'.($config['genero_perspectiva']=='a' ? 'esta' : 'este').' '.$config['perspectiva'].'.').'Grau de Consecução'.dicaF(), "javascript: void(0);' onclick='url_passar(\"dashboard_geral_".$pg_perspectiva_id."\", \"m=praticas&a=perspectiva_deshboard_geral_pro&jquery=1&dialogo=1&pg_perspectiva_id=".$pg_perspectiva_id."\");");
...
echo '<tr><td style="border: outset #d1d1cd 1px;background-color:#'.$obj->pg_perspectiva_cor.'; color:#'.melhorCor($obj->pg_perspectiva_cor).'" colspan="2"><b>'.$obj->pg_perspectiva_nome.'<b>'.$cor_indicador.'</td></tr>';
...
if ($obj->pg_perspectiva_cia) echo '<tr><td align="right" style="white-space: nowrap">'.dica(ucfirst($config['organizacao']).' Responsável', ucfirst($config['genero_organizacao']).' '.$config['organizacao'].' responsável.').ucfirst($config['organizacao']).' responsável:'.dicaF().'</td><td class="realce" width="100%">'.link_cia($obj->pg_perspectiva_cia).'</td></tr>';
...
if ($obj->pg_perspectiva_dept) echo '<tr><td align="right" style="white-space: nowrap">'.dica(ucfirst($config['departamento']).' Responsável', ucfirst($config['genero_dept']).' '.$config['departamento'].' responsável por '.($config['genero_perspectiva']=='a' ? 'esta' : 'este').' '.$config['perspectiva'].'.').ucfirst($config['departamento']).' responsável:'.dicaF().'</td><td class="realce" width="100%">'.link_dept($obj->pg_perspectiva_dept).'</td></tr>';
$saida_depts='';
...
if ($saida_depts) echo '<tr><td align="right" valign="top" style="white-space: nowrap">'.dica(ucfirst($config['departamentos']), 'Qual '.strtolower($config['departamento']).' está envolvid'.$config['genero_dept'].' com '.($config['genero_perspectiva']=='a' ? 'esta' : 'este').' '.$config['perspectiva'].'.').ucfirst($config['departamentos']).' envolvid'.$config['genero_dept'].'s:'.dicaF().'</td><td width="100%" colspan="2" class="realce">'.$saida_depts.'</td></tr>';




if ($obj->pg_perspectiva_usuario) echo '<tr><td align="right" valign="top" style="white-space: nowrap">'.dica('Responsável pel'.$config['genero_perspectiva'].' '.ucfirst($config['perspectiva']).'', ucfirst($config['usuario']).' responsável por gerenciar '.$config['genero_perspectiva'].' '.$config['perspectiva'].'.').'Responsável:'.dicaF().'</td><td class="realce" width="100%">'.link_usuario($obj->pg_perspectiva_usuario, '','','esquerda').'</td></tr>';		
...
if ($Aplic->profissional){
	...
	echo '<tr><td align="right" style="white-space: nowrap">'.dica('Sistema de Percentagem', 'Qual forma a percentagem d'.$config['genero_perspectiva'].' '.$config['perspectiva'].' é calculada.').'Sistema de percentagem:'.dicaF().'</td><td class="realce">'.(isset($tipo_pontuacao[$obj->pg_perspectiva_tipo_pontuacao]) ? $tipo_pontuacao[$obj->pg_perspectiva_tipo_pontuacao] : '').'</td></tr>';
	if ($obj->pg_perspectiva_tipo_pontuacao && $obj->pg_perspectiva_tipo_pontuacao!='indicador'){
		...
		if (is_array($medias) && count($medias)){
			...
			foreach ($medias as $contato_id => $media) {
				...
				if ($media['perspectiva_media_projeto']) echo '<td align="left">'.imagem('icones/projeto_p.gif').link_projeto($media['perspectiva_media_projeto']).'</td>';
				elseif ($media['perspectiva_media_acao']) echo '<td align="left">'.imagem('icones/plano_acao_p.gif').link_acao($media['perspectiva_media_acao']).'</td>';
				elseif ($media['perspectiva_media_objetivo']) echo '<td align="left">'.imagem('icones/obj_estrategicos_p.gif').link_objetivo($media['perspectiva_media_objetivo']).'</td>';
				elseif ($media['perspectiva_media_tema']) echo '<td align="left">'.imagem('icones/tema_p.png').link_tema($media['perspectiva_media_tema']).'</td>';
				elseif ($media['perspectiva_media_estrategia']) echo '<td align="left">'.imagem('icones/estrategia_p.gif').link_estrategia($media['perspectiva_media_estrategia']).'</td>';
	...
	echo '<tr><td align="right" style="white-space: nowrap">'.dica('Progresso', 'O progresso pode ir de 0% (não iniciado) até 100% (completado).').'Progresso:'.dicaF().'</td><td class="realce">'.number_format((float)$obj->pg_perspectiva_percentagem, 2, ',', '.').'%</td></tr>';
	
	
	if($obj->pg_perspectiva_tipo_pontuacao){
		...
		$velocidade_fisico=($fisico_previsto > 0 ? $obj->pg_perspectiva_percentagem/$fisico_previsto : 0);
...
if ($obj->pg_perspectiva_principal_indicador) echo '<tr><td align="right" style="white-space: nowrap">'.dica('Indicador Principal', 'O indicador d'.$config['genero_perspectiva'].' '.$config['perspectiva'].' mais representativo da situação geral d'.$config['genero_perspectiva'].' mesm'.$config['genero_perspectiva'].'.').'Indicador principal:'.dicaF().'</td><td width="100%" class="realce">'.link_indicador($obj->pg_perspectiva_principal_indicador).'</td></tr>';
...
if ($Aplic->profissional && $Aplic->modulo_ativo('operativo') && $Aplic->checarModulo('operativo', 'acesso')){
	...
	if (count($lista2)) echo '<tr><td align="right" valign="top" style="white-space: nowrap">'.dica('Plano'.$plural.' Operativo'.$plural, ($plural == 's' ? 'Quais planos operativos fazem parte ' : 'Qual plano operativo faz parte').($config['genero_perspectiva']=='a' ? 'desta' : 'deste').' '.$config['perspectiva'].'.').'Plano'.$plural.' operativo'.$plural.':'.dicaF().'</td><td class="realce" width="100%"><table cellspacing=0 cellpadding=0>';
...
if ($obj->pg_perspectiva_descricao) echo '<tr><td align="right" style="white-space: nowrap">'.dica('Descrição', 'Descrição d'.$config['genero_perspectiva'].' '.$config['perspectiva'].'.').'Descrição:'.dicaF().'</td></td><td class="realce" width="100%" style="margin-bottom:0cm; margin-top:0cm;">'.$obj->pg_perspectiva_descricao.'</td></tr>';
if ($obj->pg_perspectiva_oque) echo '<tr><td align="right" valign="top" style="white-space: nowrap">'.dica('O Que Fazer', 'Sumário sobre o que se trata '.($config['genero_perspectiva']=='a' ? 'esta' : 'este').' '.$config['perspectiva'].'.').'O Que:'.dicaF().'</td><td class="realce" width="100%" style="margin-bottom:0cm; margin-top:0cm;">'.$obj->pg_perspectiva_oque.'</td></tr>';
if ($obj->pg_perspectiva_porque) echo '<tr><td align="right" valign="top" style="white-space: nowrap">'.dica('Por Que Fazer', 'Por que '.($config['genero_perspectiva']=='a' ? 'esta' : 'este').' '.$config['perspectiva'].' será executada.').'Por que:'.dicaF().'</td><td class="realce" width="100%" style="margin-bottom:0cm; margin-top:0cm;">'.$obj->pg_perspectiva_porque.'</td></tr>';
if ($obj->pg_perspectiva_onde) echo '<tr><td align="right" valign="top" style="white-space: nowrap">'.dica('Onde Fazer', 'Onde '.($config['genero_perspectiva']=='a' ? 'esta' : 'este').' '.$config['perspectiva'].' é executada.').'Onde:'.dicaF().'</td><td class="realce" width="100%" style="margin-bottom:0cm; margin-top:0cm;">'.$obj->pg_perspectiva_onde.'</td></tr>';
if ($obj->pg_perspectiva_quando) echo '<tr><td align="right" valign="top" style="white-space: nowrap">'.dica('Quando Fazer', 'Quando '.($config['genero_perspectiva']=='a' ? 'esta' : 'este').' '.$config['perspectiva'].' é executada.').'Quando:'.dicaF().'</td><td class="realce" width="100%" style="margin-bottom:0cm; margin-top:0cm;">'.$obj->pg_perspectiva_quando.'</td></tr>';


if ($obj->pg_perspectiva_quem) echo '<tr><td align="right" valign="top" style="white-space: nowrap">'.dica('Quem Faz', 'Quais '.$config['usuarios'].' estarão executando '.($config['genero_perspectiva']=='a' ? 'esta' : 'este').' '.$config['perspectiva'].'.').'Quem:'.dicaF().'</td><td width="100%" class="realce">'.$obj->pg_perspectiva_quem.'</td></tr>';

if ($obj->pg_perspectiva_como) echo '<tr><td align="right" valign="top" style="white-space: nowrap">'.dica('Como Fazer', 'Como '.$config['genero_perspectiva'].' '.$config['perspectiva'].' é executada.').'Como:'.dicaF().'</td><td class="realce" width="100%" style="margin-bottom:0cm; margin-top:0cm;">'.$obj->pg_perspectiva_como.'</td></tr>';
if ($obj->pg_perspectiva_quanto) echo '<tr><td align="right" valign="top" style="white-space: nowrap">'.dica('Quanto Custa', 'Custo para executar '.$config['genero_perspectiva'].' '.$config['perspectiva'].'.').'Quanto:'.dicaF().'</td><td class="realce" width="100%" style="margin-bottom:0cm; margin-top:0cm;">'.$obj->pg_perspectiva_quanto.'</td></tr>';

	


if ($obj->pg_perspectiva_desde_quando) echo '<tr><td align="right" valign="top" style="white-space: nowrap">'.dica('Desde Quando', 'Desde quando '.$config['genero_perspectiva'].' '.$config['perspectiva'].' é executada.').'Desde quando:'.dicaF().'</td><td class="realce" width="100%" style="margin-bottom:0cm; margin-top:0cm;">'.$obj->pg_perspectiva_desde_quando.'</td></tr>';
if ($obj->pg_perspectiva_controle) echo '<tr><td align="right" valign="top" style="white-space: nowrap">'.dica('Método de Controle', 'Como '.$config['genero_perspectiva'].' '.$config['perspectiva'].' é controlada.').'Controle:'.dicaF().'</td><td class="realce" width="100%" style="margin-bottom:0cm; margin-top:0cm;">'.$obj->pg_perspectiva_controle.'</td></tr>';
if ($obj->pg_perspectiva_metodo_aprendizado) echo '<tr><td align="right" valign="top" style="white-space: nowrap">'.dica('Método de Aprendizado', 'Como é realizado o aprendizado d'.$config['genero_perspectiva'].' '.$config['perspectiva'].'.').'Aprendizado:'.dicaF().'</td><td class="realce" width="100%" style="margin-bottom:0cm; margin-top:0cm;">'.$obj->pg_perspectiva_metodo_aprendizado.'</td></tr>';
if ($obj->pg_perspectiva_melhorias) echo '<tr><td align="right" valign="top" style="white-space: nowrap">'.dica('Melhorias Efetuadas n'.$config['genero_perspectiva'].' '.ucfirst($config['perspectiva']).'', 'Quais as melhorias realizadas n'.$config['genero_perspectiva'].' '.$config['perspectiva'].' após girar o círculo PDCA.').'Melhorias:'.dicaF().'</td><td class="realce" width="100%" style="margin-bottom:0cm; margin-top:0cm;">'.$obj->pg_perspectiva_melhorias.'</td></tr>';
...
if ($Aplic->profissional && $exibir['moeda']) {
	...
	$sql->limpar();
	if (isset($moedas[$obj->pg_perspectiva_moeda])) echo '<tr><td align="right" style="white-space: nowrap">'.dica('Moeda', 'A moeda padrão utilizada.').'Moeda:'.dicaF().'</td><td class="realce" width="100%">'.$moedas[$obj->pg_perspectiva_moeda].'</td></tr>';
	}
if ($Aplic->profissional && $tem_aprovacao) echo '<tr><td align="right" style="white-space: nowrap">'.dica('Aprovad'.$config['genero_perspectiva'], 'Se '.$config['genero_perspectiva'].' '.$config['perspectiva'].' se encontra aprovad'.$config['genero_perspectiva'].'.').'Aprovad'.$config['genero_perspectiva'].':'.dicaF().'</td><td  class="realce" width="100%">'.($obj->pg_perspectiva_aprovado ? 'Sim' : '<span style="color:red; font-weight:bold">Não</span>').'</td></tr>';
...
$sql->adOnde('perspectiva_gestao_perspectiva ='.(int)$pg_perspectiva_id);	
...
if (count($lista)) {
	echo '<tr><td align="right" style="white-space: nowrap" valign="middle">'.dica('Relacionad'.$config['genero_perspectiva'], 'A que área '.$config['genero_perspectiva'].' '.$config['perspectiva'].' está relacionad'.$config['genero_perspectiva'].'.').'Relacionad'.$config['genero_perspectiva'].':'.dicaF().'</td></td><td class="realce">';	
	foreach($lista as $gestao_data){
		...
		elseif ($gestao_data['perspectiva_gestao_patrocinador']) echo ($qnt_gestao++ ? '<br>' : '').imagem('../../../modulos/patrocinadores/imagens/patrocinador_p.gif').link_patrocinador($gestao_data['perspectiva_gestao_patrocinador']);
...
if (!$dialogo && $Aplic->profissional){ 
	$caixaTab = new CTabBox('m='.$m.'&a='.$a.'&u='.$u.'&pg_perspectiva_id='.$pg_perspectiva_id, '', $tab);
	...
	if ($Aplic->checarModulo('praticas', 'acesso', null, 'plano_acao_item')) {
		...
		$sql->adOnde('plano_acao_item_gestao_perspectiva = '.(int)$pg_perspectiva_id);
	...
	if ($Aplic->checarModulo('projetos', 'acesso', null, 'demanda')) {
		...
		$sql->adOnde('demanda_gestao_perspectiva = '.(int)$pg_perspectiva_id);
	...
	if ($Aplic->profissional && $Aplic->modulo_ativo('praticas') && $Aplic->checarModulo('praticas', 'acesso', null, 'risco_resposta')) {		
		...
		$sql->adOnde('risco_resposta_gestao_perspectiva = '.(int)$pg_perspectiva_id);
	...
	if ($Aplic->checarModulo('recursos', 'acesso', null, null)) {
		...
		$sql->adOnde('recurso_gestao_perspectiva = '.(int)$pg_perspectiva_id);
	...
	if ($Aplic->modulo_ativo('patrocinadores') && $Aplic->checarModulo('patrocinadores', 'acesso', null, null)) {
		...
		$sql->adOnde('patrocinador_gestao_perspectiva = '.(int)$pg_perspectiva_id);
	...
	if ($Aplic->profissional && $Aplic->checarModulo('projetos', 'acesso', null, 'programa')) {
		...
		$sql->adOnde('programa_gestao_perspectiva = '.(int)$pg_perspectiva_id);
	...
	if ($Aplic->profissional && $Aplic->checarModulo('projetos', 'acesso', null, 'beneficio')) {
		...
		$sql->adOnde('beneficio_gestao_perspectiva = '.(int)$pg_perspectiva_id);
	...
	if ($Aplic->checarModulo('projeto', 'acesso', 'licao')) {
		...
		$sql->adOnde('licao_gestao_perspectiva = '.(int)$pg_perspectiva_id);
	...
	if ($Aplic->checarModulo('praticas', 'acesso', null, 'pratica')) {
		...
		$sql->adOnde('pratica_gestao_perspectiva = '.(int)$pg_perspectiva_id);
	...
	if ($Aplic->profissional && $Aplic->modulo_ativo('tr') && $Aplic->checarModulo('tr', 'acesso', null, null)) {
		...
		$sql->adOnde('tr_gestao_perspectiva = '.(int)$pg_perspectiva_id);
	...
	if ($Aplic->profissional && $Aplic->checarModulo('praticas', 'acesso', null, 'tgn')) {
		...
		$sql->adOnde('tgn_gestao_perspectiva = '.(int)$pg_perspectiva_id);
	...
	if ($Aplic->profissional && $Aplic->checarModulo('praticas', 'acesso', null, 'canvas')) {
		...
		$sql->adOnde('canvas_gestao_perspectiva = '.(int)$pg_perspectiva_id);
	...
	if ($Aplic->profissional && $Aplic->modulo_ativo('swot') && $Aplic->checarModulo('swot', 'acesso', null, null)) {
		...
		$sql->adOnde('mswot_gestao_perspectiva = '.(int)$pg_perspectiva_id);
	...
	if ($Aplic->profissional && $Aplic->modulo_ativo('swot') && $Aplic->checarModulo('swot', 'acesso', null, null)) {
		...
		$sql->adOnde('swot_gestao_perspectiva = '.(int)$pg_perspectiva_id);
	...
	if ($Aplic->profissional && $Aplic->modulo_ativo('operativo') && $Aplic->checarModulo('operativo', 'acesso', null, null)) {
		...
		$sql->adOnde('operativo_gestao_perspectiva = '.(int)$pg_perspectiva_id);
	...
	if ($Aplic->profissional && $Aplic->checarModulo('praticas', 'acesso', null, 'monitoramento')) {
		...
		$sql->adOnde('monitoramento_gestao_perspectiva = '.(int)$pg_perspectiva_id);
	...
	if ($Aplic->checarModulo('praticas', 'acesso', null, 'avaliacao_indicador')) {
		...
		$sql->adOnde('avaliacao_gestao_perspectiva = '.(int)$pg_perspectiva_id);
	...
	if ($Aplic->checarModulo('praticas', 'acesso', null, 'checklist')) {
		...
		$sql->adOnde('checklist_gestao_perspectiva = '.(int)$pg_perspectiva_id);
	...
	if ($Aplic->profissional) {
		...
		$sql->adOnde('agenda_gestao_perspectiva = '.(int)$pg_perspectiva_id);
	...
	if ($Aplic->profissional && $Aplic->modulo_ativo('agrupamento') && $Aplic->checarModulo('agrupamento', 'acesso', null, null)) {
		...
		$sql->adOnde('agrupamento_gestao_perspectiva = '.(int)$pg_perspectiva_id);
	...
	if ($Aplic->profissional && $Aplic->checarModulo('projetos', 'acesso', null, 'modelo')) {
		...
		$sql->adOnde('template_gestao_perspectiva = '.(int)$pg_perspectiva_id);
	...
	if ($Aplic->profissional && $Aplic->checarModulo('praticas', 'acesso', null, 'painel_indicador')) {
		...
		$sql->adOnde('painel_gestao_perspectiva = '.(int)$pg_perspectiva_id);
	...
	if ($Aplic->profissional && $Aplic->checarModulo('praticas', 'acesso', null, 'odometro_indicador')) {
		...
		$sql->adOnde('painel_odometro_gestao_perspectiva = '.(int)$pg_perspectiva_id);
	...
	if ($Aplic->profissional && $Aplic->checarModulo('praticas', 'acesso', null, 'composicao_painel')) {
		...
		$sql->adOnde('painel_composicao_gestao_perspectiva = '.(int)$pg_perspectiva_id);
	...
	if ($Aplic->profissional && $Aplic->checarModulo('praticas', 'acesso', null, 'slideshow_painel')) {
		...
		$sql->adOnde('painel_slideshow_gestao_perspectiva = '.(int)$pg_perspectiva_id);
	...
	if ($Aplic->profissional && $Aplic->checarModulo('agenda', 'acesso', null, null)) {
		...
		$sql->adOnde('calendario_gestao_perspectiva = '.(int)$pg_perspectiva_id);
	...
	if ($Aplic->checarModulo('praticas', 'acesso', null, 'perspectiva')) {
		$sql->adTabela('perspectiva_gestao');
		$sql->adOnde('perspectiva_gestao_semelhante = '.(int)$pg_perspectiva_id);
	...
	if ($Aplic->checarModulo('praticas', 'acesso', null, 'tema')) {
		...
		$sql->adOnde('tema_gestao_perspectiva = '.(int)$pg_perspectiva_id);
	...
	if ($Aplic->checarModulo('praticas', 'acesso', null, 'objetivo')) {
		...
		$sql->adOnde('objetivo_gestao_perspectiva = '.(int)$pg_perspectiva_id);
	...
	if ($Aplic->checarModulo('praticas', 'acesso', null, 'me')) {
		...
		$sql->adOnde('me_gestao_perspectiva = '.(int)$pg_perspectiva_id);
	...
	if ($config['exibe_fator'] && $Aplic->checarModulo('praticas', 'acesso', null, 'fator')) {
		...
		$sql->adOnde('fator_gestao_perspectiva = '.(int)$pg_perspectiva_id);
	...
	if ($Aplic->checarModulo('praticas', 'acesso', null, 'iniciativa')) {
		...
		$sql->adOnde('estrategia_gestao_perspectiva = '.(int)$pg_perspectiva_id);
	...
	if ($Aplic->checarModulo('praticas', 'acesso', null, 'meta')) {
		...
		$sql->adOnde('meta_gestao_perspectiva = '.(int)$pg_perspectiva_id);
	...
	if ($Aplic->checarModulo('praticas', 'acesso', null, 'planejamento')) {
		...
		$sql->adOnde('plano_gestao_gestao_perspectiva = '.(int)$pg_perspectiva_id);
	...
	if ($Aplic->checarModulo('projetos', 'acesso', null, 'abertura')) {
		...
		$sql->adOnde('projeto_abertura_gestao_perspectiva = '.(int)$pg_perspectiva_id);
	...
	if ($Aplic->checarModulo('projetos', 'acesso', null, 'viabilidade')) {
		...
		$sql->adOnde('projeto_viabilidade_gestao_perspectiva = '.(int)$pg_perspectiva_id);
	...
	if ($Aplic->profissional && $Aplic->modulo_ativo('ssti') && $Aplic->checarModulo('ssti', 'acesso')) {
		...
		$sql->adOnde('ssti_gestao_perspectiva = '.(int)$pg_perspectiva_id);
	...
	if ($Aplic->profissional && $Aplic->modulo_ativo('ssti') && $Aplic->checarModulo('ssti', 'acesso',null, 'laudo')) {
		...
		$sql->adOnde('laudo_gestao_perspectiva = '.(int)$pg_perspectiva_id);
	...
	if ($Aplic->profissional && $Aplic->modulo_ativo('trelo') && $Aplic->checarModulo('trelo', 'acesso')) {
		...
		$sql->adOnde('trelo_gestao_perspectiva = '.(int)$pg_perspectiva_id);
	...
	if ($Aplic->profissional && $Aplic->modulo_ativo('trelo') && $Aplic->checarModulo('trelo', 'acesso')) {
		...
		$sql->adOnde('trelo_cartao_gestao_perspectiva = '.(int)$pg_perspectiva_id);
	...
	if ($Aplic->profissional && $Aplic->modulo_ativo('pdcl') && $Aplic->checarModulo('pdcl', 'acesso')) {
		...
		$sql->adOnde('pdcl_gestao_perspectiva = '.(int)$pg_perspectiva_id);
	...
	if ($Aplic->profissional && $Aplic->modulo_ativo('pdcl') && $Aplic->checarModulo('pdcl', 'acesso')) {
		...
		$sql->adOnde('pdcl_item_gestao_perspectiva = '.(int)$pg_perspectiva_id);
	...
	if ($Aplic->profissional && $Aplic->modulo_ativo('os') && $Aplic->checarModulo('os', 'acesso')) {
		...
		$sql->adOnde('os_gestao_perspectiva = '.(int)$pg_perspectiva_id);

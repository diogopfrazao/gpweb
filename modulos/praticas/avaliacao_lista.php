...
if (!$dialogo || $selecao){
	...
	$popFiltro='<tr><td align="right" style="white-space: nowrap">'.dica('Relacionada', 'A que área a avaliação está relacionada.').'Relacionada:'.dicaF().'</td><td align="left">'.selecionaVetor($tipos, 'tipo_relacao', 'style="width:250px;" class="texto" onchange="popRelacao(this.value)"').'</td></tr>';
	...
	$nova_avaliacao=($Aplic->checarModulo('praticas', 'adicionar', null, 'avaliacao_indicador') ? '<tr><td style="white-space: nowrap">'.dica('Nova Avaliação', 'Criar um nova avaliação.').'<a href="javascript: void(0)"onclick="url_passar(0,\'m=praticas&a=avaliacao_editar\');"><img src="'.acharImagem('avaliacao_novo.png').'" border=0 width="16" heigth="16" /></a>'.dicaF().'</td></tr>' : '');
  ...
  $saida.='<table cellspacing=0 cellpadding=0>';
	...
	$botao_favorito='<tr><td style="white-space: nowrap"><a href="javascript: void(0)" onclick="url_passar(0, \'m=publico&a=favoritos&avaliacao=1\');">'.imagem('icones/favorito_p.png','Favoritos', 'Clique neste ícone '.imagem('icones/favorito_p.png').' para criar ou editar um grupo de favoritos, para uma rápida filtragem.').'</a></td></tr>';
	...
	$saida.='<tr><td valign=top><table cellspacing=0 cellpadding=0>'.$procurar_om.$procurar_envolvido.$procurar_usuario.$procuraBuffer.$favoritos.$popFiltro.$filtros.'</table></td><td valign=top><table cellspacing=0 cellpadding=0>'.(!$selecao ? $nova_avaliacao.$imprimir.$botao_favorito.$botao_trava : '').'</table></td></tr></table>';
	$saida.= '</div></div>';
...
if (!$dialogo || $selecao){
	...
	$caixaTab->adicionar(BASE_DIR.'/modulos/praticas/avaliacao_ver_idx','Ativas',null,null,'Ativas','Visualizar todas as avaliações ativas.');
	$caixaTab->adicionar(BASE_DIR.'/modulos/praticas/avaliacao_ver_idx','Inativas',null,null,'Inativas','Visualizar todas as avaliações inativas.');
	$caixaTab->adicionar(BASE_DIR.'/modulos/praticas/avaliacao_ver_idx','Todas',null,null,'Inativas','Visualizar todas as avaliações.');

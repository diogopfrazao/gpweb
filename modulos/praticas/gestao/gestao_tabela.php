...
if (!$dialogo) mostrarBarraNav($xpg_totalregistros, $xpg_tamanhoPagina, $xpg_total_paginas, $pagina, 'Planejamento Estratégico', 'Planejamentos Estratégicos','','',($estilo_interface=='classico' ? 'a6a6a6' : '006fc2'));
...
if ($exibir['plano_gestao_cor']) echo '<th width=16><a class="hdr" href="javascript:void(0);" onclick="url_passar(0, \'m='.$m.'&a='.$a.'&u='.$u.($u ? '&u='.$u : '').($tab ? '&tab='.$tab : '').'&ordenar=pg_cor&ordem='.($ordem ? '0' : '1').'\');">'.($ordenarPor=='pg_cor' ? imagem('icones/'.$seta[$ordem]) : '').dica('Cor d'.$config['genero_plano_gestao'].' '.ucfirst($config['plano_gestao']).'', 'Neste campo fica a cor de identificação do planejamento estratégico.').'Cor'.dicaF().'</a></th>';
echo '<th style="white-space: nowrap"><a class="hdr" href="javascript:void(0);" onclick="url_passar(0, \'m='.$m.'&a='.$a.'&u='.$u.($u ? '&u='.$u : '').($tab ? '&tab='.$tab : '').'&ordenar=pg_nome&ordem='.($ordem ? '0' : '1').'\');">'.($ordenarPor=='pg_nome' ? imagem('icones/'.$seta[$ordem]) : '').dica('Nome', 'Neste campo fica um nome para identificação.').'Nome'.dicaF().'</th>';
...
if ($filtro_prioridade_plano_gestao) echo '<th style="white-space: nowrap"><a href="javascript:void(0);" onclick="url_passar(0, \'m='.$m.'&a='.$a.'&u='.$u.($u ? '&u='.$u : '').($tab ? '&tab='.$tab : '').'&ordenar=priorizacao&ordem='.($ordem ? '0' : '1').'\');" class="hdr">'.dica('Priorização', 'Clique para ordenar pela priorização.').($ordenarPor=='priorizacao' ? imagem('icones/'.$seta[$ordem]) : '').'Prio.'.dicaF().'</a></th>';


if ($exibir['plano_gestao_descricao']) echo '<th style="white-space: nowrap"><a class="hdr" href="javascript:void(0);" onclick="url_passar(0, \'m='.$m.'&a='.$a.'&u='.$u.($u ? '&u='.$u : '').($tab ? '&tab='.$tab : '').'&ordenar=pg_descricao&ordem='.($ordem ? '0' : '1').'\');">'.($ordenarPor=='pg_descricao' ? imagem('icones/'.$seta[$ordem]) : '').dica('Descrição', 'Neste campo fica a descrição pormenorizada.').'Descrição'.dicaF().'</th>';
if ($exibir['plano_gestao_inicio']) echo '<th style="white-space: nowrap"><a class="hdr" href="javascript:void(0);" onclick="url_passar(0, \'m='.$m.'&a='.$a.'&u='.$u.($u ? '&u='.$u : '').($tab ? '&tab='.$tab : '').'&ordenar=pg_inicio&ordem='.($ordem ? '0' : '1').'\');">'.($ordenarPor=='pg_inicio' ? imagem('icones/'.$seta[$ordem]) : '').dica('Início', 'Neste campo fica a data de ínicio.').'Início'.dicaF().'</th>';
if ($exibir['plano_gestao_fim']) echo '<th style="white-space: nowrap"><a class="hdr" href="javascript:void(0);" onclick="url_passar(0, \'m='.$m.'&a='.$a.'&u='.$u.($u ? '&u='.$u : '').($tab ? '&tab='.$tab : '').'&ordenar=pg_fim&ordem='.($ordem ? '0' : '1').'\');">'.($ordenarPor=='pg_fim' ? imagem('icones/'.$seta[$ordem]) : '').dica('Término', 'Neste campo fica a data de término.').'Término'.dicaF().'</th>';

if ($exibir['plano_gestao_relacionado']) echo '<th style="white-space: nowrap">'.dica('Relacionado', 'A que área o planejamento estratégico está relacionado.').'Relacionado'.dicaF().'</th>';

if ($exibir['plano_gestao_cia']) echo '<th style="white-space: nowrap"><a href="javascript:void(0);" onclick="url_passar(0, \'m='.$m.'&a='.$a.'&u='.$u.($tab ? '&tab='.$tab : '').'&ordenar=plano_gestao_cia&ordem='.($ordem ? '0' : '1').'\');" class="hdr">'.dica(ucfirst($config['organizacao']), 'Clique para ordenar pel'.$config['genero_organizacao'].' '.$config['organizacao'].' responsável.').($ordenarPor=='plano_gestao_cia' ? imagem('icones/'.$seta[$ordem]) : '').ucfirst($config['organizacao']).dicaF().'</a></th>';
...
if ($exibir['plano_gestao_dept']) echo '<th style="white-space: nowrap"><a class="hdr" href="javascript:void(0);" onclick="url_passar(0, \'m='.$m.'&a='.$a.'&u='.$u.($u ? '&u='.$u : '').($tab ? '&tab='.$tab : '').'&ordenar=pg_dept&ordem='.($ordem ? '0' : '1').'\');">'.($ordenarPor=='pg_dept' ? imagem('icones/'.$seta[$ordem]) : '').dica(ucfirst($config['departamento']), 'Neste campo fica o nome d'.$config['genero_dept'].' '.$config['departamento'].' responsável.').ucfirst($config['departamento']).dicaF().'</th>';
...
if ($exibir['plano_gestao_responsavel']) echo '<th style="white-space: nowrap"><a class="hdr" href="javascript:void(0);" onclick="url_passar(0, \'m='.$m.'&a='.$a.'&u='.$u.($u ? '&u='.$u : '').($tab ? '&tab='.$tab : '').'&ordenar=pg_usuario&ordem='.($ordem ? '0' : '1').'\');">'.($ordenarPor=='pg_usuario' ? imagem('icones/'.$seta[$ordem]) : '').dica('Responsável', 'Neste campo fica o nome d'.$config['genero_usuario'].' '.$config['usuario'].' responsável.').'Responsável'.dicaF().'</th>';
if ($exibir['plano_gestao_designados']) echo '<th style="white-space: nowrap">'.dica('Designados', 'Neste campo fica os designados para o planejamentos estratégico.').'Designados'.dicaF().'</th>';

if(!$from_lista && !$from_para_fazer) echo '<th style="white-space: nowrap"><a class="hdr" href="javascript:void(0);" onclick="url_passar(0, \'m='.$m.'&a='.$a.'&u='.$u.($tab ? '&tab='.$tab : '').'&ordenarPor=pg_ativo&ordem='.($ordem ? '0' : '1').'\');">'.($ordenarPor==='pg_ativo' ? imagem('icones/'.$seta[$ordem]) : '').dica('Ativo', 'Neste campo consta se o planejamento estratégico está ativo.').'At.'.dicaF().'</a></th>';
...
foreach ($linhas as $linha) {
	if (permiteAcessarPlanoGestao($linha['pg_acesso'],$linha['pg_id'])) {
		...
		if (!$dialogo) echo '<td style="white-space: nowrap" width="16">'.($editar ? dica('Editar', 'Clique neste ícone '.imagem('icones/editar.gif').' para editar o planejamentos estratégico.').'<a href="javascript:void(0);" onclick="url_passar(0, \'m=praticas&u=gestao&a=gestao_editar&pg_id='.$linha['pg_id'].'\');">'.imagem('icones/editar.gif').'</a>'.dicaF() : '&nbsp;').'</td>';
		...
		else echo '<td style="white-space: nowrap">'.dica($linha['pg_nome'], 'Clique para visualizar os detalhes deste planejamentos estratégico.').'<a href="javascript:void(0);" onclick="url_passar(0, \'m=praticas&u=gestao&a=menu&pg_id='.$linha['pg_id'].'\');">'.$linha['pg_nome'].'</a>'.dicaF().'</td>';
		
		if ($exibir['plano_gestao_aprovado'] && $Aplic->profissional) echo '<td style="width: 30px; text-align: center">'.($linha['pg_aprovado'] && $linha['tem_aprovacao'] ? 'Sim' : ($linha['tem_aprovacao'] ? 'Não' : 'N/A')).'</td>';
        ...
        if (!$from_lista && !$from_para_fazer) echo '<td style="width: 30px; text-align: center">'.($linha['pg_ativo'] ? 'Sim' : 'Não').'</td>';

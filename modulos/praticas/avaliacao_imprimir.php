...
if ($obj->avaliacao_responsavel) echo '<tr><td align="right" valign="top" style="white-space: nowrap">'.dica('Responsável pela Avaliação', ucfirst($config['usuario']).' responsável por gerenciar a avaliação.').'Responsável:'.dicaF().'</td><td class="realce" width="100%">'.nome_usuario($obj->avaliacao_responsavel).'</td></tr>';		

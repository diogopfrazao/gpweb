...
if ($marcadores && count($marcadores)){
	...
	foreach($marcadores as $dado){
		if ($dado['pratica_criterio_id']!=$criterio_atual){
			...
			$dentro .= '</table>';
			echo '<tr><td align="left" colspan=2 style="white-space: nowrap">'.dica('Dados Sobre o Critério', $dentro).'<font size=2>'.$criterios[$dado['pratica_criterio_id']]['pratica_criterio_numero'].'.'.$criterios[$dado['pratica_criterio_id']]['pratica_criterio_nome'].'</font>'.dicaF().'</td></tr>';
			}
		if ($dado['pratica_item_id']!=$marcador_atual){
			...
			$dentro .= '</table>';
			echo '<tr><td align="left" colspan=2 style="white-space: nowrap">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;'.dica('Dados Sobre o Critério', $dentro).'<font size=2>'.$criterios[$dado['pratica_criterio_id']]['pratica_criterio_numero'].'.'.$itens[$dado['pratica_item_id']]['pratica_item_numero'].'.'.$itens[$dado['pratica_item_id']]['pratica_item_nome'].'</font>'.dicaF().'</td></tr>';
			}
	
		echo '<tr><td align="right" style="white-space: nowrap" valign="top">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<font size=2><b>'.$dado['pratica_marcador_letra'].'</b></font></td><td class="realce" width="100%">'.dica('Informações Extras', $dado['pratica_marcador_extra']).'<font size=2>'.$dado['pratica_marcador_texto'].'</font>'.dicaF().'</td></tr>';
		}
	echo '</table></td></tr>';
	}
...
if ($marcadores && count($marcadores)) {
	...
	echo '<tr><td colspan=20><table width=100%>';
	echo '<tr><td align="left" colspan=2 style="white-space: nowrap"><p><font size=2><b>'.ucfirst($config['marcadores']).' Atendid'.$config['genero_marcador'].'s pel'.$config['genero_pratica'].'s '.$config['praticas'].' que utilizam o indicador<b></font></p></td></tr>';
	foreach($marcadores as $dado){
		if ($dado['pratica_criterio_id']!=$criterio_atual){
			$criterio_atual=$dado['pratica_criterio_id'];
			$dentro = '<table cellspacing="4" cellpadding="2" border=0 width="100%">';
		...
		echo '<tr><td align="right" style="white-space: nowrap" valign="top">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<font size=2><b>'.$dado['pratica_marcador_letra'].'</font></b></td><td class="realce" width="100%">'.dica('Informações Extras', $dado['pratica_marcador_extra']).'<font size=2>'.$dado['pratica_marcador_texto'].'</font></td></tr>';
		}
	echo '</table></td></tr>';	
	}

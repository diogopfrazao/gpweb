...
foreach($marcadores as $dado){
	if ($dado['pratica_criterio_id']!=$criterio_atual){
		...
		echo '<tr><td align="left" style="white-space: nowrap;font-weight:bold;">'.dica('Dados Sobre o Critério', $dentro).$criterios[$dado['pratica_criterio_id']]['pratica_criterio_numero'].'.'.$criterios[$dado['pratica_criterio_id']]['pratica_criterio_nome'].dicaF().'</td><td align="center" style="font-weight:bold;">'.$valor.'</td><td colspan=20>&nbsp;</td></tr>';
		}
	...
	if ($dado['pratica_item_id']!=$item_atual){
		...
		echo '<tr><td align="left" style="white-space: nowrap">'.(!$itens[$dado['pratica_item_id']]['pratica_item_oculto'] ? dica('Dados Sobre o Ítem', $dentro).$criterios[$dado['pratica_criterio_id']]['pratica_criterio_numero'].'.'.$itens[$dado['pratica_item_id']]['pratica_item_numero'].'.'.$itens[$dado['pratica_item_id']]['pratica_item_nome'].dicaF() : '').'</td>';
...
echo '<tr><td align="center" style="white-space: nowrap">'.dica('Pontuação dos Processos Gerenciais', 'Total de pontos auferidos nos processos gerenciais').'<h1>Total</h1></td><td colspan=20 align="center" ><h1>'.$pontuacao_geral.' Pontos</h1></td></tr>';
...
foreach($marcadores as $dado){
	if ($dado['pratica_criterio_id']!=$criterio_atual){
		...
		echo '<tr><td align="left" style="white-space: nowrap;font-weight:bold;">'.dica('Dados Sobre o Critério', $dentro).$criterios[$dado['pratica_criterio_id']]['pratica_criterio_numero'].'.'.$criterios[$dado['pratica_criterio_id']]['pratica_criterio_nome'].dicaF().'</td><td align="center" style="font-weight:bold;">'.$valor.'<td colspan=20>&nbsp;</td></tr>';
		}
	if ($dado['pratica_item_id']!=$item_atual){
		...
		echo '<tr><td align="left" style="white-space: nowrap">'.(!$itens[$dado['pratica_item_id']]['pratica_item_oculto'] ? dica('Dados Sobre o Ítem', $dentro).$criterios[$dado['pratica_criterio_id']]['pratica_criterio_numero'].'.'.$itens[$dado['pratica_item_id']]['pratica_item_numero'].'.'.$itens[$dado['pratica_item_id']]['pratica_item_nome'].dicaF() : '').'</td>'.imprimir_item2($item_atual, $itens[$item_atual]['pratica_item_pontos'], !$itens[$dado['pratica_item_id']]['pratica_item_oculto']).'</tr>';
		
		}
	}
$total_geral+=$pontuacao_geral;
echo '<tr><td align="center" style="white-space: nowrap">'.dica('Pontuação dos Resultados', 'Total de pontos auferidos nos resultados gerenciais').'<h1>Total</h1></td><td colspan=20 align="center" ><h1>'.$pontuacao_geral.' Pontos</h1></td></tr>';
...
$sql->limpar();
echo '<tr><td align="center" style="white-space: nowrap">'.dica('Pontuação dos Resultados', 'Total de pontos auferidos nos resultados gerenciais').'<h1>Total Final</h1></td><td colspan=20 align="center" >'.($maturidade ? dica('Nível de Maturidade',$maturidade):'').'<h1>'.$total_geral.' Pontos</h1>'.($maturidade ? dicaF():'').'</td></tr>';
echo '</table>';

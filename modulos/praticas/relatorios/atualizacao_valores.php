...
echo '<tr><th width=16><a class="hdr" href="javascript:void(0);" onclick="url_passar(0, \'m='.$m.'&a='.$a.'&u='.$u.'&relatorio_tipo=atualizacao_valores&ordenar=pratica_indicador_cor&ordem='.($ordem ? '0' : '1').'\');">'.($ordenar=='pratica_indicador_cor' ? imagem('icones/'.$seta[$ordem]) : '').dica('Cor do Indicador', 'Neste campo fica a cor de identificação do indicador.').'Cor'.dicaF().'</th><th style="white-space: nowrap"><a class="hdr" href="javascript:void(0);" onclick="url_passar(0, \'m='.$m.'&a='.$a.'&u='.$u.'&relatorio_tipo=atualizacao_valores&ordenar=pratica_indicador_nome&ordem='.($ordem ? '0' : '1').'\');">'.($ordenar=='pratica_indicador_nome' ? imagem('icones/'.$seta[$ordem]) : '').dica('Indicador','Nome do indicador').'Indicador'.dicaF().'</th><th style="white-space: nowrap"><a class="hdr" href="javascript:void(0);" onclick="url_passar(0, \'m='.$m.'&a='.$a.'&u='.$u.'&relatorio_tipo=atualizacao_valores&ordenar=pratica_indicador_responsavel&ordem='.($ordem ? '0' : '1').'\');">'.($ordenar=='pratica_indicador_responsavel' ? imagem('icones/'.$seta[$ordem]) : '').dica('Responsável','Nome do responsável pelo indicador').'Responsável'.dicaF().'</th><th style="white-space: nowrap"><a class="hdr" href="javascript:void(0);" onclick="url_passar(0, \'m='.$m.'&a='.$a.'&u='.$u.'&relatorio_tipo=atualizacao_valores&ordenar=ultimo&ordem='.($ordem ? '0' : '1').'\');">'.($ordenar=='ultimo' ? imagem('icones/'.$seta[$ordem]) : '').dica('Data','Última data em que o indicador foi atualizado.').'Data'.dicaF().'</th><th style="white-space: nowrap"><a class="hdr" href="javascript:void(0);" onclick="url_passar(0, \'m='.$m.'&a='.$a.'&u='.$u.'&relatorio_tipo=atualizacao_valores&ordenar=pratica_indicador_agrupar&ordem='.($ordem ? '0' : '1').'\');">'.($ordenar=='pratica_indicador_agrupar' ? imagem('icones/'.$seta[$ordem]) : '').dica('Periodicidade','Periodicidade em que o indicador é observado.').'Período'.dicaF().'</th><th style="white-space: nowrap"><a class="hdr"href="javascript:void(0);" onclick="url_passar(0, \'m='.$m.'&a='.$a.'&u='.$u.'&relatorio_tipo=atualizacao_valores&ordenar=pratica_indicador_valor_responsavel&ordem='.($ordem ? '0' : '1').'\');">'.($ordenar=='pratica_indicador_valor_responsavel' ? imagem('icones/'.$seta[$ordem]) : '').dica('Atualizador','Nome d'.$config['genero_usuario'].' '.$config['usuario'].' que atualizou por último o indicador').'Atualizador'.dicaF().'</th></tr>';

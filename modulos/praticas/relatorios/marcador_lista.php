...
if ($resultado){
	...
	echo '<td valign="top" align="center" width="75%"><table><tr><td style="border-style:solid;border-width:1px; background-color: #fdc5c5;">&nbsp;&nbsp;</td><td style="white-space: nowrap">Não atende '.strtolower($marcador).'</td></tr></table></td>';	
	echo '</table>';	

...
foreach($praticas as $pratica_id) {
	...
	if (permiteAcessarPratica($pratica['pratica_acesso'],$pratica_id)){ 
		...
		if ($pratica['pratica_oque']) echo '<tr><td align="right" valign="top" style="white-space: nowrap">'.dica('O Que Fazer', 'Sumário sobre o que se trata '.($config['genero_pratica']=='a' ? 'esta ': 'este ').$config['pratica'].'.').'O Que:'.dicaF().'</td><td  width="100%" style="margin-bottom:0cm; margin-top:0cm;">'.$pratica['pratica_oque'].'</td></tr>';
		if ($pratica['pratica_porque']) echo '<tr><td align="right" valign="top" style="white-space: nowrap">'.dica('Por Que Fazer', 'Por que '.$config['genero_pratica'].' '.$config['pratica'].' será executad'.$config['genero_pratica'].'.').'Por que:'.dicaF().'</td><td  width="100%" style="margin-bottom:0cm; margin-top:0cm;">'.$pratica['pratica_porque'].'</td></tr>';
		if ($pratica['pratica_onde']) echo '<tr><td align="right" valign="top" style="white-space: nowrap">'.dica('Onde Fazer', 'Onde '.$config['genero_pratica'].' '.$config['pratica'].' é executad'.$config['genero_pratica'].'.').'Onde:'.dicaF().'</td><td  width="100%" style="margin-bottom:0cm; margin-top:0cm;">'.$pratica['pratica_onde'].'</td></tr>';
		if ($pratica['pratica_quando']) echo '<tr><td align="right" valign="top" style="white-space: nowrap">'.dica('Quando Fazer', 'Quando '.$config['genero_pratica'].' '.$config['pratica'].' é executad'.$config['genero_pratica'].'.').'Quando:'.dicaF().'</td><td  width="100%" style="margin-bottom:0cm; margin-top:0cm;">'.$pratica['pratica_quando'].'</td></tr>';
		$saida_quem='';
		...
		if ($saida_depts) echo '<tr><td align="right" valign="top" style="white-space: nowrap">'.dica(ucfirst($config['departamentos']), 'Qual '.strtolower($config['departamento']).' está relacionad'.$config['genero_dept'].' à '.($config['genero_pratica']=='a' ? 'esta ': 'este ').$config['pratica'].'.').ucfirst($config['departamento']).':'.dicaF().'</td><td width="100%" colspan="2" >'.$saida_depts.'</td></tr>';
		if ($pratica['pratica_como']) echo '<tr><td align="right" valign="top" style="white-space: nowrap">'.dica('Como Fazer', 'Como '.$config['genero_pratica'].' '.$config['pratica'].' é executad'.$config['genero_pratica'].'.').'Como:'.dicaF().'</td><td  width="100%" style="margin-bottom:0cm; margin-top:0cm;">'.$pratica['pratica_como'].'</td></tr>';
		if ($pratica['pratica_quanto']) echo '<tr><td align="right" valign="top" style="white-space: nowrap">'.dica('Quanto Custa', 'Custo para executar '.$config['genero_pratica'].' '.$config['pratica'].'.').'Quanto:'.dicaF().'</td><td  width="100%" style="margin-bottom:0cm; margin-top:0cm;">'.$pratica['pratica_quanto'].'</td></tr>';
		...
		if ($marcadores && count($marcadores)) echo '<tr><td align="left" colspan=2 style="white-space: nowrap"><p><b>'.ucfirst($config['marcadores']).' Atendid'.$config['genero_marcador'].'s pel'.$config['genero_pratica'].' '.$config['pratica'].'<b></p></td></tr>';
		else echo '<tr><td align="left" colspan=2 style="white-space: nowrap"><p><b>Nenhum '.$config['marcador'].' encontrad'.$config['genero_marcador'].'<b></p></td></tr>';
		foreach($marcadores as $dado){
			if ($dado['pratica_criterio_id']!=$criterio_atual){
				...
				$dentro .= '</table>';
				echo '<tr><td align="left" colspan=2 style="white-space: nowrap">'.dica('Dados Sobre o Critério', $dentro).$criterios[$dado['pratica_criterio_id']]['pratica_criterio_numero'].'.'.$criterios[$dado['pratica_criterio_id']]['pratica_criterio_nome'].dicaF().'</td></tr>';
				}
			if ($dado['pratica_item_id']!=$marcador_atual){
				...
				$dentro .= '</table>';
				echo '<tr><td align="left" colspan=2 style="white-space: nowrap">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;'.dica('Dados Sobre o Critério', $dentro).$criterios[$dado['pratica_criterio_id']]['pratica_criterio_numero'].'.'.$itens[$dado['pratica_item_id']]['pratica_item_numero'].'.'.$itens[$dado['pratica_item_id']]['pratica_item_nome'].dicaF().'</td></tr>';
				}
			echo '<tr><td align="right" style="white-space: nowrap" valign="top">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<b>'.$dado['pratica_marcador_letra'].'</b></td><td  width="100%">'.dica('Informações Extras', $dado['pratica_marcador_extra']).$dado['pratica_marcador_texto'].'</td></tr>';
			}															

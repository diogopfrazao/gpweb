...
foreach($marcadores as $dado){
	...
	echo '<tr><td align="right" style="white-space: nowrap" valign="top">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<b>'.$dado['pratica_marcador_letra'].'</b></td><td class="realce" width="100%">'.($dado['pratica_marcador_extra'] ? dica('Informações Extras', $dado['pratica_marcador_extra']) : '').$dado['pratica_marcador_texto'].($dado['pratica_marcador_extra'] ? dicaF() : '').'</td></tr>';
	}
echo '</table>';

...
if($pratica_id && !(permiteEditarPratica($pratica['pratica_acesso'],$pratica_id) && $Aplic->checarModulo('praticas', 'editar', $Aplic->usuario_id, 'melhor_pratica'))) $Aplic->redirecionar('m=publico&a=acesso_negado');
elseif (!$pratica_id && !$Aplic->checarModulo('praticas', 'adicionar', $Aplic->usuario_id, 'melhor_pratica'))$Aplic->redirecionar('m=publico&a=acesso_negado');

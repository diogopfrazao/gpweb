...
if (isset($_REQUEST['pg_estrategia_id'])) $Aplic->setEstado('pg_estrategia_id', getParam($_REQUEST, 'pg_estrategia_id', null), $m, $a, $u);
$pg_estrategia_id = $Aplic->getEstado('pg_estrategia_id', null, $m, $a, $u);
...
if(!(permiteAcessarEstrategia($obj->pg_estrategia_acesso,$pg_estrategia_id) && $Aplic->checarModulo('praticas', 'acesso', $Aplic->usuario_id, 'iniciativa'))) $Aplic->redirecionar('m=publico&a=acesso_negado');

$podeEditar=$Aplic->checarModulo('praticas', 'editar', $Aplic->usuario_id, 'iniciativa');
$podeAdicionar=$Aplic->checarModulo('praticas', 'adicionar', $Aplic->usuario_id, 'iniciativa');
$podeExcluir=$Aplic->checarModulo('praticas', 'excluir', $Aplic->usuario_id, 'iniciativa');


$editar=permiteEditarEstrategia($obj->pg_estrategia_acesso,$pg_estrategia_id);

$podeEditarTudo=($obj->pg_estrategia_acesso>=5 ? $editar && (in_array($obj->pg_estrategia_usuario, $Aplic->usuario_lista_grupo_vetor) || $Aplic->usuario_super_admin || $Aplic->usuario_admin) : $editar);
...
if (!$dialogo){	
	...
	if ($podeAdicionar)	$km->Add("inserir","inserir_objeto",dica('Nov'.$config['genero_iniciativa'].' '.ucfirst($config['iniciativa']), 'Criar um nov'.$config['genero_iniciativa'].' '.$config['iniciativa'].'.').'Nov'.$config['genero_iniciativa'].' '.ucfirst($config['iniciativa']).dicaF(), "javascript: void(0);' onclick='url_passar(0, \"m=praticas&a=estrategia_editar\");");
	if ($podeEditar && $editar) {
		$km->Add("inserir","inserir_registro",dica('Registro de Ocorrência','Inserir um novo registro de ocorrência.').'Registro de ocorrência'.dicaF(), "javascript: void(0);' onclick='url_passar(0, \"m=praticas&a=log_editar&pg_estrategia_id=".$pg_estrategia_id."\");");
		if ($Aplic->modulo_ativo('calendario') && $Aplic->checarModulo('eventos', 'adicionar')) $km->Add("inserir","inserir_evento",dica('Novo Evento', 'Criar um novo evento relacionado.').'Evento'.dicaF(), "javascript: void(0);' onclick='url_passar(0, \"m=calendario&a=editar&evento_estrategia=".$pg_estrategia_id."\");");
		...
		if ($Aplic->modulo_ativo('links') && $Aplic->checarModulo('links', 'adicionar')) $km->Add("diverso","inserir_link",dica('Novo Link', 'Inserir um novo link relacionado.').'Link'.dicaF(), "javascript: void(0);' onclick='url_passar(0, \"m=links&a=editar&link_estrategia=".$pg_estrategia_id."\");");
		if ($Aplic->modulo_ativo('foruns') && $Aplic->checarModulo('foruns', 'adicionar')) $km->Add("diverso","inserir_forum",dica('Novo Fórum', 'Inserir um novo fórum relacionado.').'Fórum'.dicaF(), "javascript: void(0);' onclick='url_passar(0, \"m=foruns&a=editar&forum_estrategia=".$pg_estrategia_id."\");");
	...
	if ($podeEditarTudo && $podeEditar && !$bloquear) $km->Add("acao","acao_editar",dica('Editar '.ucfirst($config['iniciativa']),'Editar os detalhes d'.($config['genero_iniciativa']=='a' ? 'esta' : 'este').' '.$config['iniciativa'].'.').'Editar '.ucfirst($config['iniciativa']).dicaF(), "javascript: void(0);' onclick='url_passar(0, \"m=praticas&a=estrategia_editar&pg_estrategia_id=".$pg_estrategia_id."\");");
	if ($podeEditarTudo && $podeExcluir && !$bloquear) $km->Add("acao","acao_excluir",dica('Excluir','Excluir '.($config['genero_iniciativa']=='a' ? 'esta' : 'este').' '.$config['iniciativa'].'.').'Excluir '.ucfirst($config['iniciativa']).dicaF(), "javascript: void(0);' onclick='excluir()");
	...
	if ($Aplic->profissional) $km->Add("acao_imprimir","dashboard_geral",dica('Grau de Consecução','Dashboard do grau de consecução d'.($config['genero_iniciativa']=='a' ? 'esta' : 'este').' '.$config['iniciativa'].'.').'Grau de Consecução'.dicaF(), "javascript: void(0);' onclick='url_passar(\"dashboard_geral_".$pg_estrategia_id."\", \"m=praticas&a=estrategia_deshboard_geral_pro&jquery=1&dialogo=1&pg_estrategia_id=".$pg_estrategia_id."\");");
...
echo '<tr><td style="border: outset #d1d1cd 1px;background-color:#'.$obj->pg_estrategia_cor.'" colspan="2"><font color="'.melhorCor($obj->pg_estrategia_cor).'"><b>'.$obj->pg_estrategia_nome.'</b></font>'.$cor_indicador.'</td></tr>';
...
if ($obj->pg_estrategia_cia) echo '<tr><td align="right" style="white-space: nowrap">'.dica(ucfirst($config['organizacao']).' Responsável', ucfirst($config['genero_organizacao']).' '.$config['organizacao'].' responsável.').ucfirst($config['organizacao']).' responsável:'.dicaF().'</td><td class="realce" width="100%">'.link_cia($obj->pg_estrategia_cia).'</td></tr>';
if ($Aplic->profissional){
...
if ($obj->pg_estrategia_dept) echo '<tr><td align="right" style="white-space: nowrap">'.dica(ucfirst($config['departamento']).' Responsável', ucfirst($config['genero_dept']).' '.$config['departamento'].' responsável por '.($config['genero_iniciativa']=='a' ? 'esta' : 'este').' '.$config['iniciativa'].'.').ucfirst($config['departamento']).' responsável:'.dicaF().'</td><td class="realce" width="100%">'.link_dept($obj->pg_estrategia_dept).'</td></tr>';
$saida_depts='';
...
if ($saida_depts) echo '<tr><td align="right" valign="top" style="white-space: nowrap">'.dica(ucfirst($config['departamentos']), 'Qual '.strtolower($config['departamento']).' está envolvid'.$config['genero_dept'].' com '.$config['genero_iniciativa'].' '.$config['iniciativa'].'.').ucfirst($config['departamentos']).' envolvid'.$config['genero_dept'].'s:'.dicaF().'</td><td width="100%" colspan="2" class="realce">'.$saida_depts.'</td></tr>';
if ($obj->pg_estrategia_usuario) echo '<tr><td align="right" valign="top" style="white-space: nowrap">'.dica('Responsável pel'.$config['genero_objetivo'].' '.ucfirst($config['objetivo']).'', ucfirst($config['usuario']).' responsável por gerenciar '.($config['genero_iniciativa']=='a' ? 'esta' : 'este').' '.$config['iniciativa'].'.').'Responsável:'.dicaF().'</td><td class="realce" width="100%">'.link_usuario($obj->pg_estrategia_usuario, '','','esquerda').'</td></tr>';		
$saida_quem='';
...
if ($Aplic->profissional){
	...
	echo '<tr><td align="right" style="white-space: nowrap">'.dica('Sistema de Percentagem', 'Qual forma a percentagem d'.$config['genero_iniciativa'].' '.$config['iniciativa'].' é calculada.').'Sistema de percentagem:'.dicaF().'</td><td class="realce">'.(isset($tipo_pontuacao[$obj->pg_estrategia_tipo_pontuacao]) ? $tipo_pontuacao[$obj->pg_estrategia_tipo_pontuacao] : '').'</td></tr>';
	...
	if ($obj->pg_estrategia_tipo_pontuacao && $obj->pg_estrategia_tipo_pontuacao!='indicador'){
		...
		if (is_array($medias) && count($medias)){
			...
			foreach ($medias as $contato_id => $media) {
				...
				if ($media['estrategia_media_projeto']) echo '<td align="left">'.imagem('icones/projeto_p.gif').link_projeto($media['estrategia_media_projeto']).'</td>';
				elseif ($media['estrategia_media_acao']) echo '<td align="left">'.imagem('icones/plano_acao_p.gif').link_acao($media['estrategia_media_acao']).'</td>';
	...
	echo '<tr><td align="right" style="white-space: nowrap">'.dica('Progresso', 'O progresso pode ir de 0% (não iniciado) até 100% (completado).').'Progresso:'.dicaF().'</td><td class="realce">'.number_format((float)$obj->pg_estrategia_percentagem, 2, ',', '.').'%</td></tr>';
	
	if($obj->pg_estrategia_tipo_pontuacao){
		...
		$velocidade_fisico=($fisico_previsto >0 ? $obj->pg_estrategia_percentagem/$fisico_previsto : 0);
...
else echo '<tr><td align="right" style="white-space: nowrap">'.dica('Progresso', 'O progresso pode ir de 0% (não iniciado) até 100% (completado).').'Progresso:'.dicaF().'</td><td class="realce" width="300">'.number_format($obj->pg_estrategia_percentagem, 2, ',', '.').'%</td></tr>';

if ($obj->pg_estrategia_descricao) echo '<tr><td align="right" style="white-space: nowrap">'.dica('Descrição', 'Descrição d'.$config['genero_iniciativa'].' '.$config['iniciativa'].'.').'Descrição:'.dicaF().'</td><td class="realce" width="100%">'.$obj->pg_estrategia_descricao.'</td></tr>';
...
if (count($lista)) {
	echo '<tr><td align="right" style="white-space: nowrap" valign="middle">'.dica('Relacionad'.$config['genero_iniciativa'], 'A que área '.$config['genero_iniciativa'].' '.$config['iniciativa'].' está relacionad'.$config['genero_iniciativa'].'.').'Relacionad'.$config['genero_iniciativa'].':'.dicaF().'</td></td><td class="realce">';	
...
if ($obj->pg_estrategia_inicio) echo '<tr><td align="right" style="white-space: nowrap">'.dica('Data de Início', 'Data de início d'.$config['genero_iniciativa'].' '.$config['iniciativa'].'.').'Data de início:'.dicaF().'</td><td class="realce" width="300">'.retorna_data($obj->pg_estrategia_inicio, false).'</td></tr>';
if ($obj->pg_estrategia_fim) echo '<tr><td align="right" style="white-space: nowrap">'.dica('Data de término', 'Data estimada de término d'.$config['genero_iniciativa'].' '.$config['iniciativa'].'.').'Data de término:'.dicaF().'</td><td class="realce" width="300">'.retorna_data($obj->pg_estrategia_fim, false).'</td></tr>';
if ($obj->pg_estrategia_principal_indicador) echo '<tr><td align="right" style="white-space: nowrap">'.dica('Indicador Principal', 'Dentre os indicadores d'.$config['genero_iniciativa'].' '.$config['iniciativa'].' mais representativo da situação geral do mesmo.').'Indicador principal:'.dicaF().'</td><td width="100%" class="realce">'.link_indicador($obj->pg_estrategia_principal_indicador).'</td></tr>';
if ($obj->pg_estrategia_ano) echo '<tr><td align="right" style="white-space: nowrap">'.dica('Ano', 'O ano  base d'.$config['genero_iniciativa'].' '.$config['iniciativa'].'.').'Ano:'.dicaF().'</td><td class="realce" style="text-align: justify;">'.$obj->pg_estrategia_ano.'</td></tr>';
if ($obj->pg_estrategia_codigo) echo '<tr><td align="right" style="white-space: nowrap">'.dica('Código', 'O  código d'.$config['genero_iniciativa'].' '.$config['iniciativa'].'.').'Código:'.dicaF().'</td><td class="realce" style="text-align: justify;">'.$obj->pg_estrategia_codigo.'</td></tr>';
if ($obj->pg_estrategia_oque) echo '<tr><td align="right" valign="top" style="white-space: nowrap">'.dica('O Que Fazer', 'Sumário sobre o que se trata '.$config['genero_iniciativa'].' '.$config['iniciativa'].'.').'O Que:'.dicaF().'</td><td class="realce" width="100%" style="margin-bottom:0cm; margin-top:0cm;">'.$obj->pg_estrategia_oque.'</td></tr>';
if ($obj->pg_estrategia_porque) echo '<tr><td align="right" valign="top" style="white-space: nowrap">'.dica('Por Que Fazer', 'Por que '.$config['genero_iniciativa'].' '.$config['iniciativa'].' será executada.').'Por que:'.dicaF().'</td><td class="realce" width="100%" style="margin-bottom:0cm; margin-top:0cm;">'.$obj->pg_estrategia_porque.'</td></tr>';
if ($obj->pg_estrategia_onde) echo '<tr><td align="right" valign="top" style="white-space: nowrap">'.dica('Onde Fazer', 'Onde '.$config['genero_iniciativa'].' '.$config['iniciativa'].' é executada.').'Onde:'.dicaF().'</td><td class="realce" width="100%" style="margin-bottom:0cm; margin-top:0cm;">'.$obj->pg_estrategia_onde.'</td></tr>';
if ($obj->pg_estrategia_quando) echo '<tr><td align="right" valign="top" style="white-space: nowrap">'.dica('Quando Fazer', 'Quando '.$config['genero_iniciativa'].' '.$config['iniciativa'].' é executada.').'Quando:'.dicaF().'</td><td class="realce" width="100%" style="margin-bottom:0cm; margin-top:0cm;">'.$obj->pg_estrategia_quando.'</td></tr>';
if ($obj->pg_estrategia_quem) echo '<tr><td align="right" valign="top" style="white-space: nowrap">'.dica('Quem', 'Quais '.$config['usuarios'].' estarão executando '.$config['genero_iniciativa'].' '.$config['iniciativa'].'.').'Quem:'.dicaF().'</td><td class="realce" width="100%" style="margin-bottom:0cm; margin-top:0cm;">'.$obj->pg_estrategia_quem.'</td></tr>';
if ($obj->pg_estrategia_como) echo '<tr><td align="right" valign="top" style="white-space: nowrap">'.dica('Como Fazer', 'Como '.$config['genero_iniciativa'].' '.$config['iniciativa'].' é executad'.$config['genero_iniciativa'].'.').'Como:'.dicaF().'</td><td class="realce" width="100%" style="margin-bottom:0cm; margin-top:0cm;">'.$obj->pg_estrategia_como.'</td></tr>';
if ($obj->pg_estrategia_quanto) echo '<tr><td align="right" valign="top" style="white-space: nowrap">'.dica('Quanto Custa', 'Custo para executar '.$config['genero_iniciativa'].' '.$config['iniciativa'].'.').'Quanto:'.dicaF().'</td><td class="realce" width="100%" style="margin-bottom:0cm; margin-top:0cm;">'.$obj->pg_estrategia_quanto.'</td></tr>';


if ($obj->pg_estrategia_desde_quando) echo '<tr><td align="right" valign="top" style="white-space: nowrap">'.dica('Desde Quando é Feita', 'Desde quando '.$config['genero_iniciativa'].' '.$config['iniciativa'].' é executad'.$config['genero_iniciativa'].'.').'Desde quando:'.dicaF().'</td><td class="realce" width="100%" style="margin-bottom:0cm; margin-top:0cm;">'.$obj->pg_estrategia_desde_quando.'</td></tr>';
if ($obj->pg_estrategia_controle) echo '<tr><td align="right" valign="top" style="white-space: nowrap">'.dica('Método de Controle', 'Como '.$config['genero_iniciativa'].' '.$config['iniciativa'].' é controlad'.$config['genero_iniciativa'].'.').'Controle:'.dicaF().'</td><td class="realce" width="100%" style="margin-bottom:0cm; margin-top:0cm;">'.$obj->pg_estrategia_controle.'</td></tr>';
if ($obj->pg_estrategia_metodo_aprendizado) echo '<tr><td align="right" valign="top" style="white-space: nowrap">'.dica('Método de Aprendizado', 'Como é realizado o aprendizado d'.$config['genero_iniciativa'].' '.$config['iniciativa'].'.').'Aprendizado:'.dicaF().'</td><td class="realce" width="100%" style="margin-bottom:0cm; margin-top:0cm;">'.$obj->pg_estrategia_metodo_aprendizado.'</td></tr>';
if ($obj->pg_estrategia_melhorias) echo '<tr><td align="right" valign="top" style="white-space: nowrap">'.dica('Melhorias Efetuadas n'.$config['genero_iniciativa'].' '.ucfirst($config['iniciativa']).'', 'Quais as melhorias realizadas n'.$config['genero_iniciativa'].' '.$config['iniciativa'].' após girar o círculo PDCA.').'Melhorias:'.dicaF().'</td><td class="realce" width="100%" style="margin-bottom:0cm; margin-top:0cm;">'.$obj->pg_estrategia_melhorias.'</td></tr>';


echo '<tr><td align="right" style="white-space: nowrap">'.dica('Ativ'.$config['genero_iniciativa'], ucfirst($config['genero_iniciativa']).' '.$config['iniciativa'].' se encontra ativ'.$config['genero_iniciativa'].'.').'Ativ'.$config['genero_iniciativa'].':'.dicaF().'</td><td class="realce" style="text-align: justify;">'.($obj->pg_estrategia_ativo ? 'Sim' : 'Não').'</td></tr>';
...
if ($saida_meta) echo '<tr><td align="right" style="white-space: nowrap">'.dica(ucfirst($config['meta']), 'Qual '.$config['meta'].' está relacionada'.$config['genero_meta'].'  com '.$config['genero_iniciativa'].' '.$config['iniciativa'].'.').ucfirst($config['meta']).':'.dicaF().'</td><td width="100%" colspan="2" class="realce">'.$saida_meta.'</td></tr>';
...
if ($Aplic->profissional) {
	...
	$sql->limpar();
	if (isset($moedas[$obj->pg_estrategia_moeda])) echo '<tr><td align="right" style="white-space: nowrap">'.dica('Moeda', 'A moeda padrão utilizada.').'Moeda:'.dicaF().'</td><td class="realce" width="100%">'.$moedas[$obj->pg_estrategia_moeda].'</td></tr>';	
	}
if ($Aplic->profissional && $tem_aprovacao) echo '<tr><td align="right" style="white-space: nowrap">'.dica('Aprovado', 'Se '.$config['genero_iniciativa'].' '.$config['iniciativa'].' se encontra aprovad'.$config['genero_iniciativa'].'.').'Aprovad'.$config['genero_iniciativa'].':'.dicaF().'</td><td  class="realce" width="100%">'.($obj->pg_estrategia_aprovado ? 'Sim' : '<span style="color:red; font-weight:bold">Não</span>').'</td></tr>';
...
if (!$dialogo) {
	...
	if ($Aplic->checarModulo('praticas', 'acesso', null, 'plano_acao_item')) {
		...
		$sql->adOnde('plano_acao_item_gestao_estrategia = '.(int)$pg_estrategia_id);
	...
	if ($Aplic->checarModulo('projetos', 'acesso', null, 'demanda')) {
		...
		$sql->adOnde('demanda_gestao_estrategia = '.(int)$pg_estrategia_id);
	...
	if ($Aplic->profissional && $Aplic->modulo_ativo('praticas') && $Aplic->checarModulo('praticas', 'acesso', null, 'risco_resposta')) {		
		...
		$sql->adOnde('risco_resposta_gestao_estrategia = '.(int)$pg_estrategia_id);
	...
	if ($Aplic->checarModulo('recursos', 'acesso', null, null)) {
		...
		$sql->adOnde('recurso_gestao_estrategia = '.(int)$pg_estrategia_id);
	...
	if ($Aplic->modulo_ativo('patrocinadores') && $Aplic->checarModulo('patrocinadores', 'acesso', null, null)) {
		...
		$sql->adOnde('patrocinador_gestao_estrategia = '.(int)$pg_estrategia_id);
	...
	if ($Aplic->profissional && $Aplic->checarModulo('projetos', 'acesso', null, 'programa')) {
		...
		$sql->adOnde('programa_gestao_estrategia = '.(int)$pg_estrategia_id);
	...
	if ($Aplic->profissional && $Aplic->checarModulo('projetos', 'acesso', null, 'beneficio')) {
		...
		$sql->adOnde('beneficio_gestao_estrategia = '.(int)$pg_estrategia_id);
	...
	if ($Aplic->checarModulo('projeto', 'acesso', 'licao')) {
		...
		$sql->adOnde('licao_gestao_estrategia = '.(int)$pg_estrategia_id);
	...
	if ($Aplic->checarModulo('praticas', 'acesso', null, 'pratica')) {
		...
		$sql->adOnde('pratica_gestao_estrategia = '.(int)$pg_estrategia_id);
	...
	if ($Aplic->profissional && $Aplic->modulo_ativo('tr') && $Aplic->checarModulo('tr', 'acesso', null, null)) {
		...
		$sql->adOnde('tr_gestao_estrategia = '.(int)$pg_estrategia_id);
	...
	if ($Aplic->profissional && $Aplic->checarModulo('praticas', 'acesso', null, 'tgn')) {
		...
		$sql->adOnde('tgn_gestao_estrategia = '.(int)$pg_estrategia_id);
	...
	if ($Aplic->profissional && $Aplic->checarModulo('praticas', 'acesso', null, 'canvas')) {
		...
		$sql->adOnde('canvas_gestao_estrategia = '.(int)$pg_estrategia_id);
	...
	if ($Aplic->profissional && $Aplic->modulo_ativo('swot') && $Aplic->checarModulo('swot', 'acesso', null, null)) {
		...
		$sql->adOnde('mswot_gestao_estrategia = '.(int)$pg_estrategia_id);
	...
	if ($Aplic->profissional && $Aplic->modulo_ativo('swot') && $Aplic->checarModulo('swot', 'acesso', null, null)) {
		...
		$sql->adOnde('swot_gestao_estrategia = '.(int)$pg_estrategia_id);
	...
	if ($Aplic->profissional && $Aplic->modulo_ativo('operativo') && $Aplic->checarModulo('operativo', 'acesso', null, null)) {
		...
		$sql->adOnde('operativo_gestao_estrategia = '.(int)$pg_estrategia_id);
	...
	if ($Aplic->profissional && $Aplic->checarModulo('praticas', 'acesso', null, 'monitoramento')) {
		...
		$sql->adOnde('monitoramento_gestao_estrategia = '.(int)$pg_estrategia_id);
	...
	if ($Aplic->checarModulo('praticas', 'acesso', null, 'avaliacao_indicador')) {
		...
		$sql->adOnde('avaliacao_gestao_estrategia = '.(int)$pg_estrategia_id);
	...
	if ($Aplic->checarModulo('praticas', 'acesso', null, 'checklist')) {
		...
		$sql->adOnde('checklist_gestao_estrategia = '.(int)$pg_estrategia_id);
	...
	if ($Aplic->profissional) {
		...
		$sql->adOnde('agenda_gestao_estrategia = '.(int)$pg_estrategia_id);
	...
	if ($Aplic->profissional && $Aplic->modulo_ativo('agrupamento') && $Aplic->checarModulo('agrupamento', 'acesso', null, null)) {
		...
		$sql->adOnde('agrupamento_gestao_estrategia = '.(int)$pg_estrategia_id);
	...
	if ($Aplic->profissional && $Aplic->checarModulo('projetos', 'acesso', null, 'modelo')) {
		...
		$sql->adOnde('template_gestao_estrategia = '.(int)$pg_estrategia_id);
	...
	if ($Aplic->profissional && $Aplic->checarModulo('praticas', 'acesso', null, 'painel_indicador')) {
		...
		$sql->adOnde('painel_gestao_estrategia = '.(int)$pg_estrategia_id);
	...
	if ($Aplic->profissional && $Aplic->checarModulo('praticas', 'acesso', null, 'odometro_indicador')) {
		...
		$sql->adOnde('painel_odometro_gestao_estrategia = '.(int)$pg_estrategia_id);
	...
	if ($Aplic->profissional && $Aplic->checarModulo('praticas', 'acesso', null, 'composicao_painel')) {
		...
		$sql->adOnde('painel_composicao_gestao_estrategia = '.(int)$pg_estrategia_id);
	...
	if ($Aplic->profissional && $Aplic->checarModulo('praticas', 'acesso', null, 'slideshow_painel')) {
		...
		$sql->adOnde('painel_slideshow_gestao_estrategia = '.(int)$pg_estrategia_id);
	...
	if ($Aplic->profissional && $Aplic->checarModulo('agenda', 'acesso', null, null)) {
		...
		$sql->adOnde('calendario_gestao_estrategia = '.(int)$pg_estrategia_id);
	...
	if ($Aplic->checarModulo('praticas', 'acesso', null, 'perspectiva')) {
		...
		$sql->adOnde('perspectiva_gestao_estrategia = '.(int)$pg_estrategia_id);
	...
	if ($Aplic->checarModulo('praticas', 'acesso', null, 'tema')) {
		...
		$sql->adOnde('tema_gestao_estrategia = '.(int)$pg_estrategia_id);
	...
	if ($Aplic->checarModulo('praticas', 'acesso', null, 'objetivo')) {
		...
		$sql->adOnde('objetivo_gestao_estrategia = '.(int)$pg_estrategia_id);
	...
	if ($Aplic->checarModulo('praticas', 'acesso', null, 'me')) {
		...
		$sql->adOnde('me_gestao_estrategia = '.(int)$pg_estrategia_id);
	...
	if ($config['exibe_fator'] && $Aplic->checarModulo('praticas', 'acesso', null, 'fator')) {
		...
		$sql->adOnde('fator_gestao_estrategia = '.(int)$pg_estrategia_id);
	...
	if ($Aplic->checarModulo('praticas', 'acesso', null, 'meta')) {
		...
		$sql->adOnde('meta_gestao_estrategia = '.(int)$pg_estrategia_id);
	...
	if ($Aplic->checarModulo('praticas', 'acesso', null, 'planejamento')) {
		...
		$sql->adOnde('plano_gestao_gestao_estrategia = '.(int)$pg_estrategia_id);
	...
	if ($Aplic->checarModulo('projetos', 'acesso', null, 'abertura')) {
		...
		$sql->adOnde('projeto_abertura_gestao_estrategia = '.(int)$pg_estrategia_id);
	...
	if ($Aplic->checarModulo('projetos', 'acesso', null, 'viabilidade')) {
		...
		$sql->adOnde('projeto_viabilidade_gestao_estrategia = '.(int)$pg_estrategia_id);
	...
	if ($Aplic->profissional && $Aplic->modulo_ativo('ssti') && $Aplic->checarModulo('ssti', 'acesso')) {
		...
		$sql->adOnde('ssti_gestao_estrategia = '.(int)$pg_estrategia_id);
	...
	if ($Aplic->profissional && $Aplic->modulo_ativo('ssti') && $Aplic->checarModulo('ssti', 'acesso',null, 'laudo')) {
		...
		$sql->adOnde('laudo_gestao_estrategia = '.(int)$pg_estrategia_id);
	...
	if ($Aplic->profissional && $Aplic->modulo_ativo('trelo') && $Aplic->checarModulo('trelo', 'acesso')) {
		...
		$sql->adOnde('trelo_gestao_estrategia = '.(int)$pg_estrategia_id);
	...
	if ($Aplic->profissional && $Aplic->modulo_ativo('trelo') && $Aplic->checarModulo('trelo', 'acesso')) {
		...
		$sql->adOnde('trelo_cartao_gestao_estrategia = '.(int)$pg_estrategia_id);
	...
	if ($Aplic->profissional && $Aplic->modulo_ativo('pdcl') && $Aplic->checarModulo('pdcl', 'acesso')) {
		...
		$sql->adOnde('pdcl_gestao_estrategia = '.(int)$pg_estrategia_id);
	...
	if ($Aplic->profissional && $Aplic->modulo_ativo('pdcl') && $Aplic->checarModulo('pdcl', 'acesso')) {
		...
		$sql->adOnde('pdcl_item_gestao_estrategia = '.(int)$pg_estrategia_id);
	...
	if ($Aplic->profissional && $Aplic->modulo_ativo('os') && $Aplic->checarModulo('os', 'acesso')) {
		...
		$sql->adOnde('os_gestao_estrategia = '.(int)$pg_estrategia_id);

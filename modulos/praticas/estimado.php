...
if ($acao!='inserir' && $acao!='editar'){
	...
	echo '<tr><td align="right" style="white-space: nowrap">'.dica('Modalidade de Aplicação', 'Escolha a modalidade de aplicação deste item.').'Modalidade de aplicação:'.dicaF().'</td><td>'.selecionaVetor($ModalidadeAplicacao, 'plano_acao_item_custos_modalidade_aplicacao', 'class=texto size=1 style="width:395px;" onchange="plano_acao_item_custos_nd.value=\'\'; mudar_nd();"', (isset($atual['plano_acao_item_custos_modalidade_aplicacao']) ? $atual['plano_acao_item_custos_modalidade_aplicacao']:'')).'</td></tr>';
	...
	echo '<tr><td align="right" style="white-space: nowrap">'.dica('Descrição', 'Insira a descrição deste item.').'Descrição:'.dicaF().'</td><td><textarea cols="70" rows="5" class="textarea" name="plano_acao_item_custos_descricao">'.(isset($atual['plano_acao_item_custos_descricao']) ? $atual['plano_acao_item_custos_descricao']:'').'</textarea></td></tr>';
	...
	echo '<tr><td align="right">'.dica('Data','Data limite para o recebimento do ítem.').'Data:</td><td><table cellpadding=0 cellspacing=0><tr><td><td><input type="hidden" name="plano_acao_item_custos_data_limite" id="plano_acao_item_custos_data_limite" value="'.($data_texto ? $data_texto->format('%Y%m%d') : '').'" /><input type="text" name="data_texto"  id="data_texto" style="width:70px;" onchange="setData(\'env\', \'data_texto\', \'plano_acao_item_custos_data_limite\');" value="'.($data_texto ? $data_texto->format('%d/%m/%Y') : '').'" class="texto" />'.dica('Data Limite', 'Clique neste ícone '.imagem('icones/calendario.gif').'  para abrir um calendário onde poderá selecionar a data limite para o recebimento do ítem.').'<a href="javascript: void(0);" ><img id="f_btn1" src="'.acharImagem('calendario.gif').'" style="vertical-align:middle" width="18" height="12" alt="Calendário" border=0 /></a>'.dicaF().'</td></tr></table></td></tr>';

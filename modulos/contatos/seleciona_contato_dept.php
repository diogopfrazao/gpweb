...
if ($dept_id) {
	...
	if (isset($_REQUEST['sobescrever_end'])) $atualizar_campos = array('dept_endereco1' => 'contato_endereco1', 'dept_endereco2' => 'contato_endereco2', 'dept_cidade' => 'contato_cidade', 'dept_estado' => 'contato_estado', 'dept_cep' => 'contato_cep', 'dept_tel' => 'contato_tel');

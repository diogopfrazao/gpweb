...
function testar_circular($cia_original=null, $cia_superior=null){
    $achou_circular = circular($cia_original, $cia_superior);
...
function circular($cia_original, $cia_id){
    $sql = new BDConsulta;
    $sql->adTabela('cias');
    ...
    //cia raiz?
    if ($cia_superior==$cia_original){
        return 1;
        }

    if (!$cia_superior || $cia_id == $cia_superior) {
        return 0;
        }


    return circular($cia_original, $cia_superior);
    }

...
$social_log_id=getParam($_REQUEST, 'social_log_id', 0);



$obj = new CSocialLog();
if ($social_log_id) $obj->_mensagem = 'atualizada';
...
if (($msg = $obj->armazenar())) $Aplic->setMsg($msg, UI_MSG_ERRO);
	...
	$Aplic->setMsg($social_log_id ? 'atualizada' : 'adicionada', UI_MSG_OK, true);
	}
$Aplic->redirecionar('m=social&a=social_ver&tab=0&social_id='.$social_id);
?>
...
if (!$dialogo){
	...
	$filtro_status='<tr id="filtro_status" '.($relatorio_id=='problema' ? '' : 'style="display:none"').' ><td align="right" style="white-space: nowrap">'.dica('Status', 'Filtre os problemas pelo status.').'Status:'.dicaF().'</td><td align="left" style="white-space: nowrap">'. selecionaVetor($status, 'status_id', 'size="1" style="width:160px;" class="texto"', $status_id) .'</td></tr>';
	...
	$programas='<tr><td align="right" style="white-space: nowrap">'.dica('Programa Social', 'Filtre os beneficiários por programa social em que estão inseridas.').'Programa:'.dicaF().'</td><td align="left" style="white-space: nowrap">'. selecionaVetor($lista_programas, 'social_id', 'size="1" style="width:240px;" class="texto" onchange="mudar_acao()"', $social_id) .'</td></tr>';
	$acoes='<tr><td align="right" style="white-space: nowrap">'.dica('Ação Social', 'Filtre os beneficiários pela ação social.').'Ação:'.dicaF().'</td><td align="left" style="white-space: nowrap"><div id="acao_combo">'.selecionar_acao_para_ajax($social_id, 'acao_id', 'size="1" style="width:240px;" class="texto"', '', $acao_id, false).'</div></td></tr>';
	...
	$superintendencias=($lista_superintendencias ? '<tr><td align="right" style="white-space: nowrap">'.dica('Superintendência', 'Filtre os beneficiários por área de atuação da superintendência selecionada.').'Superintendência:'.dicaF().'</td><td align="left" style="white-space: nowrap">'. selecionaVetor($lista_superintendencias, 'superintendencia_id', 'size="1" style="width:160px;" class="texto" onchange="document.getElementById(\'social_comunidade_id\').length=0; document.getElementById(\'social_comunidade_id\').value=0; document.getElementById(\'municipio_id\').length=0; document.getElementById(\'estado_sigla\').value=\'\';"', $superintendencia_id) .'</td></tr>' : '');
	...
	$botoesTitulo->adicionaCelula('<td align="right" style="white-space: nowrap">'.dica('Imprimir '.ucfirst($config['beneficiario']), 'Clique neste ícone '.imagem('imprimir_p.png').' para imprimir a lista de famílias.').'<a href="javascript: void(0);" onclick ="url_passar(1, \'m=social&a='.$a.'&dialogo=1\');">'.imagem('imprimir_p.png').'</a>'.dicaF());

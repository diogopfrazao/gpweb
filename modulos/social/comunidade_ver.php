...
$social_comunidade_id = ($Aplic->getEstado('social_comunidade_id') !== null ? $Aplic->getEstado('social_comunidade_id') : null);
...
if ($editar)$botoesTitulo->adicionaCelula('<table><tr><td style="white-space: nowrap">'.dica('Nova Comunidade', 'Criar uma nova comunidade.').'<a class="botao" href="javascript: void(0)" onclick="javascript:url_passar(0, \'m=social&a=comunidade_editar\');" ><span>comunidade</span></a>'.dicaF().'</td></tr></table>');
...
if ($obj->social_comunidade_responsavel) echo '<tr><td align="right" valign="top" style="white-space: nowrap">'.dica('Responsável pelo Social', ucfirst($config['usuario']).' responsável por gerenciar a comunidade.').'Responsável:'.dicaF().'</td><td class="realce" width="100%">'.link_usuario($obj->social_comunidade_responsavel, '','','esquerda').'</td></tr>';		

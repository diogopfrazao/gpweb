...
if ($social_acao_problema_id && !$podeEditar) $Aplic->redirecionar('m=publico&a=acesso_negado');
elseif (!$social_acao_problema_id && !$podeAdicionar) $Aplic->redirecionar('m=publico&a=acesso_negado');

...
if ($editar)$botoesTitulo->adicionaCelula('<table><tr><td style="white-space: nowrap">'.dica('Novo Comitê', 'Cadastre um novo comitê.').'<a class="botao" href="javascript: void(0)" onclick="javascript:url_passar(0, \'m=social&a=comite_editar\');" ><span>comitê</span></a>'.dicaF().'</td></tr></table>');
...
if ($obj->social_comite_observacao) echo '<tr><td align="right" valign="top" style="white-space: nowrap">'.dica('Observações', 'Observações do comitê.').'Observações:'.dicaF().'</td><td class="realce" width="100%">'.$obj->social_comite_observacao.'</td></tr>';
...
if ($saida_quem) echo '<tr><td align="right" style="white-space: nowrap">'.dica('Membros', 'Quais contatos são membros deste comitê.').'Membros:'.dicaF().'</td><td width="100%" colspan="2"><table><tr><td>'.$saida_quem.'</td></tr></table></td></tr>';

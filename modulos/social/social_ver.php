...
if ($editar)$botoesTitulo->adicionaCelula('<table><tr><td style="white-space: nowrap">'.dica('Novo Progama Social', 'Criar um novo programa programa social.').'<a class="botao" href="javascript: void(0)" onclick="javascript:url_passar(0, \'m=social&a=social_editar\');" ><span>programa&nbsp;social</span></a>'.dicaF().'</td></tr></table>');
...
if ($obj->social_responsavel) echo '<tr><td align="right" valign="top" style="white-space: nowrap">'.dica('Responsável pelo Social', ucfirst($config['usuario']).' responsável por gerenciar o programa programa social.').'Responsável:'.dicaF().'</td><td class="realce" width="100%">'.link_usuario($obj->social_responsavel, '','','esquerda').'</td></tr>';		

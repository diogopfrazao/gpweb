...
if (isset($_REQUEST['social_acao_id'])) $Aplic->setEstado('social_acao_id', getParam($_REQUEST, 'social_acao_id', null));
$social_acao_id = ($Aplic->getEstado('social_acao_id') !== null ? $Aplic->getEstado('social_acao_id') : null);
...
if ($editar) {
	...
	$atividades='<tr><td align="right" style="white-space: nowrap">'.dica('Atividades', 'Insira ou edite a lista de atividades.').'Atividades:'.dicaF().'</td><td align="left" style="white-space: nowrap">'. selecionaVetor($lista_atividades, 'lista_atividades', 'size="1" style="width:160px;" class="texto" onChange="ir_para(\'lista_atividades\');"') .'</td></tr>';
	...
	$problemas='<tr><td align="right" style="white-space: nowrap">'.dica('Problemas', 'Insira ou edite a lista de possíveis problemas durante a execução da ação social.').'Problemas:'.dicaF().'</td><td align="left" style="white-space: nowrap">'. selecionaVetor($lista_problemas, 'lista_problemas', 'size="1" style="width:160px;" class="texto" onChange="ir_para(\'lista_problemas\');"') .'</td></tr>';
...
echo '<tr><td align="right" style="white-space: nowrap">'.dica('Legenda da Demanda Inicial', 'Para os relatórios, a legenda da demanda inicial.').'Demanda inicial:'.dicaF().'</td><td class="realce" style="text-align: justify;">'.$obj->social_acao_inicial.'</td></tr>';
echo '<tr><td align="right" style="white-space: nowrap">'.dica('Legenda do Total Programado', 'Para os relatórios, a legenda do total programado para ser adiquirido.').'Total Programado:'.dicaF().'</td><td class="realce" style="text-align: justify;">'.$obj->social_acao_adquirido.'</td></tr>';
echo '<tr><td align="right" style="white-space: nowrap">'.dica('Legenda do Total Final', 'Para os relatórios, a legenda do total final.').'Total final:'.dicaF().'</td><td class="realce" style="text-align: justify;">'.$obj->social_acao_final.'</td></tr>';
echo '<tr><td align="right" style="white-space: nowrap">'.dica('Legenda do Total Instalado', 'Para os relatórios, a legenda do total instalado.').'Total instalado:'.dicaF().'</td><td class="realce" style="text-align: justify;">'.$obj->social_acao_instalado.'</td></tr>';
echo '<tr><td align="right" style="white-space: nowrap">'.dica('Legenda do Total à Instalar', 'Para os relatórios, a legenda do total que falta instalar.').'Total à instalar:'.dicaF().'</td><td class="realce" style="text-align: justify;">'.$obj->social_acao_instalar.'</td></tr>';
echo '<tr><td align="right" style="white-space: nowrap">'.dica('Campo do Produto/Serviço Entregue', 'Para o termo de recebimento, qual a legenda para o produto/serviço entregue.').'Produto/Serviço Entregue:'.dicaF().'</td><td class="realce" style="text-align: justify;">'.$obj->social_acao_produto.'</td></tr>';
echo '<tr><td align="right" style="white-space: nowrap">'.dica('Campo do Órgão', 'Para o termo de recebimento, qual a legenda para o órgão responsável pela entrega.').'Órgão responsável:'.dicaF().'</td><td class="realce" style="text-align: justify;">'.$obj->social_acao_orgao.'</td></tr>';
echo '<tr><td align="right" style="white-space: nowrap">'.dica('Campo do Financiador', 'Para o termo de recebimento, qual a legenda para o órgão financiador da ação social.').'Financiador:'.dicaF().'</td><td class="realce" style="text-align: justify;">'.$obj->social_acao_financiador.'</td></tr>';
echo '<tr><td align="right" style="white-space: nowrap">'.dica('Campo do Código do Produto/Serviço', 'Para o termo de recebimento, qual a legenda para o código produto/serviço entregue.').'Código:'.dicaF().'</td><td class="realce" style="text-align: justify;">'.$obj->social_acao_codigo.'</td></tr>';
echo '<tr><td align="right" style="white-space: nowrap">'.dica('Campo da Declaração', 'Para o termo de recebimento, qual o texto da declaração de recebimento.').'Declaração:'.dicaF().'</td><td  class="realce">'.$obj->social_acao_declaracao.'</td></tr>';
...
if ($saida_quem) echo '<tr><td align="right" valign="top" style="white-space: nowrap">'.dica('Quem', 'Quais '.$config['usuarios'].' estarão executando este programa social.').'Quem:'.dicaF().'</td><td width="100%" colspan="2" class="realce"><table cellspacing=0 cellpadding=0><tr><td>'.$saida_quem.'</td></tr></table></td></tr>';
...
if ($saida_depts) echo '<tr><td align="right" valign="top" style="white-space: nowrap">'.dica(ucfirst($config['departamentos']), 'Qual '.strtolower($config['departamento']).' está relacionad'.$config['genero_dept'].' à este programa social.').ucfirst($config['departamento']).':'.dicaF().'</td><td width="100%" colspan="2" class="realce">'.$saida_depts.'</td></tr>';

if ($obj->social_acao_responsavel) echo '<tr><td align="right" valign="top" style="white-space: nowrap">'.dica('Responsável pelo Social', ucfirst($config['usuario']).' responsável por gerenciar a ação social.').'Responsável:'.dicaF().'</td><td class="realce" width="100%">'.link_usuario($obj->social_acao_responsavel, '','','esquerda').'</td></tr>';		

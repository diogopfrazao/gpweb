...
if ($social_acao_conceder_id && !$podeEditar ) $Aplic->redirecionar('m=publico&a=acesso_negado');
elseif (!$social_acao_conceder_id && !$podeAdicionar ) $Aplic->redirecionar('m=publico&a=acesso_negado');

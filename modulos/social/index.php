...
if (!$dialogo){
	...
	$botoesTitulo->adicionaCelula('<td align="right" style="white-space: nowrap">'.dica('Imprimir Programas Sociais', 'Clique neste ícone '.imagem('imprimir_p.png').' para imprimir a lista de programas sociais.').'<a href="javascript: void(0);" onclick ="url_passar(1, \'m=social&a=index&dialogo=1\');">'.imagem('imprimir_p.png').'</a>'.dicaF());

...
if ($editar)$botoesTitulo->adicionaCelula('<table><tr><td style="white-space: nowrap">'.dica('Nova Superintendência', 'Cadastre uma nova superintendência.').'<a class="botao" href="javascript: void(0)" onclick="javascript:url_passar(0, \'m=social&a=superintendencia_editar\');" ><span>superintendência</span></a>'.dicaF().'</td></tr></table>');
...
if ($obj->social_superintendencia_tel) echo '<tr><td align="right" style="white-space: nowrap" width="110">'.dica('Telefone Principal', 'O telefone principal da superintendência.').'Telefone principal:'.dicaF().'</td><td class="realce" style="text-align: justify;">'.$obj->social_superintendencia_tel.'</td></tr>';
if ($obj->social_superintendencia_tel2) echo '<tr><td align="right" style="white-space: nowrap" width="110">'.dica('Telefone Reserva', 'O telefone residencial da superintendência.').'Telefone reserva:'.dicaF().'</td><td class="realce" style="text-align: justify;">'.$obj->social_superintendencia_tel2.'</td></tr>';
if ($obj->social_superintendencia_cel) echo '<tr><td align="right" style="white-space: nowrap" width="110">'.dica('Celular', 'O celular da superintendência.').'Celular:'.dicaF().'</td><td class="realce" style="text-align: justify;">'.$obj->social_superintendencia_cel.'</td></tr>';
if ($obj->social_superintendencia_email) echo '<tr><td align="right">'.dica('e-mail', 'O e-mail da superintendência.').'e-mail:'.dicaF().'</td><td style="white-space: nowrap" class="realce">'.$obj->social_superintendencia_email.'</td></tr>';
if ($obj->social_superintendencia_responsavel) echo '<tr><td align="right" valign="top" style="white-space: nowrap">'.dica('Responsável pela Superintendência', ucfirst($config['usuario']).' responsável pela superintendência.').'Responsável:'.dicaF().'</td><td class="realce" width="100%">'.link_usuario($obj->social_superintendencia_responsavel, '','','esquerda').'</td></tr>';
if ($obj->social_superintendencia_observacao) echo '<tr><td align="right" valign="top" style="white-space: nowrap">'.dica('Observações', 'Observações da superitendência.').'Observações:'.dicaF().'</td><td class="realce" width="100%">'.$obj->social_superintendencia_observacao.'</td></tr>';
...
if ($saida_quem) echo '<tr><td align="right" style="white-space: nowrap">'.dica('Membros', 'Quais contatos são membros deste superintendência.').'Membros:'.dicaF().'</td><td width="100%" colspan="2"><table><tr><td>'.$saida_quem.'</td></tr></table></td></tr>';
...
if ($saida_municipios) echo '<tr><td align="right" valign="top" style="white-space: nowrap">'.dica('Município'.$plural, 'Município'.$plural.' relacionado'.$plural.' com '.$config['genero_projeto'].' '.$config['projeto']).'Município'.$plural.':'.dicaF().'</td><td width="100%" colspan="2" class="realce">'.$saida_municipios.'</td></tr>';

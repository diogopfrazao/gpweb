...
elseif ($inserir){
	echo '<tr><td align=right width=100>'.dica('Nome','Nome do modelo de documento').'Nome:'.dicaF().'</td><td><input type=text class="texto" name="nome_novo_modelo" id="nome_novo_modelo" style="width:400px"></td></tr>';
	echo '<tr><td align=right>'.dica('Descrição','Informações sobre este modelo de documento a ser mostrado no menu de seleção de documento a ser criado.').'Descrição:'.dicaF().'</td><td><input type=text class="texto" name="descricao" id="descricao" style="width:400px"></td></tr>';
	echo '<tr><td align=right>'.dica('Imagem','Escreva o nome do ícone a ser mostrado no menu de seleção de documento a ser criado, ex: <b>oficio.gif</b> .<br><br>Local para colocar o ícone: gpweb/estilo/rondon/imagens/icones/').'Imagem:'.dicaF().'</td><td><input type=text class="texto" name="imagem" id="imagem" style="width:400px"></td></tr>';
	...
	echo '<tr><td align=right width=100>'.dica('Nome','Nome do modelo de documento').'Nome:'.dicaF().'</td><td><input type=text class="texto" name="novo_nome" id="novo_nome" value="'.$rs['modelo_tipo_nome'].'" style="width:400px"></td></tr>';
	echo '<tr><td align=right width=100>'.dica('Descrição','Informações sobre este modelo de documento a ser mostrado no menu de seleção de documento a ser criado.').'Descrição:'.dicaF().'</td><td><input type=text class="texto" name="descricao" id="descricao" value="'.$rs['descricao'].'" style="width:400px"></td></tr>';
	echo '<tr><td align=right width=100>'.dica('Imagem','Escreva o nome do ícone a ser mostrado no menu de seleção de documento a ser criado, ex: <b>oficio.gif</b> .<br><br>Local para colocar o ícone: gpweb/estilo/rondon/imagens/icones/').'Imagem:'.dicaF().'</td><td><input type=text class="texto" name="imagem" id="imagem" value="'.$rs['imagem'].'" style="width:400px"></td></tr>';
...
var botoes_ckeditor=<?php echo $Aplic->profissional ? botoesCKEditor() : botoes_ckeditor(); ?>;

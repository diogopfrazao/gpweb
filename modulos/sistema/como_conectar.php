...
Bem, agora que a configuração do MySQL já está admitindo conexões remotadas, transações originadas de um servidor de aplicações (onde está o seu sistema/site php), chega a hora de definirmos que usuário será aceito durante as conexões remotas; para que base/tabela de dados e de que endereço (número IP, por exemplo) elas virão.
</p><p>

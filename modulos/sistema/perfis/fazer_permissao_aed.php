...
$permissao_tipo=implode(',', $permissao_tipo);

$Aplic->redirecionar('m=sistema&u=perfis&a=ver_perfil&perfil_id='.$perfil_id.'&permissao_modulo='.$permissao_modulo.'&permissao_submodulo='.$permissao_submodulo.'&permissao_tipo='.$permissao_tipo.'&perfil_acesso_negar='.$perfil_acesso_negar);

...
function corpo_cabecalho(){
	...
	if (count($logs)){
	  ...
	  $saida.= '<table width="100%">';
	  $saida.= '<tr><td align="left" style="padding-top: 5px;"><font size=2><b>'.++$numero.'. REGISTROS DE OCORRÊNCIAS</b></font></td></tr>';
	  $saida.= '<tr><td>';

	  $saida.= '<table width="100%" border=0 cellpadding="2" cellspacing=0 class="tbl1">';
	  $s = '<tr><th>Data</th><th>Tarefa</th><th>Ref.</th><th>Título</th><th>Responsável</th><th>Horas</th><th>Comentários</th></tr>';
	  $projeto_corrente = 0;

...
echo '<tr><td align="right" valign="top" style="white-space: nowrap">'.dica('Notificar', 'Marque esta caixa para avisar sobre o plano de qualidade.').'Notificar:'.dicaF().'</td>';
echo '<td>';

...
$sql->esqUnir('demandas', 'demandas', 'demandas.demanda_id=demanda_custo_demanda');
...
foreach ($linhas as $linha) {
	...
	echo '<td style="white-space: nowrap">'.$unidade[$linha['demanda_custo_tipo']].'</td>';
	echo '<td style="white-space: nowrap">'.number_format($linha['demanda_custo_quantidade'], 2, ',', '.').'</td>';
	echo '<td align="right" style="white-space: nowrap">'.$moedas[$linha['demanda_custo_moeda']].' '.number_format($linha['demanda_custo_custo'], 2, ',', '.').'</td>';
	if ($config['bdi']) echo '<td align="right">'.number_format($linha['demanda_custo_bdi'], 2, ',', '.').'</td>';

	echo '<td style="white-space: nowrap">'.$nd.'</td>';
	echo '<td align="right" style="white-space: nowrap">'.$moedas[$linha['demanda_custo_moeda']].' '.number_format($linha['valor'], 2, ',', '.').'</td>';
	...
	echo '<td align="left" style="white-space: nowrap">'.link_usuario($linha['demanda_custo_usuario'],'','','esquerda').'</td>';
	echo '<tr>';

...
if ($podeAdicionar && $editar)  $botoesTitulo->adicionaCelula('<table><tr><td style="white-space: nowrap">'.dica('Nov'.$config['genero_licao'].' '.ucfirst($config['licao']).'', 'Criar nova licao aprendida.').'<a class="botao" href="javascript: void(0)" onclick="javascript:url_passar(0, \'m=projetos&a=licao_editar&projeto_id='.$projeto_id.'&licao_projeto='.$projeto_id.'\');" ><span>nova lição</span></a>'.dicaF().'</td></tr><tr><td style="white-space: nowrap"></td></tr></table>');
...
else echo '<tr><td colspan=20>Nenh'.($config['genero_licao']=='a' ? 'uma ' : 'um ').$config['licao'].' encontrad'.$config['genero_licao'].'</table></td></tr>';

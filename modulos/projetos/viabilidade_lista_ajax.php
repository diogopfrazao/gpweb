...
function mudar_ajax($superior='', $sisvalor_titulo='', $campo='', $posicao, $script){
	...
	if($Aplic->profissional && $campo=='viabilidade_segmento') $objResposta->call('criarComboSegmento');
	if($Aplic->profissional && $campo=='viabilidade_intervencao') $objResposta->call('criarComboIntervencao');
	if($Aplic->profissional && $campo=='viabilidade_tipo_intervencao') $objResposta->call('criarComboTipoIntervencao');
	return $objResposta; 
	}	

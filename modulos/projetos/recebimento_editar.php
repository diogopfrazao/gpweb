...
echo '<tr><td align="right" style="white-space: nowrap">'.dica('Data Prevista', 'Digite ou escolha no calendário a data prevista para a entrega dos produtos/serviços').'Data prevista:'.dicaF().'</td><td align="left"><input type="hidden" name="projeto_recebimento_data_prevista" id="projeto_recebimento_data_prevista" value="'.($data_inicio ? $data_inicio->format('%Y%m%d') : '').'" /><input type="text" name="prevista"  id="prevista" style="width:70px;" onchange="setData(\'env\', \'prevista\');" value="'.($data_inicio ? $data_inicio->format('%d/%m/%Y') : '').'" class="texto" />'.dica('Data Inicial', 'Clique neste ícone '.imagem('icones/calendario.gif').'  para abrir um calendário onde poderá selecionar a data inícial da pesquisa.').'<a href="javascript: void(0);" ><img id="f_btn1" src="'.acharImagem('calendario.gif').'" style="vertical-align:middle" width="18" height="12" alt="Calendário" border=0 /></a>'.dicaF().'</td></tr>';
echo '<tr><td align="right" style="white-space: nowrap">Entregue:</td><td><input type="checkbox" name="entregue" value="1" class="texto" '.($obj->projeto_recebimento_data_entrega ? 'checked="checked"' : '').' onchange="mostrar();" /></td></tr>';
echo '<tr align="center" id="ver_data_entrega" style="display: '.($obj->projeto_recebimento_data_entrega ? '' : 'none').'"><td align="right" style="white-space: nowrap">'.dica('Data da Entrega', 'Digite ou escolha no calendário a data da entrega dos produtos/serviços').'Data da entrega:'.dicaF().'</td><td align="left"><input type="hidden" name="projeto_recebimento_data_entrega" id="projeto_recebimento_data_entrega" value="'.($data_fim ? $data_fim->format('%Y%m%d') : '').'" /><input type="text" name="entrega" id="entrega" style="width:70px;" onchange="setData(\'env\', \'entrega\');" value="'.($data_fim ? $data_fim->format('%d/%m/%Y') : '').'" class="texto" />'.dica('Data Final', 'Clique neste ícone '.imagem('icones/calendario.gif').'  para abrir um calendário onde poderá selecionar a data final da pesquisa.').'<a href="javascript: void(0);" ><img id="f_btn2" src="'.acharImagem('calendario.gif').'" style="vertical-align:middle" width="18" height="12" alt="Calendário" border=0 /></a>'.dicaF().'</td></tr>';
echo '<tr><td align="right" style="white-space: nowrap">'.dica('Observação', 'Descrever de forma clara a justificativa como se processa o recebimento de produtos/serviços.').'Descrição:'.dicaF().'</td><td><textarea name="projeto_recebimento_observacao" style="width:800px;" class="textarea">'.$obj->projeto_recebimento_observacao.'</textarea></td></tr>';
...
if ($saida_quem) echo '<tr><td align="right" style="white-space: nowrap">'.dica('Quem', 'Quais '.$config['usuarios'].' estarão executando esta entegra de produtos/serviços.').'Quem:'.dicaF().'</td><td colspan="2">'.$saida_quem.'</td></td></tr>';
...
echo '<tr><td align="right" valign="top" style="white-space: nowrap">'.dica('Notificar', 'Marque esta caixa para avisar sobre a '.($projeto_recebimento_id > 0 ? 'modificação' : 'criação').' da entegra de produtos/serviços.').'Notificar:'.dicaF().'</td>';
echo '<td>';

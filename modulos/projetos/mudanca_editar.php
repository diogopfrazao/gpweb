...
echo '<tr><td align="right" style="white-space: nowrap" width=100>'.dica('Número', 'Número desta solicitação de mudanças').'Número:'.dicaF().'</td><td colspan="2">'.($obj->projeto_mudanca_numero<100 ? '0' : '').($obj->projeto_mudanca_numero<10 ? '0' : '').$obj->projeto_mudanca_numero.'</td></tr>';
echo '<tr><td align="right" style="white-space: nowrap">'.dica('Cor', 'Cor selecionada dentre as 16 milhões possíveis. Pode-se escrever diretamente o hexadecinal na cor ou utilizar a interface que se abre ao clicar na caixa de inserção do valor.').'Cor:'.dicaF().'</td><td align="left" style="white-space: nowrap"><input class="jscolor" name="projeto_mudanca_cor" value="'.($obj->projeto_mudanca_cor ? $obj->projeto_mudanca_cor : 'FFFFFF').'" '.($config['selecao_cor_restrita'] ? 'readonly="readonly" ' : '').'size="6" maxlength="6" style="width:57px;" /></td></tr>';

echo '<tr><td align="right" style="white-space: nowrap">'.dica('Demandante', 'Toda solicitação de mudança deve ter um demandante.').'Demandante:'.dicaF().'</td><td colspan="2"><input type="hidden" id="projeto_mudanca_cliente" name="projeto_mudanca_cliente" value="'.($obj->projeto_mudanca_cliente ? $obj->projeto_mudanca_cliente : '').'" /><input type="text" id="nome_contato" name="nome_contato" value="'.nome_om(($obj->projeto_mudanca_cliente ? $obj->projeto_mudanca_cliente : ''),$Aplic->getPref('om_usuario'),'', true).'" style="width:284px;" class="texto" READONLY /><a href="javascript: void(0);" onclick="popContato();">'.imagem('icones/usuarios.gif','Selecionar Contato','Clique neste ícone '.imagem('icones/usuarios.gif').' para selecionar um contato.').'</a></td></tr>';
echo '<tr><td align="right" style="white-space: nowrap">'.dica('Responsável', 'Toda solicitação de mudança deve ter um responsável.').'Responsável:'.dicaF().'</td><td colspan="2"><input type="hidden" id="projeto_mudanca_responsavel" name="projeto_mudanca_responsavel" value="'.($obj->projeto_mudanca_responsavel ? $obj->projeto_mudanca_responsavel : $Aplic->usuario_id).'" /><input type="text" id="nome_responsavel" name="nome_responsavel" value="'.nome_om(($obj->projeto_mudanca_responsavel ? $obj->projeto_mudanca_responsavel : $Aplic->usuario_id),$Aplic->getPref('om_usuario')).'" style="width:284px;" class="texto" READONLY /><a href="javascript: void(0);" onclick="popResponsavel();">'.imagem('icones/usuarios.gif','Selecionar '.ucfirst($config['usuario']),'Clique neste ícone '.imagem('icones/usuarios.gif').' para selecionar '.($config['genero_usuario']=='o' ? 'um' : 'uma').' '.$config['usuario'].'.').'</a></td></tr>';
echo '<tr><td align="right" style="white-space: nowrap">'.dica('Autoridade', 'Toda solicitação de mudança deve ter um autoridade responsável por aprovar.').'Autoridade:'.dicaF().'</td><td colspan="2"><input type="hidden" id="projeto_mudanca_autoridade" name="projeto_mudanca_autoridade" value="'.$obj->projeto_mudanca_autoridade.'" /><input type="text" id="nome_autoridade" name="nome_autoridade" value="'.nome_om($obj->projeto_mudanca_autoridade, $Aplic->getPref('om_usuario')).'" style="width:284px;" class="texto" READONLY /><a href="javascript: void(0);" onclick="popAutoridade();">'.imagem('icones/usuarios.gif','Selecionar '.ucfirst($config['usuario']),'Clique neste ícone '.imagem('icones/usuarios.gif').' para selecionar '.($config['genero_usuario']=='o' ? 'um' : 'uma').' '.$config['usuario'].'.').'</a></td></tr>';
echo '<tr><td align="right" style="white-space: nowrap">'.dica('Aprovada pelo Requisitante', 'Marque esta opção se a requisição de mudança foi aprovada pelo requisitante.').'Aprovada pelo requisitante:'.dicaF().'</td><td colspan="2"><input type="checkbox" name="projeto_mudanca_requisitante_aprovada" id="projeto_mudanca_requisitante_aprovada" '.($obj->projeto_mudanca_requisitante_aprovada  ? 'checked="checked"' : '').' value="1" onchange="if (env.projeto_mudanca_requisitante_aprovada.checked) {env.projeto_mudanca_requisitante_reprovada.checked=false;} else {env.projeto_mudanca_requisitante_reprovada.checked=true;}" /></td></tr>';
echo '<tr><td align="right" style="white-space: nowrap">'.dica('Reprovada pelo Requisitante', 'Marque esta opção se a requisição de mudança foi reprovada pelo requisitante.').'Reprovada pelo requisitante:'.dicaF().'</td><td colspan="2"><input type="checkbox" name="projeto_mudanca_requisitante_reprovada" id="projeto_mudanca_requisitante_reprovada" '.($obj->projeto_mudanca_requisitante_reprovada  ? 'checked="checked"' : '').' value="1" onchange="if (env.projeto_mudanca_requisitante_reprovada.checked) {env.projeto_mudanca_requisitante_aprovada.checked=false;} else {env.projeto_mudanca_requisitante_aprovada.checked=true;}" /></td></tr>';
echo '<tr><td align="right" style="white-space: nowrap">'.dica('Aprovada pela Administração', 'Marque esta opção se a requisição de mudança foi aprovada pela administração.').'Aprovada pela administração:'.dicaF().'</td><td colspan="2"><input type="checkbox" name="projeto_mudanca_administracao_aprovada" id="projeto_mudanca_administracao_aprovada" '.($obj->projeto_mudanca_administracao_aprovada ? 'checked="checked"' : '').' value="1" onchange="if (env.projeto_mudanca_administracao_aprovada.checked) {env.projeto_mudanca_administracao_reprovada.checked=false;} else {env.projeto_mudanca_administracao_reprovada.checked=true;}" /></td></tr>';
echo '<tr><td align="right" style="white-space: nowrap">'.dica('Reprovada pela Administração', 'Marque esta opção se a requisição de mudança foi reprovada pela administração.').'Reprovada pela administração:'.dicaF().'</td><td colspan="2"><input type="checkbox" name="projeto_mudanca_administracao_reprovada" id="projeto_mudanca_administracao_reprovada" '.($obj->projeto_mudanca_administracao_reprovada  ? 'checked="checked"' : '').' value="1" onchange="if (env.projeto_mudanca_administracao_reprovada.checked) {env.projeto_mudanca_administracao_aprovada.checked=false;} else {env.projeto_mudanca_administracao_aprovada.checked=true;}" /></td></tr>';
echo '<tr><td align="right" style="white-space: nowrap">'.dica(ucfirst($config['tarefa']).' Relacionada', 'Caso a solicitação de mudanças seja específica de um'.($config['genero_tarefa']=='a' ?  'a' : '').' '.$config['tarefa'].' d'.$config['genero_projeto'].' '.$config['projeto'].', este campo deverá constar o nome d'.$config['genero_tarefa'].' '.$config['tarefa'].'.').ucfirst($config['tarefa']).':'.dicaF().'</td><td align="left" valign="top" style="white-space: nowrap"><table cellspacing=0 cellpadding=0><tr><td><input type="hidden" name="projeto_mudanca_tarefa" value="'.$obj->projeto_mudanca_tarefa.'" /><input type="text" id="tarefa_nome" name="tarefa_nome" value="'.nome_tarefa($obj->projeto_mudanca_tarefa).'" style="width:450px;" class="texto" READONLY /></td><td><a href="javascript: void(0);" onclick="popTarefa();">'.imagem('icones/tarefa_p.gif','Selecionar '.ucfirst($config['tarefa']),'Clique neste ícone '.imagem('icones/tarefa_p.gif').' escolher à qual '.$config['tarefa'].' a entrega irá pertencer.<br><br>Caso não escolha um'.($config['genero_tarefa']=='a' ?  'a' : '').' '.$config['tarefa'].', a entrega será d'.$config['genero_projeto'].' '.$config['projeto'].' tod'.$config['genero_projeto'].'.').'</a></td></tr></table></td></tr>';
echo '<tr><td align="right" style="white-space: nowrap">'.dica('Nível de Acesso', 'A solicitação de mudanças pode ter cinco níveis de acesso:<ul><li><b>Público</b> - Todos podem ver e editar a solicitação de mudanças.</li><li><b>Protegido I</b> - Todos podem ver, porem apenas o responsável e os designados para a solicitação de mudanças podem editar.</li><li><b>Protegido II</b> - Todos podem ver, porem apenas o responsável pode editar tudo e os designados editarem os objetos relacionados.</li><li><b>Protegido III</b> - Todos podem ver, porem apenas o responsável pode editar.</li><li><b>Participante I</b> - Somente o responsável e os designados para a solicitação de mudanças ver e editar a solicitação de mudanças</li><li><b>Participantes II</b> - Somente o responsável e os designados podem ver e apenas o responsável pode editar tudo e os designados editarem os objetos relacionados.</li><li><b>Participantes III</b> - Somente o responsável e os designados para a solicitação de mudanças podem ver a mesma, e o responsável editar.</li></ul>').'Nível de acesso:'.dicaF().'</td><td colspan="2">'.selecionaVetor($projeto_mudanca_acesso, 'projeto_mudanca_acesso', 'class="texto"', ($projeto_mudanca_id ? $obj->projeto_mudanca_acesso : $config['nivel_acesso_padrao'])).'</td></tr>';

$data_inicio = new CData(($obj->projeto_mudanca_data  ? $obj->projeto_mudanca_data : date('Y-m-d')));
echo '<tr><td align="right" style="white-space: nowrap">'.dica('Data da Solicitação', 'Digite ou escolha no calendário a data da solicitação de mudança').'Data da solicitação:'.dicaF().'</td><td align="left"><input type="hidden" name="projeto_mudanca_data" id="projeto_mudanca_data" value="'.($data_inicio ? $data_inicio->format('%Y%m%d') : '').'" /><input type="text" name="prevista"  id="prevista" style="width:70px;" onchange="setData(\'env\', \'prevista\');" value="'.($data_inicio ? $data_inicio->format('%d/%m/%Y') : '').'" class="texto" />'.dica('Data Inicial', 'Clique neste ícone '.imagem('icones/calendario.gif').'  para abrir um calendário onde poderá selecionar a data inícial da pesquisa.').'<a href="javascript: void(0);" ><img id="f_btn1" src="'.acharImagem('calendario.gif').'" style="vertical-align:middle" width="18" height="12" alt="Calendário" border=0 /></a>'.dicaF().'</td></tr>';
echo '<tr><td align="right" style="white-space: nowrap">'.dica('Necessidade/Justificativa', 'Descrição de forma clara a necessidade, a motivação, custo e prazo estimado da mudança no projeto.').'Necessidade/justificativa:'.dicaF().'</td><td><textarea name="projeto_mudanca_justificativa" style="width:750px;" class="textarea">'.$obj->projeto_mudanca_justificativa.'</textarea></td></tr>';
echo '<tr><td align="right" style="white-space: nowrap">'.dica('Parecer Técnico', 'Avaliar tecnicamente se a mudança é pertinente').'Parecer técnico:'.dicaF().'</td><td><textarea name="projeto_mudanca_parecer_tecnico" style="width:750px;" class="textarea">'.$obj->projeto_mudanca_parecer_tecnico.'</textarea></td></tr>';
echo '<tr><td align="right" style="white-space: nowrap">'.dica('Soluções Possíveis', 'Avaliar todas as possíveis soluções para solução da mudança proposta.').'Soluções possíveis:'.dicaF().'</td><td><textarea name="projeto_mudanca_solucoes" style="width:750px;" class="textarea">'.$obj->projeto_mudanca_solucoes.'</textarea></td></tr>';
echo '<tr><td align="right" style="white-space: nowrap">'.dica('Impacto no Cronograma', 'Descrever o impacto da mudança no tempo, custo e riscos.').'Impacto no cronograma:'.dicaF().'</td><td><textarea name="projeto_mudanca_impacto_cronograma" style="width:750px;" class="textarea">'.$obj->projeto_mudanca_impacto_cronograma.'</textarea></td></tr>';
echo '<tr><td align="right" style="white-space: nowrap">'.dica('Impactos no Custo', 'Descrever o impacto da mudança no tempo, custo e riscos.').'Impactos no custo:'.dicaF().'</td><td><textarea name="projeto_mudanca_impacto_custo" style="width:750px;" class="textarea">'.$obj->projeto_mudanca_impacto_custo.'</textarea></td></tr>';
echo '<tr><td align="right" style="white-space: nowrap">'.dica('Novos Riscos', 'Descrever o impacto da mudança no tempo, custo e riscos.').'Novos riscos:'.dicaF().'</td><td><textarea name="projeto_mudanca_novo_risco" style="width:750px;" class="textarea">'.$obj->projeto_mudanca_novo_risco.'</textarea></td></tr>';
echo '<tr><td align="right" style="white-space: nowrap">'.dica('Outros Impactos', 'Descrever o impacto da mudança no tempo, custo e riscos.').'Outros impactos:'.dicaF().'</td><td><textarea name="projeto_mudanca_outros_impactos" style="width:750px;" class="textarea">'.$obj->projeto_mudanca_outros_impactos.'</textarea></td></tr>';
echo '<tr><td align="right" style="white-space: nowrap">'.dica('Solução Indicada', 'Dentre as soluções possíveis levantada pela equipe de projeto o gerente de projeto deve avaliar o impacto no projeto como um todo e indicar a melhor solução a ser adotada.').'Solução indicada:'.dicaF().'</td><td><textarea name="projeto_mudanca_solucao" style="width:750px;" class="textarea">'.$obj->projeto_mudanca_solucao.'</textarea></td></tr>';
echo '<tr><td align="right" style="white-space: nowrap">'.dica('Parecer', 'Deliberar sobre a aprovação da mudança.').'Parecer:'.dicaF().'</td><td><textarea name="projeto_mudanca_parecer" style="width:750px;" class="textarea">'.$obj->projeto_mudanca_parecer.'</textarea></td></tr>';
...
if ($saida_quem) echo '<tr><td align="right" style="white-space: nowrap">'.dica('Quem', 'Quais '.$config['usuarios'].' estarão executando esta solicitação de mudanças.').'Quem:'.dicaF().'</td><td colspan="2">'.$saida_quem.'</td></td></tr>';

echo '<tr><td align="right" style="white-space: nowrap"></td><td colspan="2"><table><tr><td>'.botao('participantes', 'Participantes','Abrir uma janela onde poderá selecionar quais serão os participantes desta solicitação de mudanças.<br><br>Os participantes poderão receber e-mails informando sobre alterações nesta solicitação de mudanças.','','popUsuarios()').'</td></tr></table></td></tr>';
...
echo '<tr><td align="right" valign="top" style="white-space: nowrap">'.dica('Notificar', 'Marque esta caixa para avisar sobre a '.($projeto_mudanca_id > 0 ? 'modificação' : 'criação').' da solicitação de mudança.').'Notificar:'.dicaF().'</td>';
echo '<td>';
...
echo '</td><td>'.dica('Destinatários Extra', 'Preencha neste campo os e-mail, separados por vírgula, dos destinatários extras que serão avisados.').'Destinatários extra:'.dicaF().'<input type="text" class="texto" name="email_extras" maxlength="255" size="30" /></td></tr></table></td></tr>';
...
function popTarefa() {
	if (window.parent.gpwebApp) parent.gpwebApp.popUp('<?php echo ucfirst($config["tarefa"])?>', 1000, 700, 'm=publico&a=selecionar&dialogo=1&chamar_volta=setTarefa&tabela=tarefas&tarefa_projeto=<?php echo $projeto_id ?>', window.setTarefa, window);
	else window.open('./index.php?m=publico&a=selecionar&dialogo=1&chamar_volta=setTarefa&tabela=tarefas&tarefa_projeto=<?php echo $projeto_id ?>', 'tarefa','left=0,top=0,height=700,width=700,scrollbars=yes, resizable=yes');
	}

...
$projeto_id=getParam($_REQUEST, 'projeto_embasamento_projeto', null);
$Aplic->setMsg('Embasamento');
...
$Aplic->redirecionar('m=projetos&a=embasamento_ver&projeto_id='.$projeto_id);

...
echo '<tr><th style="white-space: nowrap">Cor</th><th style="white-space: nowrap">P</th><th style="white-space: nowrap">Nome d'.$config['genero_projeto'].' '.ucfirst($config['projeto']).'</th><th style="white-space: nowrap">'.$config['organizacao'].'</th><th style="white-space: nowrap">Início</th><th style="white-space: nowrap">Término</th><th style="white-space: nowrap">Provável</th><th style="white-space: nowrap">Responsável</th><th style="white-space: nowrap">T M</th><th style="white-space: nowrap">Custo</th>';

...
$projeto_id=getParam($_REQUEST, 'projeto_comunicacao_projeto', null);
$Aplic->setMsg('comunicacao');
...
$Aplic->redirecionar('m=projetos&a=comunicacao_ver&projeto_id='.$projeto_id);

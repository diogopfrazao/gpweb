...
if (!$dialogo){
	...
	$popFiltro='<tr><td align="right" style="white-space: nowrap">'.dica('Relacionado', 'A que área está relacionado.').'Relacionado:'.dicaF().'</td><td align="left">'.selecionaVetor($tipos, 'tipo_relacao', 'style="width:250px;" class="texto" onchange="popRelacao(this.value)"').'</td></tr>';
  ...
  $saida.='<table cellspacing=0 cellpadding=0>';
	...
	$imprimir='<tr><td align="right" style="white-space: nowrap">'.dica('Imprimir', 'Clique neste ícone '.imagem('imprimir_p.png').' para imprimir a lista.').'<a href="javascript: void(0);" onclick ="url_passar(1, \'m=projetos&a=viabilidade_lista&dialogo=1\');">'.imagem('imprimir_p.png').'</a>'.dicaF().'</td></tr>';
...
$caixaTab->adicionar('banco_projeto_tabela', 'Sem Termo de Abertura',null,null,'Sem Termo de Abertura','Possíveis '.$config['projetos'].' que ainda não tem um termo de abertura criado.');
